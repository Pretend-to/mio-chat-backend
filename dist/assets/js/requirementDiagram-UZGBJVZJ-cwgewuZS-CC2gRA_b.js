...
import { t as E } from './chunk-55IACEB6-DWUqxxdp-ClblAteD.js'
import { t as p } from './chunk-QN33PNHL-BFbXAWI4-CKMEtEdN.js'
var d = (function () {
  var e = i(function (e, t, s, i) {
      for (s ||= {}, i = e.length; i--; s[e[i]] = t);
      return s
    }, 'o'),
    t = [1, 3],
    s = [1, 4],
    ...
    oe = {
      ...
      table: [
        ...
        e(A, [2, 85]),
        e(A, [2, 86]),
        { 62: 69, 65: v, 66: L, 67: x, 68: O, 69: D, 70: M, 71: w },
        { 62: 77, 65: v, 66: L, 67: x, 68: O, 69: D, 70: M, 71: w },
        ...
        e(k, [2, 57], { 76: z }),
        e(k, [2, 58], { 76: F }),
        { 5: J, 28: 105, 31: ee, 34: te, 36: se, 38: ie, 40: ne },
        { 27: [1, 112], 76: F },
        ...
        { 32: [1, 124] },
        { 32: [1, 125] },
        { 5: J, 28: 126, 31: ee, 34: te, 36: se, 38: ie, 40: ne },
        e(k, [2, 28]),
        { 5: [1, 127] },
        e(k, [2, 42]),
        { 32: [1, 128] },
        ...
        e(k, [2, 27]),
        { 5: J, 28: 145, 31: ee, 34: te, 36: se, 38: ie, 40: ne },
        ...
        { 5: [2, 90] },
        e(k, [2, 43]),
        { 5: J, 28: 159, 31: ee, 34: te, 36: se, 38: ie, 40: ne },
        { 5: J, 28: 160, 31: ee, 34: te, 36: se, 38: ie, 40: ne },
        { 5: J, 28: 161, 31: ee, 34: te, 36: se, 38: ie, 40: ne },
        { 5: J, 28: 162, 31: ee, 34: te, 36: se, 38: ie, 40: ne },
      ...
      parse: i(function (e) {
        ...
        ;('function' == typeof E.yy.parseError
          ...
          i(function (e) {
            ;((s.length -= 2 * e), (r.length -= e), (a.length -= e))
          }, 'popStack'),
          i(f, 'lex'))
        for (var _, g, S, I, b, T, k, N, q, C = {}; ;) {
          if (
            ((S = s[s.length - 1]),
...
var R = d,
  f = class {
    constructor() {
      ;((this.relations = []),
        ...
        (this.getConfig = i(() => u().requirement, 'getConfig')),
        this.clear(),
    ...
    defineClass(e, t) {
      for (let s of e) {
        ...
        ;(void 0 === e &&
          ((e = { id: s, styles: [], textStyles: [] }), this.classes.set(s, e)),
          t &&
    ...
    getData() {
      ...
      for (let i of this.relations) {
        let t = 0,
          n = i.type === this.Relationships.CONTAINS,
          r = {
            id: `${i.src}-${i.dst}-${t}`,
            start:
  ...
  g = {}
a(g, { draw: () => S })
var S = i(async function (e, t, s, i) {
    ;(n.info('REF0:'), n.info('Drawing requirement diagram (unified)', t))
    let { securityLevel: r, state: a, layout: l } = u(),
      y = i.db.getData(),
      m = E(t, r)
    ;((y.type = i.type),
      (y.layoutAlgorithm = h(l)),
      (y.nodeSpacing = a?.nodeSpacing ?? 50),
      (y.rankSpacing = a?.rankSpacing ?? 50),
      ...
      p(m, 8, 'requirementDiagram', a?.useMaxWidth ?? !0))
  }, 'draw'),
  I = {
    parser: R,
    get db() {
...
export { I as diagram }
//# sourceMappingURL=requirementDiagram-UZGBJVZJ-cwgewuZS-CC2gRA_b.js.map
