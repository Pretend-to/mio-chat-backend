...
import {
  ...
  r as J,
  u as Z,
} from './_basePickBy-fyOYyssU-BAJ6xFh9.js'
import { t as ee } from './clone-Dtvdu9_S-Bf3oLzFp.js'
function te(e) {
  return 'object' == typeof e && !!e && 'string' == typeof e.$type
}
function re(e) {
  return 'object' == typeof e && !!e && 'string' == typeof e.$refText
}
function ne(e) {
  return (
    'object' == typeof e &&
...
var ie = class {
  ...
  isInstance(e, t) {
    return te(e) && this.isSubtype(e.$type, t)
  }
  isSubtype(e, t) {
    if (e === t) return !0
    ...
    {
      let n = this.computeIsSubtype(e, t)
      return ((r[t] = n), n)
    }
  }
  getAllSubTypes(e) {
...
function ae(e) {
  return 'object' == typeof e && !!e && Array.isArray(e.content)
}
function se(e) {
  return 'object' == typeof e && !!e && 'object' == typeof e.tokenType
}
function oe(e) {
  return ae(e) && 'string' == typeof e.fullText
}
var le = class e {
  constructor(e, t) {
  ...
  toArray() {
    let e,
      ...
      r = this.iterator()
    do {
      ;((e = r.next()), void 0 !== e.value && t.push(e.value))
    } while (!e.done)
    return t
  }
  toSet() {
  ...
  toMap(e, t) {
    let r = this.map((r) => [e ? e(r) : r, t ? t(r) : r])
    return new Map(r)
  }
  toString() {
    return this.join()
  ...
  join(e = ',') {
    let t,
      ...
      i = !1
    do {
      ;((t = r.next()), t.done || (i && (n += e), (n += ue(t.value))), (i = !0))
    } while (!t.done)
    return n
  }
  indexOf(e, t = 0) {
  ...
  map(t) {
    return new e(this.startFn, (e) => {
      let { done: r, value: n } = this.nextFn(e)
      return r ? he : { done: !1, value: t(n) }
    })
  }
  filter(t) {
    return new e(this.startFn, (e) => {
      let r
      do {
        if (((r = this.nextFn(e)), !r.done && t(r.value))) return r
      } while (!r.done)
      return he
    })
  }
  ...
  reduce(e, t) {
    let r = this.iterator(),
      ...
      i = r.next()
    for (; !i.done;)
      ((n = void 0 === n ? i.value : e(n, i.value)), (i = r.next()))
    return n
  }
  reduceRight(e, t) {
    ...
    return new e(
      ...
      (e) => {
        do {
          ...
          let { done: r, value: n } = this.nextFn(e.this)
          if (!r) {
            let r = t(n)
            if (!ce(r)) return { done: !1, value: r }
    ...
    return new e(
      ...
      (e) => {
        do {
          ...
          let { done: t, value: n } = r.nextFn(e.this)
          if (!t) {
            if (!ce(n)) return { done: !1, value: n }
  ...
  tail(t = 1) {
    return new e(() => {
      let e = this.startFn()
      for (let r = 0; r < t; r++) if (this.nextFn(e).done) return e
      return e
    }, this.nextFn)
  }
  limit(t) {
    return new e(
      ...
      (e) => (e.size++, e.size > t ? he : this.nextFn(e.state)),
    )
  }
  distinct(t) {
    return new e(
      ...
      (e) => {
        let r
        do {
          if (((r = this.nextFn(e.internalState)), !r.done)) {
            let n = t ? t(r.value) : r.value
            if (!e.set.has(n)) return (e.set.add(n), r)
          }
        } while (!r.done)
        return he
      },
...
var de = new le(
  ...
  he = Object.freeze({ done: !0, value: void 0 })
function fe(...e) {
  if (1 === e.length) {
    let t = e[0]
    ...
    if ('number' == typeof t.length)
      return new le(
        () => ({ index: 0 }),
        (e) => (e.index < t.length ? { done: !1, value: t[e.index++] } : he),
      )
  }
  return e.length > 1
    ? new le(
          ...
          do {
            ...
            if (t.collIndex < e.length) {
              ...
              ce(r)
                ...
                : r && 'number' == typeof r.length && (t.array = r)
            }
      ...
      super(
        ...
        (e) => {
          for (e.pruned &&= (e.iterators.pop(), !1); e.iterators.length > 0;) {
            ...
            if (!r.done)
              return (e.iterators.push(t(r.value)[Symbol.iterator]()), r)
            e.iterators.pop()
          }
          return he
        },
...
function Te(e) {
  return new ye(e, (e) => (ae(e) ? e.content : []), { includeRoot: !0 })
}
function Re(e) {
  return {
...
;(((me = pe ||= {}).sum = function (e) {
  return e.reduce((e, t) => e + t, 0)
}),
  (me.product = function (e) {
    return e.reduce((e, t) => e * t, 0)
  }),
  (me.min = function (e) {
...
var $e = /^[\w\p{L}]$/u
function Ae(e, t) {
  return se(e) && t.includes(e.tokenType.name)
}
...
var Ue = 'Grammar',
  ...
  Ge = 'InferredType'
function Be(e) {
  return Pt.isInstance(e, Ge)
}
var Ke = 'Interface'
function Ve(e) {
  return Pt.isInstance(e, Ke)
}
var je = 'NamedArgument',
  He = 'Negation'
var We = 'NumberLiteral',
  ze = 'Parameter',
  Ye = 'ParameterReference'
var qe = 'ParserRule'
function Xe(e) {
  return Pt.isInstance(e, qe)
}
var Qe = 'ReferenceType',
  Je = 'ReturnType'
var Ze = 'SimpleType'
function et(e) {
  return Pt.isInstance(e, Ze)
}
var tt = 'StringLiteral',
  rt = 'TerminalRule'
function nt(e) {
  return Pt.isInstance(e, rt)
}
var it = 'Type'
function at(e) {
  return Pt.isInstance(e, it)
}
var st = 'TypeAttribute',
  ot = 'UnionType',
  lt = 'Action'
function ut(e) {
  return Pt.isInstance(e, lt)
}
var ct = 'Alternatives'
function dt(e) {
  return Pt.isInstance(e, ct)
}
var ht = 'Assignment'
function ft(e) {
  return Pt.isInstance(e, ht)
}
var pt = 'CharacterRange'
var mt = 'CrossReference'
function gt(e) {
  return Pt.isInstance(e, mt)
}
var yt = 'EndOfFile'
var Tt = 'Group'
function Rt(e) {
  return Pt.isInstance(e, Tt)
}
var vt = 'Keyword'
function Et(e) {
  return Pt.isInstance(e, vt)
}
var $t = 'NegatedToken'
var At = 'RegexToken'
var kt = 'RuleCall'
function xt(e) {
  return Pt.isInstance(e, kt)
}
var It = 'TerminalAlternatives'
var St = 'TerminalGroup'
var Ct = 'TerminalRuleCall'
function Nt(e) {
  return Pt.isInstance(e, Ct)
}
var wt = 'UnorderedGroup'
function Lt(e) {
  return Pt.isInstance(e, wt)
}
var bt = 'UntilToken'
var Ot = 'Wildcard'
var _t = class extends ie {
    getAllTypes() {
      return [
        Le,
        Ie,
    ...
    getTypeMetaData(e) {
      switch (e) {
        ...
        case _e:
          return { name: _e, properties: [{ name: 'elementType' }] }
        case Pe:
          return { name: Pe, properties: [{ name: 'true', defaultValue: !1 }] }
        case Me:
          return { name: Me, properties: [{ name: 'left' }, { name: 'right' }] }
        case De:
          return { name: De, properties: [{ name: 'left' }, { name: 'right' }] }
        case Ue:
          return {
            name: Ue,
            properties: [
        ...
        case Fe:
          return { name: Fe, properties: [{ name: 'path' }] }
        case Ge:
          return { name: Ge, properties: [{ name: 'name' }] }
        case Ke:
          return {
            name: Ke,
            properties: [
        ...
        case He:
          return { name: He, properties: [{ name: 'value' }] }
        case We:
          return { name: We, properties: [{ name: 'value' }] }
        case ze:
          return { name: ze, properties: [{ name: 'name' }] }
        case Ye:
          return { name: Ye, properties: [{ name: 'parameter' }] }
        case qe:
          return {
            name: qe,
            properties: [
        ...
        case Qe:
          return { name: Qe, properties: [{ name: 'referenceType' }] }
        case Je:
          return { name: Je, properties: [{ name: 'name' }] }
        case Ze:
          return {
            name: Ze,
            properties: [
        ...
        case tt:
          return { name: tt, properties: [{ name: 'value' }] }
        case rt:
          return {
            name: rt,
            properties: [
        ...
        case it:
          return { name: it, properties: [{ name: 'name' }, { name: 'type' }] }
        case st:
          return {
            name: st,
            properties: [
        ...
        case ot:
          return { name: ot, properties: [{ name: 'types', defaultValue: [] }] }
        case lt:
          return {
            name: lt,
            properties: [
    ...
    (t) => {
      for (; t.keyIndex < t.keys.length;) {
        ...
        if (!n.startsWith('$')) {
          let i = e[n]
          if (te(i)) {
            if ((t.keyIndex++, Kt(i, r))) return { done: !1, value: i }
          } else if (Array.isArray(i)) {
            for (; t.arrayIndex < i.length;) {
              let e = i[t.arrayIndex++]
              if (te(e) && Kt(e, r)) return { done: !1, value: e }
            }
            t.arrayIndex = 0
          }
        }
...
function Gt(e, t) {
  ...
  return new ye(e, (e) => Ft(e, t))
}
function Bt(e, t) {
  if (!e) throw Error('Root node must be an AstNode.')
  return t?.range && !Kt(e, t.range)
    ? new ye(e, () => [])
    : new ye(e, (e) => Ft(e, t), { includeRoot: !0 })
}
function Kt(e, t) {
  if (!t) return !0
            ...
            for (; t.arrayIndex < n.length;) {
              ...
              if (re(a))
                return {
                  ...
                  value: { reference: a, container: e, property: r, index: i },
                }
            }
            t.arrayIndex = 0
          }
...
function jt(e) {
  return Array.isArray(e) ? [...e.map(jt)] : e
}
function Ht(e) {
...
var Qt = []
for (let wh = Ht('0'); wh <= Ht('9'); wh++) Qt.push(wh)
var Jt = [Ht('_')].concat(Qt)
for (let wh = Ht('a'); wh <= Ht('z'); wh++) Jt.push(wh)
for (let wh = Ht('A'); wh <= Ht('Z'); wh++) Jt.push(wh)
var Zt = [
    Ht(' '),
    Ht('\f'),
  ...
  nr = class {
    ...
    quantifier(e = !1) {
      ...
      switch (this.popChar()) {
        ...
        case '?':
          ...
          break
        case '{':
          let r = this.integerIncludingZero()
          switch (this.popChar()) {
            case '}':
            ...
            case ',':
              ...
              ;(this.isDigit()
                ? ((e = this.integerIncludingZero()),
                  (t = { atLeast: r, atMost: e }))
                : (t = { atLeast: r, atMost: Infinity }),
                this.consumeChar('}'))
          }
          if (!0 === e && void 0 === t) return
          Yt(t)
      }
      if ((!0 !== e || void 0 !== t) && Yt(t))
        return (
          '?' === this.peekChar(0)
    ...
    characterClassEscape() {
      ...
      return Yt(e) ? { type: 'Set', value: e, complement: t } : qt()
    }
    controlEscapeAtom() {
      let e
      switch (this.popChar()) {
      ...
      return Yt(e) ? { type: 'Character', value: e } : qt()
    }
    ...
    nulCharacterAtom() {
      return (this.consumeChar('0'), { type: 'Character', value: Ht('\0') })
    }
    ...
    identityEscapeAtom() {
      return { type: 'Character', value: Ht(this.popChar()) }
    }
    ...
    characterClass() {
      ...
      for (
        ...
        if ((t.type, Xt(t) && this.isRangeDash())) {
          this.consumeChar('-')
          ...
          } else (Wt(t.value, e), e.push(Ht('-')), Wt(r.value, e))
        } else Wt(t.value, e)
      }
    ...
    classEscape() {
      switch ((this.consumeChar('\\'), this.peekChar())) {
        case 'b':
          return (this.consumeChar('b'), { type: 'Character', value: Ht('\b') })
        case 'd':
        case 'D':
        case 's':
        case 'S':
    ...
    positiveInteger() {
      let e = this.popChar()
      if (!1 === rr.test(e)) throw Error('Expecting a positive integer')
      for (; tr.test(this.peekChar(0));) e += this.popChar()
      return parseInt(e, 10)
    }
    integerIncludingZero() {
      let e = this.popChar()
      if (!1 === tr.test(e)) throw Error('Expecting an integer')
      for (; tr.test(this.peekChar(0));) e += this.popChar()
      return parseInt(e, 10)
    }
    patternCharacter() {
      ...
      switch (e) {
        ...
        case '|':
          throw Error('TBD')
        default:
          return { type: 'Character', value: Ht(e) }
      }
    }
    isRegExpFlag() {
    ...
    isDigit() {
      return tr.test(this.peekChar(0))
    }
    isClassAtom(e = 0) {
    ...
    parseHexDigits(e) {
      ...
      for (let r = 0; r < e; r++) {
        let e = this.popChar()
        if (!1 === er.test(e)) throw Error('Expecting a HexDecimal digits')
        t += e
      }
          ...
          switch (r[n]) {
            case '\\':
              switch (r[n + 1]) {
                ...
                case 'p':
                case 'P':
                  t.unicode ? o(r.indexOf('}', n) - n + 1) : o(2)
                  break
                case 'k':
                  o(r.indexOf('>', n) - n + 1)
                  break
              ...
              if ('?' === r[n + 1])
                switch (r[n + 2]) {
                  ...
                  case '=':
                    ...
                    break
                  case '!':
                    ;((e = n), (n += 3), i(), (a += r.substr(e, n - e)))
                    break
                  case '<':
                    switch (r[n + 3]) {
                      case '=':
                      case '!':
                        ;((e = n), (n += 4), i(), (a += r.substr(e, n - e)))
                        break
                      default:
                        ;(s(r.indexOf('>', n) - n + 1), (a += i() + '|$)'))
                    }
                }
              else (s(1), (a += i() + '|$)'))
              break
...
function fr(e, t) {
  ...
  let i = [n].concat(
    (function (e) {
      return e.rules.filter((e) => nt(e) && e.hidden)
    })(e),
  )
  for (let s of i) pr(s, r, t)
  let a = new Set()
  for (let s of e.rules) (r.has(s.name) || (nt(s) && s.hidden)) && a.add(s)
  return a
}
function pr(e, t, r) {
  ;(t.add(e.name),
    Gt(e).forEach((e) => {
      if (xt(e) || (r && Nt(e))) {
        let n = e.rule.ref
        n && !t.has(n.name) && pr(n, t, r)
      }
    }))
}
function mr(e) {
  return e.hidden && !cr(xr(e))
}
function gr(e, t, r) {
  if (!e || !t) return
  let n = yr(e, t, e.astNode, !0)
  return 0 !== n.length
    ? n[(r = void 0 === r ? 0 : Math.max(0, Math.min(r, n.length - 1)))]
    : void 0
}
function yr(e, t, r, n) {
  if (!n) {
    let r = Mt(e.grammarSource, ft)
    if (r && r.feature === t) return [e]
  }
  return ae(e) && e.astNode === r
    ? e.content.flatMap((e) => yr(e, t, r, !1))
    : []
}
function Tr(e, t, r) {
  if (!e) return
...
function vr(e, t, r) {
  function n(t, n) {
    let i
    return (Mt(t, ft) || (i = vr(n, n, r)), r.set(e, i), i)
  }
  if (r.has(e)) return r.get(e)
  r.set(e, void 0)
  for (let i of Gt(t)) {
    if (ft(i) && 'name' === i.feature.toLowerCase()) return (r.set(e, i), i)
    if (xt(i) && Xe(i.rule.ref)) return n(i, i.rule.ref)
    if (et(i) && i.typeRef?.ref) return n(i, i.typeRef.ref)
  }
}
function Er(e) {
  return $r(e, new Set())
...
function $r(e, t) {
  ...
  for (let r of Gt(e))
    if (xt(r)) {
      if (!r.rule.ref || (Xe(r.rule.ref) && !$r(r.rule.ref, t))) return !1
    } else {
      if (ft(r)) return !1
      if (ut(r)) return !1
    }
...
function Ar(e) {
  ...
  if (e.returnType) {
    ...
    if (t && (Xe(t) || Ve(t) || at(t))) return t.name
  }
}
function kr(e) {
  if (Xe(e)) return Er(e) ? e.name : (Ar(e) ?? e.name)
  if (
    Ve(e) ||
    at(e) ||
    (function (e) {
      return Pt.isInstance(e, Je)
    })(e)
  )
    return e.name
  if (ut(e)) {
    let t = (function (e) {
      if (e.inferredType) return e.inferredType.name
      if (e.type?.ref) return kr(e.type.ref)
    })(e)
    if (t) return t
  } else if (Be(e)) return e.name
...
function Sr(e, t) {
  if (
    ...
    return (function (e) {
      return Nr(e.elements.map((e) => Sr(e)).join('|'), {
  ...
  if (
    (function (e) {
      return Pt.isInstance(e, pt)
    })(e)
  )
    return (function (e) {
      return e.right
        ? Nr(`[${Cr(e.left)}-${Cr(e.right)}]`, {
            cardinality: e.cardinality,
            lookahead: e.lookahead,
            wrap: !1,
          })
  ...
  if (
    (function (e) {
      return Pt.isInstance(e, $t)
    })(e)
  )
    return (function (e) {
      return Nr(`(?!${Sr(e.terminal)})${Ir}*?`, {
        cardinality: e.cardinality,
        lookahead: e.lookahead,
      })
    })(e)
  if (
    (function (e) {
      return Pt.isInstance(e, bt)
    })(e)
  )
    return (function (e) {
      return Nr(`${Ir}*?${Sr(e.terminal)}`, {
        cardinality: e.cardinality,
        lookahead: e.lookahead,
      })
    })(e)
  if (
    ...
    return (
      t &&
        ...
        (t.s = i.includes('s')),
        (t.u = i.includes('u'))),
      Nr(n, { cardinality: e.cardinality, lookahead: e.lookahead, wrap: !1 })
    )
  }
  if (
    (function (e) {
      return Pt.isInstance(e, Ot)
    })(e)
  )
    return Nr(Ir, { cardinality: e.cardinality, lookahead: e.lookahead })
...
function Nr(e, t) {
  return (
    (!1 !== t.wrap || t.lookahead) && (e = `(${t.lookahead ?? ''}${e})`),
    t.cardinality ? `${e}${t.cardinality}` : e
  )
}
var wr = Object.prototype.hasOwnProperty,
  Lr = i(function (e, r) {
    if (l(r) || h(r)) t(r, D(r), e)
    else for (var n in r) wr.call(r, n) && c(e, n, r[n])
  })
function br(e, t, r) {
  var n = -1,
    i = e.length
  ...
  return r(e)
    ? (function (e, t, r, n) {
        ...
        ;(r && (t = b(t, d(r))),
          n
            ? ((a = V), (s = !1))
            : t.length >= 200 && ((a = P), (s = !1), (t = new w(t))))
        e: for (; ++i < o;) {
          var c = e[i],
            h = null == r ? c : r(c)
...
function Dr(e, t, r) {
  ...
  return n ? br(e, (t = r || void 0 === t ? 1 : J(t)) < 0 ? 0 : t, n) : []
}
function Ur(e, t, r) {
  var n = null == e ? 0 : e.length
  return n
    ? br(e, 0, (t = n - (t = r || void 0 === t ? 1 : J(t))) < 0 ? 0 : t)
    : []
}
function Fr(e, t) {
...
function Br(e, t, r) {
  var n = $(e) ? Fr : Gr
  return (r && p(e, t, r) && (t = void 0), n(e, K(t, 3)))
}
function Kr(e) {
...
var jr = Object.prototype.hasOwnProperty,
  Hr = (function (e, t) {
    return function (r, n) {
      var i = $(r) ? _r : Pr,
        a = t ? t() : {}
      return i(r, e, K(n, 2), a)
    }
  })(function (e, t, r) {
    jr.call(e, r) ? e[r].push(t) : n(e, r, [t])
  }),
  Wr = Math.max
function zr(e, t, r, n) {
  ;((e = h(e) ? e : A(e)), (r = r && !n ? J(r) : 0))
  var i = e.length
  return (
    r < 0 && (r = Wr(i + r, 0)),
    H(e) ? r <= i && e.indexOf(t, r) > -1 : !!i && k(e, t, r) > -1
  )
}
var Yr = Math.max
function qr(e, t, r) {
...
function En(e) {
  ...
  if (e instanceof dn) {
    ...
    return (H(e.label) && (t.label = e.label), t)
  }
  if (e instanceof fn)
  ...
  if (e instanceof gn)
    return {
      ...
      idx: e.idx,
      separator: En(new vn({ terminalType: e.separator })),
      definition: t(e.definition),
    }
  if (e instanceof Tn)
    return {
  ...
  if (e instanceof vn) {
    let t = {
      ...
      label: un(e.terminalType),
      idx: e.idx,
    }
    H(e.label) && (t.terminalLabel = e.label)
    let r = e.terminalType.PATTERN
    return (e.terminalType.PATTERN && (t.pattern = Qr(r) ? r.source : r), t)
  }
  if (e instanceof hn)
    return {
      type: 'Rule',
...
function An(e, t = []) {
  return (
    ...
    e instanceof Tn ||
    (e instanceof Rn
      ? tn(e.definition, (e) => An(e, t))
      : !(e instanceof dn && zr(t, e)) &&
        e instanceof cn &&
        (e instanceof dn && t.push(e), Br(e.definition, (e) => An(e, t))))
  )
}
function kn(e) {
  if (e instanceof dn) return 'SUBRULE'
  if (e instanceof pn) return 'OPTION'
  if (e instanceof Rn) return 'OR'
  if (e instanceof mn) return 'AT_LEAST_ONE'
  if (e instanceof gn) return 'AT_LEAST_ONE_SEP'
  if (e instanceof Tn) return 'MANY_SEP'
  if (e instanceof yn) return 'MANY'
  if (e instanceof vn) return 'CONSUME'
  throw Error('non exhaustive match')
}
var xn = class {
  walk(e, t = []) {
    F(e.definition, (r, n) => {
      let i = Dr(e.definition, n + 1)
      if (r instanceof dn) this.walkProdRef(r, i, t)
      else if (r instanceof vn) this.walkTerminal(r, i, t)
      else if (r instanceof fn) this.walkFlat(r, i, t)
      else if (r instanceof pn) this.walkOption(r, i, t)
      else if (r instanceof mn) this.walkAtLeastOne(r, i, t)
      else if (r instanceof gn) this.walkAtLeastOneSep(r, i, t)
      else if (r instanceof Tn) this.walkManySep(r, i, t)
      else if (r instanceof yn) this.walkMany(r, i, t)
      else {
        if (!(r instanceof Rn)) throw Error('non exhaustive match')
        this.walkOr(r, i, t)
      }
    })
  }
  ...
  walkAtLeastOne(e, t, r) {
    let n = [new pn({ definition: e.definition })].concat(t, r)
    this.walk(e, n)
  }
...
function In(e, t, r) {
  return [
    new pn({
      definition: [new vn({ terminalType: e.separator })].concat(e.definition),
    }),
  ].concat(t, r)
}
function Sn(e) {
  if (e instanceof dn) return Sn(e.referencedRule)
  if (e instanceof vn)
    return (function (e) {
  ...
  if (
    ...
    return (function (e) {
      return rn(j(X(e.definition, (e) => Sn(e))))
    })(e)
  throw Error('non exhaustive match')
}
var Cn = '_~IN~_',
  Nn = class extends xn {
    ...
    walkProdRef(e, t, r) {
      let n =
          (function (e, t) {
            return e.name + t + Cn
          })(e.referencedRule, e.idx) + this.topProd.name,
        i = Sn(new fn({ definition: t.concat(r) }))
      this.follows[n] = i
    }
  }
var wn = {},
...
var On = 'Complement Sets are not supported for first char optimization'
function _n(e, t = !1) {
  try {
    let t = bn(e)
    return Pn(t.value, {}, t.flags.ignoreCase)
  } catch (ee) {
    if (ee.message === On) t && sn(e.toString())
    else {
      let r = ''
      ;(t &&
        (r =
...
function Pn(e, t, r) {
  switch (e.type) {
    case 'Disjunction':
      for (let i = 0; i < e.value.length; i++) Pn(e.value[i], t, r)
      break
    case 'Alternative':
      let n = e.value
      for (let e = 0; e < n.length; e++) {
        ...
        switch (a.type) {
          case 'Character':
            ...
            break
          case 'Set':
            if (!0 === a.complement) throw Error(On)
            F(a.value, (e) => {
              if ('number' == typeof e) Mn(e, t, r)
              else {
                let n = e
                if (!0 === r) for (let e = n.from; e <= n.to; e++) Mn(e, t, r)
                else {
                  for (let e = n.from; e <= n.to && e < 256; e++) Mn(e, t, r)
                  if (n.to >= 256) {
                    let e = n.from >= 256 ? n.from : 256,
                      r = n.to,
                      i = ii(e),
                      a = ii(r)
                    for (let n = i; n <= a; n++) t[n] = n
                  }
                }
              }
            })
        ...
        let s = void 0 !== a.quantifier && 0 === a.quantifier.atLeast
        if (
          ('Group' === a.type && !1 === Un(a)) ||
          ('Group' !== a.type && !1 === s)
        )
    ...
    !0 === r &&
      (function (e, t) {
        let r = String.fromCharCode(e),
          n = r.toUpperCase()
        if (n !== r) {
          let e = ii(n.charCodeAt(0))
          t[e] = e
        } else {
          let e = r.toLowerCase()
          if (e !== r) {
            let r = ii(e.charCodeAt(0))
            t[r] = r
          }
        }
      })(e, t))
...
function Dn(e, t) {
  return z(e.value, (e) => {
    if ('number' == typeof e) return zr(t, e)
    {
      let r = e
      return void 0 !== z(t, (e) => r.from <= e && e <= r.to)
    }
  })
}
function Un(e) {
  ...
  return (
    !(!t || 0 !== t.atLeast) ||
    (!!e.value && ($(e.value) ? Br(e.value, Un) : Un(e.value)))
  )
}
var Fn = class extends ir {
  constructor(e) {
  ...
  visitCharacter(e) {
    zr(this.targetCharCodes, e.value) && (this.found = !0)
  }
  visitSet(e) {
    e.complement
      ? void 0 === Dn(e, this.targetCharCodes) && (this.found = !0)
      : void 0 !== Dn(e, this.targetCharCodes) && (this.found = !0)
  }
}
function Gn(e, t) {
  ...
  return void 0 !== z(t, (t) => zr(e, t.charCodeAt(0)))
}
var Bn = 'PATTERN',
  Kn = 'defaultMode',
  Vn = 'boolean' == typeof RegExp('(?:)').sticky
function jn(t, r) {
  let n,
    i = (r = Y(r, {
      useSticky: Vn,
  ...
  ;(i('initCharCodeToOptimizedIndexMap', () => {
    !(function () {
      if (g(ni)) {
        ni = Array(65536)
        for (let e = 0; e < 65536; e++) ni[e] = e > 255 ? 255 + ~~(e / 255) : e
      }
    })()
  }),
    i('Reject Lexer.NA', () => {
  ...
  ;(i('Transform Patterns', () => {
    ;((y = !1),
      (a = X(n, (t) => {
        ...
        if (e(n)) return ((y = !0), { exec: n })
        if ('object' == typeof n) return ((y = !0), n)
        if ('string' == typeof n) {
          if (1 === n.length) return n
          {
            let e = n.replace(/[\\^$.*+?()[\]{}|]/g, '\\$&'),
              t = new RegExp(e)
            return r.useSticky ? qn(t) : Yn(t)
          }
        }
        throw Error('non exhaustive match')
      })))
    ...
    i('misc mapping', () => {
      ;((s = X(n, (e) => e.tokenTypeIdx)),
        ...
        (l = X(n, (e) => {
          let t = e.LONGER_ALT
          if (t) return $(t) ? X(t, (e) => qr(n, e)) : [qr(n, t)]
        })),
        (u = X(n, (e) => e.PUSH_MODE)),
        (c = X(n, (e) => Z(e, 'POP_MODE'))))
    }),
    i('Line Terminator Handling', () => {
      let e = ti(r.lineTerminatorCharacters)
      ;((d = X(n, (e) => !1)),
        'onlyOffset' !== r.positionTracking &&
          (d = X(n, (t) =>
            Z(t, 'LINE_BREAKS')
              ? !!t.LINE_BREAKS
              : !1 === Zn(t, e) && Gn(e, t.PATTERN),
          )))
    }),
    i('Misc Mapping #2', () => {
      ;((h = X(n, Xn)),
  ...
  return (
    r.safeMode ||
      i('First Char Optimization', () => {
        R = O(
          n,
          (e, t, n) => {
            if ('string' == typeof t.PATTERN)
              ri(e, ii(t.PATTERN.charCodeAt(0)), m[n])
            else if ($(t.START_CHARS_HINT)) {
              let r
              F(t.START_CHARS_HINT, (t) => {
                let i = ii('string' == typeof t ? t.charCodeAt(0) : t)
                r !== i && ((r = i), ri(e, i, m[n]))
              })
            } else if (Qr(t.PATTERN))
              if (t.PATTERN.unicode)
                ((T = !1), r.ensureOptimizations && an(t.PATTERN.toString()))
              else {
                let i = _n(t.PATTERN, r.ensureOptimizations)
                ;(g(i) && (T = !1),
                  F(i, (t) => {
                    ri(e, t, m[n])
                  }))
              }
            else (r.ensureOptimizations && an(t.name), (T = !1))
            return e
          },
          [],
        )
  ...
  return (
      ...
      (function (e) {
        ...
        return (
            ...
            (function (e) {
              return X(
                ...
                (e) => ({
                  ...
                  type: pi.UNSUPPORTED_FLAGS_FOUND,
                  tokenTypes: [e],
                }),
              )
            })(r),
              ...
              let t = [],
                r = X(e, (r) =>
                  O(
                    e,
                    (e, n) => (
                      r.PATTERN.source !== n.PATTERN.source ||
                        zr(t, n) ||
                        n.PATTERN === yi.NA ||
                        (t.push(n), e.push(n)),
                      e
              ...
              return (
                ...
                X(
                  ...
                  (e) => {
                    let t = X(e, (e) => e.name)
                    return {
                      message: `The same RegExp pattern ->${Kr(e).PATTERN}<-has been used in all of the following Token Types: ${t.join(', ')} <-`,
                      type: pi.DUPLICATE_PATTERNS_FOUND,
                      tokenTypes: e,
                    }
                  },
                )
          ...
          (t = t.concat(
            (function (e) {
              return X(
                M(e, (e) => e.PATTERN.test('')),
                (e) => ({
                  message:
                    'Token Type: ->' +
                    e.name +
                    "<- static 'PATTERN' must not match an empty string",
                  type: pi.EMPTY_MATCH_PATTERN,
                  tokenTypes: [e],
                }),
              )
            })(r),
    ...
    (n = n.concat(
      (function (e) {
        return X(
          M(e, (e) => {
            if (!Z(e, 'GROUP')) return !1
            let t = e.GROUP
            return t !== yi.SKIPPED && t !== yi.NA && !H(t)
          }),
          (e) => ({
            message:
              'Token Type: ->' +
            ...
            type: pi.INVALID_GROUP_TYPE_FOUND,
            tokenTypes: [e],
          }),
        )
      })(s),
          ...
          n = O(
            ...
            (e, t, r) => {
              ...
              return (
                n === yi.NA ||
                  (H(n)
                    ? e.push({ str: n, idx: r, tokenType: t })
                    : Qr(n) &&
                      (function (e) {
                        return (
                          void 0 ===
                      ...
                      e.push({ str: n.source, idx: r, tokenType: t })),
                e
              )
            },
            [],
            ...
            F(n, ({ str: n, idx: a, tokenType: s }) => {
              if (
                ...
                (function (t, r) {
                  ...
                  if (e(r)) return r(t, 0, [], {})
                  if (Z(r, 'exec')) return r.exec(t, 0, [], {})
                  if ('string' == typeof r) return r === t
                  throw Error('non exhaustive match')
                })(n, t.PATTERN)
              ) {
                let e = `Token: ->${s.name}<- can never be matched.\nBecause it appears AFTER the Token Type ->${t.name}<-in the lexer's definition.\nSee https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNREACHABLE`
                r.push({
                  message: e,
                  type: pi.UNREACHABLE_PATTERN,
                  tokenTypes: [t, s],
                })
              }
            })
...
function Xn(t) {
  let r = t.PATTERN
  if (Qr(r)) return !1
  if (e(r) || Z(r, 'exec')) return !0
  if (H(r)) return !1
  throw Error('non exhaustive match')
}
function Qn(e) {
  return !(!H(e) || 1 !== e.length) && e.charCodeAt(0)
}
var Jn = {
  test: function (e) {
    let t = e.length
...
function Zn(e, t) {
  if (Z(e, 'LINE_BREAKS')) return !1
  if (Qr(e.PATTERN)) {
    try {
      Gn(t, e.PATTERN)
    } catch (e) {
      return { issue: pi.IDENTIFY_TERMINATOR, errMsg: e.message }
    }
    return !1
  }
  if (H(e.PATTERN)) return !1
  if (Xn(e)) return { issue: pi.CUSTOM_LINE_BREAK }
  throw Error('non exhaustive match')
}
function ei(e, t) {
  if (t.issue === pi.IDENTIFY_TERMINATOR)
    return `Warning: unable to identify line terminator usage in pattern.\n\tThe problem is in the <${e.name}> Token Type\n\t Root cause: ${t.errMsg}.\n\tFor details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#IDENTIFY_TERMINATOR`
  if (t.issue === pi.CUSTOM_LINE_BREAK)
    return `Warning: A Custom Token Pattern should specify the <line_breaks> option.\n\tThe problem is in the <${e.name}> Token Type\n\tFor details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_LINE_BREAK`
  throw Error('non exhaustive match')
}
function ti(e) {
  return X(e, (e) => (H(e) ? e.charCodeAt(0) : e))
}
function ri(e, t, r) {
...
function ai(e, t) {
  ...
  return (
    r === t.tokenTypeIdx ||
    (!0 === t.isParent && !0 === t.categoryMatchesMap[r])
  )
}
function si(e, t) {
...
function ui(e) {
  let t = (function (e) {
    let t = ee(e),
      ...
      n = !0
    for (; n;) {
      r = Or(j(X(r, (e) => e.CATEGORIES)))
      let e = Mr(r, t)
      ;((t = t.concat(e)), g(e) ? (n = !1) : (r = e))
    }
    return t
  })(e)
  ;((function (e) {
    F(e, (e) => {
      ;(di(e) || ((li[oi] = e), (e.tokenTypeIdx = oi++)),
        hi(e) && !$(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]),
        hi(e) || (e.CATEGORIES = []),
        (function (e) {
    ...
    (function (e) {
      F(e, (e) => {
        ;((e.categoryMatches = []),
          F(e.categoryMatchesMap, (t, r) => {
            e.categoryMatches.push(li[r].tokenTypeIdx)
          }))
      })
    })(t),
    F(t, (e) => {
...
var yi = class {
      ...
      this.TRACE_INIT('Lexer Constructor', () => {
        ...
        ;(this.TRACE_INIT('Lexer Config handling', () => {
          if (this.config.lineTerminatorsPattern === gi.lineTerminatorsPattern)
            this.config.lineTerminatorsPattern = Jn
          else if (
            this.config.lineTerminatorCharacters === gi.lineTerminatorCharacters
          )
            throw Error(
          ...
          ;((this.trackStartLines = /full|onlyStart/i.test(
            ...
            $(e)
              ? (r = { modes: { defaultMode: ee(e) }, defaultMode: Kn })
              : ((n = !1), (r = ee(e))))
        }),
              ...
              this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
                (function (e) {
                  ...
                  return (
                    ...
                    Z(e, 'modes') &&
                      Z(e, 'defaultMode') &&
                      !Z(e.modes, e.defaultMode) &&
                      t.push({
                        message: `A MultiMode Lexer cannot be initialized with a ${Kn}: <${e.defaultMode}>which does not exist\n`,
                      ...
                      F(e.modes, (e, r) => {
                        F(e, (n, i) => {
                          S(n)
                            ...
                            : Z(n, 'LONGER_ALT') &&
                              F(
                                $(n.LONGER_ALT) ? n.LONGER_ALT : [n.LONGER_ALT],
                                (i) => {
                                  !S(i) &&
                                    !zr(e, i) &&
                                    t.push({
            ...
            this.TRACE_INIT('performWarningRuntimeChecks', () => {
              this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(
                (function (e, t, r) {
                  let n = [],
                    i = !1,
                    a = Zr(Or(j(A(e.modes))), (e) => e[Bn] === yi.NA),
                    s = ti(r)
                  return (
                    t &&
                      F(a, (e) => {
        ...
        if (
              ...
              if (
                ...
                !1 === this.config.skipValidations &&
                  this.TRACE_INIT('validatePatterns', () => {
                    this.lexerDefinitionErrors =
                      this.lexerDefinitionErrors.concat(Hn(e, i))
                  }),
                ...
                ;(ui(e),
                  ...
                  (this.charCodeToPatternIdxToConfig[r] =
                    n.charCodeToPatternIdxToConfig),
                  (this.emptyGroups = Lr({}, this.emptyGroups, n.emptyGroups)),
          ...
          let e = X(this.lexerDefinitionErrors, (e) => e.message).join(
            '-----------------------\n',
          )
          throw Error('Errors detected in definition of Lexer:\n' + e)
        }
        ;(F(this.lexerDefinitionWarning, (e) => {
          sn(e.message)
        }),
          this.TRACE_INIT('Choosing sub-methods implementations', () => {
            if (
              (Vn
                ? ((this.chopInput = E), (this.match = this.matchWithTest))
                : ((this.updateLastIndex = x),
                  (this.match = this.matchWithExec)),
              n && (this.handleModes = x),
              !1 === this.trackStartLines && (this.computeNewColumn = E),
              !1 === this.trackEndLines &&
                (this.updateTokenEndLineColumnLocation = x),
          ...
          this.TRACE_INIT('Failed Optimization Warnings', () => {
            let e = O(
              this.canModeBeOptimized,
              (e, t, r) => (!1 === t && e.push(r), e),
              [],
            )
            if (t.ensureOptimizations && !g(e))
              throw Error(
  ...
  tokenizeInternal(e, t) {
    let r,
      ...
      v = 0,
      E = 0,
      A = this.hasCustom ? 0 : Math.floor(e.length / 10),
      k = Array(A),
      x = [],
      ...
      C = (function (e) {
        ...
        return (
          F(D(e), (r) => {
            let n = e[r]
            if (!$(n)) throw Error('non exhaustive match')
            t[r] = []
          }),
          t
        )
    ...
    B.call(this, t)
    let K,
      V = this.config.recoveryEnabled
    for (; v < R;) {
      o = null
      let t = T.charCodeAt(v),
        $ = y(t),
        A = $.length
      for (r = 0; r < A; r++) {
        K = $[r]
          ...
          (!1 === c
            ? !0 === K.isCustom
              ? ((g = n.exec(T, v, k, C)),
                null === g
                  ? (o = null)
                  : ((o = g[0]), void 0 !== g.payload && (l = g.payload)))
              : (this.updateLastIndex(n, v), (o = this.match(n, e, v)))
            : t === c && (o = n),
          null !== o)
        ) {
          if (((s = K.longerAlt), void 0 !== s)) {
            let t = s.length
            for (i = 0; i < t; i++) {
              let t = b[s[i]],
                r = t.pattern
              if (
                ...
                !0 === t.isCustom
                  ? ((g = r.exec(T, v, k, C)),
                    null === g
                      ? (a = null)
                      : ((a = g[0]), void 0 !== g.payload && (u = g.payload)))
                  : (this.updateLastIndex(r, v), (a = this.match(r, e, v))),
                a && a.length > o.length)
              ) {
                ;((o = a), (l = u), (K = t))
                break
      ...
      if (null !== o) {
        if (
          ...
          void 0 !== d &&
            ((h = K.tokenTypeIdx),
            (f = this.createTokenInstance(o, v, h, K.tokenType, I, S, c)),
            this.handlePayload(f, l),
            !1 === d ? (E = this.addToken(k, E, f)) : C[d].push(f)),
          (e = this.chopInput(e, c)),
          (v += c),
          (S = this.computeNewColumn(S, c)),
          !0 === N && !0 === K.canLineTerminator)
        ) {
          let e,
            t,
            r = 0
          w.lastIndex = 0
          do {
            ;((e = w.test(o)), !0 === e && ((t = w.lastIndex - 1), r++))
          } while (!0 === e)
          0 !== r &&
            ((I += r),
            (S = c - t),
            this.updateTokenEndLineColumnLocation(f, d, t, r, I, S, c))
        }
        this.handleModes(K, G, B, f)
      } else {
        let t = v,
          r = I,
          i = S,
          a = !1 === V
        for (; !1 === a && v < R;)
          for (e = this.chopInput(e, 1), v++, n = 0; n < L; n++) {
            let t = b[n],
              r = t.pattern,
              i = t.short
            if (
              (!1 === i
                ? !0 === t.isCustom
                  ? (a = null !== r.exec(T, v, k, C))
                  : (this.updateLastIndex(r, v), (a = null !== r.exec(e)))
                : T.charCodeAt(v) === i && (a = !0),
              !0 === a)
            )
              break
          }
        if (
          ...
          x.push({ offset: t, line: r, column: i, length: p, message: m }),
          !1 === V)
        )
          break
      }
    ...
    return (
      this.hasCustom || (k.length = E),
      { tokens: k, groups: C, errors: x }
    )
  }
  handleModes(e, t, r, n) {
    if (!0 === e.pop) {
  ...
  updateTokenEndLineColumnLocation(e, t, r, n, i, a, s) {
    ...
    void 0 !== t &&
      ((o = r === s - 1),
      (l = o ? -1 : 0),
      (1 === n && !0 === o) || ((e.endLine = i + l), (e.endColumn = a - 1 - l)))
  }
...
function Ni(e) {
  return (function (e) {
    let t = e.pattern,
      r = {}
    if (((r.name = e.name), S(t) || (r.PATTERN = t), Z(e, vi)))
      throw 'The parent property is no longer supported.\nSee: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.'
    return (
      Z(e, Ei) && (r.CATEGORIES = e[Ei]),
      ui([r]),
      Z(e, $i) && (r.LABEL = e[$i]),
      Z(e, Ai) && (r.GROUP = e[Ai]),
      Z(e, xi) && (r.POP_MODE = e[xi]),
      Z(e, ki) && (r.PUSH_MODE = e[ki]),
      Z(e, Ii) && (r.LONGER_ALT = e[Ii]),
      Z(e, Si) && (r.LINE_BREAKS = e[Si]),
      Z(e, Ci) && (r.START_CHARS_HINT = e[Ci]),
      r
    )
  })(e)
}
var wi = Ni({ name: 'EOF', pattern: yi.NA })
function Li(e, t, r, n, i, a, s, o) {
  return {
    image: t,
    startOffset: r,
    endOffset: n,
...
var Oi = {
  buildMismatchTokenMessage: ({
    ...
    `Expecting ${Ri(e) ? `--\x3e ${Ti(e)} <--` : `token of type --\x3e ${e.name} <--`} but found --\x3e '${t.image}' <--`,
...
var _i = {
  ...
  Pi = {
    ...
    buildAlternationPrefixAmbiguityError(e) {
      let t = X(e.prefixPath, (e) => Ti(e)).join(', '),
    ...
    buildDuplicateRuleNameError(e) {
      ...
      return (
        (t =
          e.topLevelRule instanceof hn ? e.topLevelRule.name : e.topLevelRule),
...
var Mi,
  Di = class extends $n {
    ...
    visitNonTerminal(e) {
      ...
      if (t) e.referencedRule = t
        ...
        this.errors.push({
          message: t,
          type: es.UNRESOLVED_SUBRULE_REF,
  ...
  Ui = class extends xn {
    ...
    startWalking() {
      ...
      return (
        (this.ruleStack = ee(this.path.ruleStack).reverse()),
        (this.occurrenceStack = ee(this.path.occurrenceStack).reverse()),
        this.ruleStack.pop(),
  ...
  Fi = class extends Ui {
    ...
    walkTerminal(e, t, r) {
      if (
        ...
        let e = new fn({ definition: t.concat(r) })
        ;((this.possibleTokTypes = Sn(e)), (this.found = !0))
      }
    }
  },
  Gi = class extends xn {
...
function Hi(e, t, r = []) {
  ...
  for (; r.length < t && i < e.length;) {
    let t = e[i]
    if (t instanceof fn || t instanceof dn) return s(t.definition)
    if (t instanceof pn) n = s(t.definition)
    else {
      if (t instanceof mn)
        return s(t.definition.concat([new yn({ definition: t.definition })]))
      if (t instanceof gn)
        return s([
          new fn({ definition: t.definition }),
          new yn({
            definition: [new vn({ terminalType: t.separator })].concat(
              t.definition,
            ),
          }),
        ])
      if (t instanceof Tn)
        ...
        n = s(t.definition.concat([new yn({ definition: t.definition })]))
      else {
        if (t instanceof Rn)
          return (
            F(t.definition, (e) => {
              !1 === g(e.definition) && (n = s(e.definition))
            }),
            n
          )
        if (!(t instanceof vn)) throw Error('non exhaustive match')
        r.push(t.terminalType)
      }
    }
    i++
  }
  return (n.push({ partialPath: r, suffixDef: Dr(e, i) }), n)
}
function Wi(e, t, r, n) {
  ...
  for (
    ...
    let m = n[0]
    if (m === i) {
      let e = { idx: h, def: Dr(n), ruleStack: Ur(f), occurrenceStack: Ur(p) }
      d.push(e)
    } else if (m instanceof vn)
      if (h < l - 1) {
        let e = h + 1
        if (r(t[e], m.terminalType)) {
          let t = { idx: e, def: Dr(n), ruleStack: f, occurrenceStack: p }
          d.push(t)
        }
      } else {
      ...
      let r = {
        idx: h,
        def: m.definition.concat(a, Dr(n)),
        ruleStack: e,
        occurrenceStack: t,
      }
      d.push(r)
    } else if (m instanceof pn) {
      let e = { idx: h, def: Dr(n), ruleStack: f, occurrenceStack: p }
      ;(d.push(e), d.push(s))
      let t = {
        idx: h,
        def: m.definition.concat(Dr(n)),
        ruleStack: f,
        occurrenceStack: p,
      }
      d.push(t)
    } else if (m instanceof mn) {
      let e = new yn({ definition: m.definition, idx: m.idx }),
        t = {
          idx: h,
          def: m.definition.concat([e], Dr(n)),
          ruleStack: f,
          occurrenceStack: p,
        }
      d.push(t)
      ...
      let e = new yn({
          definition: [new vn({ terminalType: m.separator })].concat(
            m.definition,
          ),
          idx: m.idx,
        }),
      ...
      let t = new yn({
        ...
        r = {
          idx: h,
          def: m.definition.concat([t], Dr(n)),
          ruleStack: f,
          occurrenceStack: p,
        }
      d.push(r)
    } else if (m instanceof yn) {
      let e = { idx: h, def: Dr(n), ruleStack: f, occurrenceStack: p }
      ;(d.push(e), d.push(s))
      let t = new yn({ definition: m.definition, idx: m.idx }),
        r = {
          idx: h,
          def: m.definition.concat([t], Dr(n)),
          ruleStack: f,
      ...
      d.push(r)
    } else if (m instanceof Rn)
      for (let t = m.definition.length - 1; t >= 0; t--) {
        let e = {
          idx: h,
          def: m.definition[t].definition.concat(Dr(n)),
          ruleStack: f,
          occurrenceStack: p,
        }
        ;(d.push(e), d.push(s))
      }
    else if (m instanceof fn)
      d.push({
        idx: h,
        def: m.definition.concat(Dr(n)),
        ruleStack: f,
      ...
      if (!(m instanceof hn)) throw Error('non exhaustive match')
      d.push(zi(m, h, f, p))
    }
  }
  return c
...
function Yi(e) {
  if (e instanceof pn || 'Option' === e) return Mi.OPTION
  if (e instanceof yn || 'Repetition' === e) return Mi.REPETITION
  if (e instanceof mn || 'RepetitionMandatory' === e)
    return Mi.REPETITION_MANDATORY
  if (e instanceof gn || 'RepetitionMandatoryWithSeparator' === e)
    return Mi.REPETITION_MANDATORY_WITH_SEPARATOR
  if (e instanceof Tn || 'RepetitionWithSeparator' === e)
    return Mi.REPETITION_WITH_SEPARATOR
  if (e instanceof Rn || 'Alternation' === e) return Mi.ALTERNATION
  throw Error('non exhaustive match')
}
function qi(e) {
  let { occurrence: t, rule: r, prodType: n, maxLookahead: i } = e,
    a = Yi(n)
  return a === Mi.ALTERNATION ? ia(t, r, i) : aa(t, r, a, i)
}
function Xi(e, t, r, n) {
  let i = e.length,
    a = Br(e, (e) => Br(e, (e) => 1 === e.length))
  if (t)
    return function (t) {
      let n = X(t, (e) => e.GATE)
      for (let a = 0; a < i; a++) {
        ...
        if (void 0 === s || !1 !== s.call(this))
          e: for (let e = 0; e < i; e++) {
            let n = t[e],
              i = n.length
            for (let e = 0; e < i; e++)
              if (!1 === r(this.LA(e + 1), n[e])) continue e
            return a
          }
      }
    }
  if (a && !n) {
    let t = O(
      ...
      (e, t, r) => (
        F(t, (t) => {
          ;(Z(e, t.tokenTypeIdx) || (e[t.tokenTypeIdx] = r),
    ...
    for (let t = 0; t < i; t++) {
      ...
      e: for (let e = 0; e < i; e++) {
        let i = n[e],
          a = i.length
        for (let e = 0; e < a; e++)
          if (!1 === r(this.LA(e + 1), i[e])) continue e
        return t
      }
    }
  }
...
function Qi(e, t, r) {
  let n = Br(e, (e) => 1 === e.length),
    i = e.length
  if (n && !r) {
    let t = j(e)
    if (1 === t.length && g(t[0].categoryMatches)) {
  ...
  return function () {
    e: for (let r = 0; r < i; r++) {
      let n = e[r],
        i = n.length
      for (let e = 0; e < i; e++) if (!1 === t(this.LA(e + 1), n[e])) continue e
      return !0
    }
    return !1
  }
...
var Ji = class extends xn {
    ...
    checkIsTarget(e, t, r, n) {
      return (
        ...
        ((this.restDef = r.concat(n)), !0)
      )
    }
    walkOption(e, t, r) {
      this.checkIsTarget(e, Mi.OPTION, t, r) || super.walkOption(e, t, r)
    }
    walkAtLeastOne(e, t, r) {
      this.checkIsTarget(e, Mi.REPETITION_MANDATORY, t, r) ||
        super.walkOption(e, t, r)
    }
    walkAtLeastOneSep(e, t, r) {
      this.checkIsTarget(e, Mi.REPETITION_MANDATORY_WITH_SEPARATOR, t, r) ||
        super.walkOption(e, t, r)
    }
    walkMany(e, t, r) {
      this.checkIsTarget(e, Mi.REPETITION, t, r) || super.walkOption(e, t, r)
    }
    walkManySep(e, t, r) {
      this.checkIsTarget(e, Mi.REPETITION_WITH_SEPARATOR, t, r) ||
        super.walkOption(e, t, r)
    }
  },
  Zi = class extends $n {
    ...
    visitOption(e) {
      this.checkIsTarget(e, Mi.OPTION)
    }
    visitRepetition(e) {
      this.checkIsTarget(e, Mi.REPETITION)
    }
    visitRepetitionMandatory(e) {
      this.checkIsTarget(e, Mi.REPETITION_MANDATORY)
    }
    visitRepetitionMandatoryWithSeparator(e) {
      this.checkIsTarget(e, Mi.REPETITION_MANDATORY_WITH_SEPARATOR)
    }
    visitRepetitionWithSeparator(e) {
      this.checkIsTarget(e, Mi.REPETITION_WITH_SEPARATOR)
    }
    visitAlternation(e) {
      this.checkIsTarget(e, Mi.ALTERNATION)
    }
  }
function ea(e) {
  let t = Array(e)
  ...
  for (let s = 1; s <= t; s++) {
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      for (let e = 0; e < o.length; e++) {
        let l = o[e].partialPath,
          u = o[e].suffixDef,
          c = ta(l)
        if (ra(i, c, r) || g(u) || l.length === t) {
          let e = n[r]
          if (!1 === sa(e, l)) {
            e.push(l)
...
function ia(e, t, r, n) {
  let i = new Zi(e, Mi.ALTERNATION, n)
  return (t.accept(i), na(i.result, r))
}
function aa(e, t, r, n) {
  let i = new Zi(e, r)
  t.accept(i)
  let a = i.result,
    s = new Ji(t, e, r).startWalking()
  return na([new fn({ definition: a }), new fn({ definition: s })], n)
}
function sa(e, t) {
  e: for (let r = 0; r < e.length; r++) {
    ...
    if (n.length === t.length) {
      for (let e = 0; e < n.length; e++) {
        let r = t[e],
          i = n[e]
        if (r !== i && void 0 === i.categoryMatchesMap[r.tokenTypeIdx])
          continue e
      }
      return !0
    }
...
function oa(e) {
  return Br(e, (e) => Br(e, (e) => Br(e, (e) => g(e.categoryMatches))))
}
function la(e, t, r, n) {
  let i = Vr(e, (e) =>
      (function (e, t) {
        ...
        return X(A(Jr(Hr(n, ua), (e) => e.length > 1)), (r) => {
          let n = Kr(r),
            i = t.buildDuplicateFoundError(e, r),
            a = kn(n),
            s = {
              message: i,
              type: es.DUPLICATE_PRODUCTIONS,
              ruleName: e.name,
              dslName: a,
              occurrence: n.idx,
            },
    ...
    a = (function (e, t, r) {
      ...
      return (
        F(e, (e) => {
          let t = e.name
          if (zr(i, t)) {
            let i = r.buildNamespaceConflictError(e)
            n.push({
              message: i,
              type: es.CONFLICT_TOKENS_RULES_NAMESPACE,
              ruleName: t,
            })
          }
        }),
    ...
    o = Vr(e, (t) =>
      (function (e, t, r, n) {
        let i = []
        if (O(t, (t, r) => (r.name === e.name ? t + 1 : t), 0) > 1) {
          let t = n.buildDuplicateRuleNameError({
            topLevelRule: e,
            grammarName: r,
          })
          i.push({ message: t, type: es.DUPLICATE_RULE_NAME, ruleName: e.name })
        }
        return i
      })(t, e, n, r),
    )
...
function ua(e) {
  return `${kn(e)}_#_${e.idx}_#_${ca(e)}`
}
function ca(e) {
  return e instanceof vn
    ? e.terminalType.name
  ...
  if (g(a)) return []
  {
    ...
    zr(a, e) &&
      i.push({
        ...
        type: es.LEFT_RECURSION,
        ruleName: t,
      })
    let s = Vr(Mr(a, n.concat([e])), (t) => {
      let i = ee(n)
      return (i.push(t), ha(e, t, r, i))
    })
    return i.concat(s)
  }
}
function fa(e) {
  ...
  if (g(e)) return t
  let r = Kr(e)
  if (r instanceof dn) t.push(r.referencedRule)
  else if (
    r instanceof fn ||
    r instanceof pn ||
    r instanceof mn ||
    ...
    t = t.concat(fa(r.definition))
  else if (r instanceof Rn) t = j(X(r.definition, (e) => fa(e.definition)))
  else if (!(r instanceof vn)) throw Error('non exhaustive match')
  let n = An(r),
    i = e.length > 1
  if (n && i) {
    let r = Dr(e)
    return t.concat(fa(r))
  }
  return t
}
...
function ma(e, t, r) {
  ...
  return (
    (i = Zr(i, (e) => !0 === e.ignoreAmbiguities)),
    Vr(i, (n) => {
      let i = ia(n.idx, e, n.maxLookahead || t, n),
        a = (function (e, t, r, n) {
          let i = []
          return X(
            O(
              e,
              (r, n, a) => (
                !0 === t.definition[a].ignoreAmbiguities ||
                  F(n, (n) => {
                    let s = [a]
                    ;(F(e, (e, r) => {
                      a !== r &&
                        sa(e, n) &&
                        !0 !== t.definition[r].ignoreAmbiguities &&
                        s.push(r)
                    }),
                      s.length > 1 &&
                        !sa(i, n) &&
                        (i.push(n), r.push({ alts: s, path: n })))
                  }),
                r
              ),
              [],
...
var Ta = 'MismatchedTokenException',
  Ra = 'NoViableAltException',
  va = 'EarlyExitException',
...
var ka = class extends Error {
  ...
  xa = class extends ka {
    constructor(e, t, r) {
      ;(super(e, t), (this.previousToken = r), (this.name = Ta))
    }
  },
  Ia = class extends ka {
    constructor(e, t, r) {
      ;(super(e, t), (this.previousToken = r), (this.name = Ra))
    }
  },
  Sa = class extends ka {
    constructor(e, t) {
      ;(super(e, t), (this.name = Ea))
    }
  },
  Ca = class extends ka {
    constructor(e, t, r) {
      ;(super(e, t), (this.previousToken = r), (this.name = va))
    }
  },
  Na = {},
    ...
    validate(e) {
      ...
      if (g(t)) {
        let r = this.validateEmptyOrAlternatives(e.rules),
          n = this.validateAmbiguousAlternationAlternatives(
            e.rules,
            this.maxLookahead,
          ),
          ...
          F(e, (e) => {
            ...
            F(a, (i) => {
              ...
              if (g(j(o))) {
                ...
                n.push({
                  message: t,
                  type: es.NO_NON_EMPTY_LOOKAHEAD,
                  ruleName: e.name,
                })
              }
            })
...
function Va(t, r) {
  let n = function () {}
  return (
    Ba(n, t + 'BaseSemantics'),
    (n.prototype = {
      visit: function (e, t) {
        if (($(e) && (e = e[0]), !S(e))) return this[e.name](e.children, t)
      },
          ...
          return (function (t, r) {
            return Or(
              X(
                M(r, (r) => !1 === e(t[r])),
                (e) => ({
                  msg: `Missing visitor method: <${e}> on ${t.constructor.name} CST Visitor.`,
                  type: Ga.MISSING_METHOD,
                  methodName: e,
                }),
              ),
            )
...
Object.freeze(ja)
var Ha = !0,
  Wa = Ni({ name: 'RECORDING_PHASE_TOKEN', pattern: yi.NA })
ui([Wa])
var za = Li(
  Wa,
...
function qa(t, r, n, i = !1) {
  Ja(n)
  let a = q(this.recordingProdStack),
    s = e(r) ? r : r.DEF,
    o = new t({ definition: [], idx: n })
  return (
    i && (o.separator = r.SEP),
    Z(r, 'MAX_LOOKAHEAD') && (o.maxLookahead = r.MAX_LOOKAHEAD),
...
function Xa(t, r) {
  Ja(r)
  let n = q(this.recordingProdStack),
    i = !1 === $(t),
    a = !1 === i ? t : t.DEF,
    s = new Rn({
      definition: [],
      idx: r,
      ignoreAmbiguities: i && !0 === t.IGNORE_AMBIGUITIES,
    })
  return (
    Z(t, 'MAX_LOOKAHEAD') && (s.maxLookahead = t.MAX_LOOKAHEAD),
    (s.hasPredicates = tn(a, (t) => e(t.GATE))),
    n.definition.push(s),
    F(a, (e) => {
      let t = new fn({ definition: [] })
      ;(s.definition.push(t),
        Z(e, 'IGNORE_AMBIGUITIES')
          ? (t.ignoreAmbiguities = e.IGNORE_AMBIGUITIES)
          : Z(e, 'GATE') && (t.ignoreAmbiguities = !0),
...
var Za = Li(wi, '', NaN, NaN, NaN, NaN, NaN, NaN)
Object.freeze(Za)
var es,
  ts = Object.freeze({
    recoveryEnabled: !1,
...
var is = class e {
    ...
    this.TRACE_INIT('performSelfAnalysis', () => {
      ...
      if (
        (this.TRACE_INIT('Grammar Resolving', () => {
          ;((n = ya({ rules: A(this.gastProductionsCache) })),
            (this.definitionErrors = this.definitionErrors.concat(n)))
        }),
        this.TRACE_INIT('Grammar Validations', () => {
          if (g(n) && !1 === this.skipValidations) {
            let e = (function (e) {
                return la(
                  (e = Y(e, { errMsgProvider: Pi })).rules,
                  e.tokenTypes,
                  e.errMsgProvider,
                  e.grammarName,
                )
              })({
                rules: A(this.gastProductionsCache),
                tokenTypes: A(this.tokensMap),
                errMsgProvider: Pi,
                grammarName: r,
              }),
              t = (function (e) {
                return X(
                  ...
                  (e) =>
                    Object.assign({ type: es.CUSTOM_LOOKAHEAD_VALIDATION }, e),
                )
              })({
          ...
          (this.recoveryEnabled &&
            this.TRACE_INIT('computeAllProdsFollows', () => {
              let e = (function (e) {
                ...
                return (
                  F(e, (e) => {
                    Lr(t, new Nn(e).startWalking())
                  }),
                  t
                )
              })(A(this.gastProductionsCache))
              this.resyncFollows = e
            }),
          this.TRACE_INIT('ComputeLookaheadFunctions', () => {
            var e, t
            ;(null == (t = (e = this.lookaheadStrategy).initialize) ||
              t.call(e, { rules: A(this.gastProductionsCache) }),
              this.preComputeLookaheadFunctions(A(this.gastProductionsCache)))
          })),
        !e.DEFER_DEFINITION_ERRORS_HANDLING && !g(this.definitionErrors))
      )
        throw (
          (t = X(this.definitionErrors, (e) => e.message)),
          Error(
  ...
  constructor(e, t) {
    ...
    this.skipValidations = Z(t, 'skipValidations')
      ? t.skipValidations
      : ts.skipValidations
  }
}
;((is.DEFER_DEFINITION_ERRORS_HANDLING = !1),
  (function (e, t) {
    t.forEach((t) => {
      let r = t.prototype
      Object.getOwnPropertyNames(r).forEach((n) => {
        if ('constructor' === n) return
        let i = Object.getOwnPropertyDescriptor(r, n)
        i && (i.get || i.set)
    ...
    class {
      initRecoverable(e) {
        ;((this.firstAfterRepMap = {}),
          (this.resyncFollows = {}),
          (this.recoveryEnabled = Z(e, 'recoveryEnabled')
            ? e.recoveryEnabled
            : ts.recoveryEnabled),
          this.recoveryEnabled && (this.attemptInRepetitionRecovery = La))
      }
      getTokenToInsert(e) {
        let t = Li(e, '', NaN, NaN, NaN, NaN, NaN, NaN)
      ...
      tryInRepetitionRecovery(e, t, r, n) {
        let i = this.findReSyncTokenType(),
          ...
          c = () => {
            ...
            ;((t.resyncedTokens = Ur(s)), this.SAVE_ERROR(t))
          }
        for (; !o;) {
          if (this.tokenMatcher(u, n)) return void c()
          if (r.call(this)) return (c(), void e.apply(this, t))
          this.tokenMatcher(u, i)
            ? (o = !0)
      ...
      canRecoverWithSingleTokenInsertion(e, t) {
        ...
        let r = this.LA(1)
        return void 0 !== z(t, (e) => this.tokenMatcher(r, e))
      }
      ...
      isInCurrentRuleReSyncSet(e) {
        ...
        return zr(this.getFollowSetFromFollowKey(t), e)
      }
      findReSyncTokenType() {
      ...
      getCurrFollowKey() {
        if (1 === this.RULE_STACK.length) return Na
      ...
      flattenFollowSet() {
        return j(
          X(this.buildFullFollowKeyStack(), (e) =>
      ...
      getFollowSetFromFollowKey(e) {
        if (e === Na) return [wi]
        let t = e.ruleName + e.idxInCallingRule + Cn + e.inRule
        return this.resyncFollows[t]
      }
      addToResyncTokens(e, t) {
        return (this.tokenMatcher(e, wi) || t.push(e), t)
      }
      reSyncTo(e) {
        let t = [],
          r = this.LA(1)
        for (; !1 === this.tokenMatcher(r, e);)
      ...
      getCurrentGrammarPath(e, t) {
        return {
          ...
          occurrenceStack: ee(this.RULE_OCCURRENCE_STACK),
          lastTok: e,
          lastTokOccurrence: t,
        }
      }
    ...
    class {
      initLooksAhead(e) {
        ;((this.dynamicTokensEnabled = Z(e, 'dynamicTokensEnabled')
          ...
          (this.maxLookahead = Z(e, 'maxLookahead')
            ? e.maxLookahead
            : ts.maxLookahead),
          (this.lookaheadStrategy = Z(e, 'lookaheadStrategy')
            ? e.lookaheadStrategy
            : new Ma({ maxLookahead: this.maxLookahead })),
        ...
        F(e, (e) => {
          this.TRACE_INIT(`${e.name} Rule Lookahead`, () => {
            let {
              ...
              repetitionWithSeparator: s,
            } = (function (e) {
              ;(Da.reset(), e.accept(Da))
              let t = Da.dslMethods
              return (Da.reset(), t)
            })(e)
            ;(F(t, (t) => {
              let r = 0 === t.idx ? '' : t.idx
              this.TRACE_INIT(`${kn(t)}${r}`, () => {
                let r = this.lookaheadStrategy.buildLookaheadForAlternation({
                  ...
                  n = Pa(this.fullRuleNameToShort[e.name], 256, t.idx)
      ...
      computeLookaheadFunc(e, t, r, n, i, a) {
        this.TRACE_INIT(`${a}${0 === t ? '' : t}`, () => {
          let a = this.lookaheadStrategy.buildLookaheadForOptional({
            ...
            s = Pa(this.fullRuleNameToShort[e.name], r, t)
          this.setLaFuncCache(s, a)
        })
      }
      getKeyForAutomaticLookahead(e, t) {
        return Pa(this.getLastExplicitRuleShortName(), e, t)
      }
    ...
    class {
      initTreeBuilder(e) {
        if (
          ...
          if (/full/i.test(this.nodeLocationTracking))
            this.recoveryEnabled
              ? ((this.setNodeLocationFromToken = Fa),
                (this.setNodeLocationFromNode = Fa),
                (this.cstPostRule = x),
                (this.setInitialNodeLocation =
                  this.setInitialNodeLocationFullRecovery))
              : ((this.setNodeLocationFromToken = x),
                (this.setNodeLocationFromNode = x),
                (this.cstPostRule = this.cstPostRuleFull),
                (this.setInitialNodeLocation =
                  this.setInitialNodeLocationFullRegular))
          else if (/onlyOffset/i.test(this.nodeLocationTracking))
            this.recoveryEnabled
              ? ((this.setNodeLocationFromToken = Ua),
                (this.setNodeLocationFromNode = Ua),
                (this.cstPostRule = x),
                (this.setInitialNodeLocation =
            ...
            ;((this.setNodeLocationFromToken = x),
              (this.setNodeLocationFromNode = x),
              (this.cstPostRule = x),
              (this.setInitialNodeLocation = x))
          }
        else
          ((this.cstInvocationStateUpdate = x),
            (this.cstFinallyStateUpdate = x),
            (this.cstPostTerminal = x),
            (this.cstPostNonTerminal = x),
            (this.cstPostRule = x))
      }
      ...
      getBaseCstVisitorConstructor() {
        if (S(this.baseCstVisitorConstructor)) {
          let e = Va(this.className, D(this.gastProductionsCache))
          return ((this.baseCstVisitorConstructor = e), e)
        }
        return this.baseCstVisitorConstructor
      }
      getBaseCstVisitorConstructorWithDefaults() {
        if (S(this.baseCstVisitorWithDefaultsConstructor)) {
          let e = (function (e, t, r) {
            let n = function () {}
            Ba(n, e + 'BaseSemanticsWithDefaults')
            let i = Object.create(r.prototype)
            return (
              F(t, (e) => {
                i[e] = Ka
              }),
              ((n.prototype = i).constructor = n),
              n
            )
          })(
            this.className,
            D(this.gastProductionsCache),
    ...
    class {
      ...
      LA(e) {
        ...
        return t < 0 || this.tokVectorLength <= t ? Za : this.tokVector[t]
      }
      consumeToken() {
        this.currIdx++
      }
    ...
    class {
      initRecognizerEngine(e, t) {
        ...
        if ($(e)) this.tokensMap = O(e, (e, t) => ((e[t.name] = t), e), {})
        else if (Z(e, 'modes') && Br(j(A(e.modes)), fi)) {
          let t = rn(j(A(e.modes)))
          this.tokensMap = O(t, (e, t) => ((e[t.name] = t), e), {})
        } else {
          if (!s(e))
            throw Error(
        ...
        this.tokensMap.EOF = wi
        let r = Br(Z(e, 'modes') ? j(A(e.modes)) : A(e), (e) =>
          g(e.categoryMatches),
        )
        ;((this.tokenMatcher = r ? si : ai), ui(A(this.tokensMap)))
      }
      defineRule(e, t, r) {
        ...
        let n,
          i = Z(r, 'resyncEnabled') ? r.resyncEnabled : rs.resyncEnabled,
          a = Z(r, 'recoveryValueFunc')
            ? r.recoveryValueFunc
        ...
        return (
          ...
          Object.assign(n, { ruleName: e, originalGrammarAction: t })
        )
      }
      invokeRuleCatch(e, t, r) {
        ...
        if (Aa(e)) {
          let t = e
          if (i) {
            let n = this.findReSyncTokenType()
            if (this.isInCurrentRuleReSyncSet(n)) {
              if (((t.resyncedTokens = this.reSyncTo(n)), this.outputCst)) {
      ...
      atLeastOneInternal(e, t) {
        let r = this.getKeyForAutomaticLookahead(ba, e)
      ...
      atLeastOneSepFirstInternal(e, t) {
        let r = this.getKeyForAutomaticLookahead(_a, e)
      ...
      atLeastOneSepFirstInternalLogic(e, t, r) {
        ...
        if (!0 !== this.getLaFuncFromCache(r).call(this))
          throw this.raiseEarlyExitException(
            e,
            Mi.REPETITION_MANDATORY_WITH_SEPARATOR,
            t.ERR_MSG,
          )
        {
          n.call(this)
      ...
      manySepFirstInternal(e, t) {
        let r = this.getKeyForAutomaticLookahead(Oa, e)
      ...
      ruleFinallyStateUpdate() {
        if (
          ...
          this.SAVE_ERROR(new Sa(t, e))
        }
      }
      subruleInternal(e, t, r) {
        let n
        try {
          let i = void 0 === r ? void 0 : r.ARGS
          return (
            (this.subruleIdx = t),
            (n = e.apply(this, i)),
            this.cstPostNonTerminal(
              n,
              void 0 !== r && void 0 !== r.LABEL ? r.LABEL : e.ruleName,
            ),
            n
          )
        } catch (t) {
      ...
      subruleInternalError(e, t, r) {
        throw (
          Aa(e) &&
            ...
            (this.cstPostNonTerminal(
              e.partialCstResult,
              void 0 !== t && void 0 !== t.LABEL ? t.LABEL : r,
            ),
      ...
      consumeInternal(e, t, r) {
        ...
        try {
          ...
          !0 === this.tokenMatcher(t, e)
            ? (this.consumeToken(), (n = t))
            : this.consumeInternalError(e, t, r)
        } catch (r) {
          n = this.consumeInternalRecovery(e, t, r)
        }
        return (
          this.cstPostTerminal(
            void 0 !== r && void 0 !== r.LABEL ? r.LABEL : e.name,
            n,
          ),
          n
        )
      ...
      consumeInternalError(e, t, r) {
        ...
        throw (
          ...
          this.SAVE_ERROR(new xa(n, t, i))
        )
      }
      consumeInternalRecovery(e, t, r) {
        if (
          !this.recoveryEnabled ||
          'MismatchedTokenException' !== r.name ||
          this.isBackTracking()
        )
          throw r
        {
          ...
          try {
            ...
            throw 'InRuleRecoveryException' === e.name ? r : e
          }
        }
      }
      saveRecogState() {
        let e = this.errors,
          t = ee(this.RULE_STACK)
        return {
          errors: e,
      ...
      isAtEndOfInput() {
        return this.tokenMatcher(this.LA(1), wi)
      }
      reset() {
    ...
    class {
      ...
      RULE(e, t, r = rs) {
        if (zr(this.definedRulesNames, e)) {
          let t = {
            message: Pi.buildDuplicateRuleNameError({
              topLevelRule: e,
              grammarName: this.className,
            }),
            type: es.DUPLICATE_RULE_NAME,
            ruleName: e,
          }
      ...
      OVERRIDE_RULE(e, t, r = rs) {
        let n = (function (e, t, r) {
          let n,
            i = []
          return (
            zr(t, e) ||
              ((n = `Invalid rule override, rule: ->${e}<- cannot be overridden in the grammar: ->${r}<-as it is not defined in any of the super grammars `),
              i.push({
                message: n,
                type: es.INVALID_RULE_OVERRIDE,
                ruleName: e,
              })),
            i
          )
    ...
    class {
      ...
      SAVE_ERROR(e) {
        if (Aa(e))
          return (
            (e.context = {
              ruleStack: this.getHumanReadableRuleStack(),
              ruleOccurrenceStack: ee(this.RULE_OCCURRENCE_STACK),
            }),
            this._errors.push(e),
            e
          )
      ...
      raiseEarlyExitException(e, t, r) {
        let n = this.getCurrRuleFullName(),
          i = aa(e, this.getGAstProductions()[n], t, this.maxLookahead)[0],
          a = []
        for (let o = 1; o <= this.maxLookahead; o++) a.push(this.LA(o))
        ...
        throw this.SAVE_ERROR(new Ca(s, this.LA(1), this.LA(0)))
      }
      raiseNoAltException(e, t) {
        ...
        throw this.SAVE_ERROR(new Ia(s, this.LA(1), a))
      }
    },
    class {
      initContentAssist() {}
      computeContentAssist(e, t) {
        ...
        if (S(r)) throw Error(`Rule ->${e}<- does not exist in this grammar.`)
        return Wi([r], t, this.tokenMatcher, this.maxLookahead)
      }
      getNextPossibleTokenTypes(e) {
        let t = Kr(e.ruleStack),
          r = this.getGAstProductions()[t]
        return new Fi(r, e).startWalking()
      }
    },
    class {
      initGastRecorder(e) {
      ...
      topLevelRuleRecord(e, t) {
        try {
          let r = new hn({ definition: [], name: e })
          return (
            (r.name = e),
      ...
      subruleInternalRecord(e, t, r) {
        ...
        return (n.definition.push(a), this.outputCst ? Ya : ja)
      }
      consumeInternalRecord(e, t, r) {
        if ((Ja(t), !di(e))) {
          let r = Error(
            `<CONSUME${Qa(t)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>\n inside top level rule: <${this.recordingProdStack[0].name}>`,
          )
          throw ((r.KNOWN_RECORDER_ERROR = !0), r)
        }
        let n = q(this.recordingProdStack),
          i = new vn({ idx: t, terminalType: e, label: r?.LABEL })
        return (n.definition.push(i), za)
      }
    },
    class {
      initPerformanceTracer(e) {
        if (Z(e, 'traceInitPerf')) {
          ...
          ((this.traceInitMaxIdent = 0),
            (this.traceInitPerf = ts.traceInitPerf))
        this.traceInitIndent = -1
      }
      TRACE_INIT(e, t) {
        if (!0 === this.traceInitPerf) {
...
function ds(e) {
  ...
  !(function (e, t) {
    ...
    for (let n = 0; n < r; n++) {
      let r = t[n],
        i = Es(e, r, void 0, { type: 2 }),
        a = Es(e, r, void 0, { type: 7 })
...
function hs(e, t, r) {
  return r instanceof vn
    ? Ts(e, t, r.terminalType, r)
    : r instanceof dn
      ? (function (e, t, r) {
          let n = r.referencedRule,
            ...
            a = Es(e, t, r, { type: 1 }),
            s = Es(e, t, r, { type: 1 })
          return ($s(a, new cs(i, n, s)), { left: a, right: s })
        })(e, t, r)
      : r instanceof Rn
        ? (function (e, t, r) {
            let n = Es(e, t, r, { type: 1 })
            return (
              gs(e, n),
              ys(e, t, n, r, ...X(r.definition, (r) => hs(e, t, r)))
            )
          })(e, t, r)
        : r instanceof pn
          ? (function (e, t, r) {
              ...
              return (
                ...
                (function (e, t, r, n) {
                  ...
                  return (
                    vs(i, a),
                    (e.decisionMap[ss(t, 'Option', r.idx)] = i),
                    n
                  )
                })(e, t, r, ys(e, t, n, r, fs(e, t, r)))
              )
            })(e, t, r)
          : r instanceof yn
            ? (function (e, t, r) {
                let n = Es(e, t, r, { type: 5 })
                return (gs(e, n), ms(e, t, r, ys(e, t, n, r, fs(e, t, r))))
              })(e, t, r)
            : r instanceof Tn
              ? (function (e, t, r) {
                  let n = Es(e, t, r, { type: 5 })
                  return (
                    ...
                    ms(
                      ...
                      r,
                      ys(e, t, n, r, fs(e, t, r)),
                      Ts(e, t, r.separator, r),
                    )
                  )
                })(e, t, r)
              : r instanceof mn
                ? (function (e, t, r) {
                    let n = Es(e, t, r, { type: 4 })
                    return (gs(e, n), ps(e, t, r, ys(e, t, n, r, fs(e, t, r))))
                  })(e, t, r)
                : r instanceof gn
                  ? (function (e, t, r) {
                      let n = Es(e, t, r, { type: 4 })
    ...
    : 0 === n.length
      ...
      : (function (e, t) {
          ...
          for (let a = 0; a < r - 1; a++) {
            ...
            let i = r instanceof cs,
              s = r,
              o = t[a + 1].left
            1 === n.left.type &&
            1 === n.right.type &&
            void 0 !== r &&
            ((i && s.followState === n.right) || r.target === n.right)
              ? (i ? (s.followState = o) : (r.target = o), As(e, n.right))
              : vs(n.right, o)
          }
          let n = t[0],
            i = t[r - 1]
...
function ps(e, t, r, n, i) {
  ...
  return (
    ...
    void 0 === i
      ? (vs(o, a), vs(o, l))
      : (vs(o, l), vs(o, i.left), vs(i.right, a)),
    { left: a, right: l }
  )
}
function ms(e, t, r, n, i) {
  ...
  return (
    ...
    vs(o, l),
    vs(s, u),
    void 0 === i ? vs(u, o) : (vs(u, l), vs(u, i.left), vs(i.right, a)),
    (e.decisionMap[ss(t, i ? 'RepetitionWithSeparator' : 'Repetition', r.idx)] =
      o),
    { left: o, right: l }
  )
}
...
function ys(e, t, r, n, ...i) {
  let a = Es(e, t, n, { type: 8, start: r })
  r.end = a
  for (let o of i) void 0 === o ? vs(r, a) : (vs(r, o.left), vs(o.right, a))
  let s = { left: r, right: a }
  return (
    (e.decisionMap[
      ss(
        t,
        (function (e) {
          if (e instanceof Rn) return 'Alternation'
          if (e instanceof pn) return 'Option'
          if (e instanceof yn) return 'Repetition'
          if (e instanceof Tn) return 'RepetitionWithSeparator'
          if (e instanceof mn) return 'RepetitionMandatory'
          if (e instanceof gn) return 'RepetitionMandatoryWithSeparator'
...
function Ts(e, t, r, n) {
  let i = Es(e, t, n, { type: 1 }),
    a = Es(e, t, n, { type: 1 })
  return ($s(i, new ls(a, r)), { left: i, right: a })
}
function Rs(e, t, r) {
  let n = e.ruleToStartState.get(t)
  vs(n, r.left)
  let i = e.ruleToStopState.get(t)
  return (vs(r.right, i), { left: n, right: i })
}
function vs(e, t) {
  $s(e, new us(t))
}
...
function $s(e, t) {
  ;(0 === e.transitions.length && (e.epsilonOnlyTransitions = t.isEpsilon()),
...
function Ss(e, t) {
  ...
  return (n) => {
    let i = n.toString(),
      a = r[i]
    return void 0 === a
      ? ((a = { atnStartState: e, decision: t, states: {} }), (r[i] = a), a)
      : a
  }
}
var Cs,
  ...
  rl = class extends Ma {
    constructor(e) {
      ;(super(), (this.logging = e?.logging ?? ((e) => {})))
    }
    initialize(e) {
      ;((this.atn = ds(e.rules)),
        (this.dfas = (function (e) {
          let t = e.decisionStates.length,
            r = Array(t)
          for (let n = 0; n < t; n++) r[n] = Ss(e.decisionStates[n], n)
          return r
        })(this.atn)))
    }
    ...
    buildLookaheadForAlternation(e) {
      ...
      return n
        ? function (e) {
            ...
            let n = il.call(this, a, l, t, s)
            return 'number' == typeof n ? n : void 0
          }
        : function () {
            let e = il.call(this, a, l, tl, s)
    ...
    buildLookaheadForOptional(e) {
      let {
        ...
        l = this.atn.decisionMap[o].decision,
        u = X(
          qi({ maxLookahead: 1, occurrence: t, prodType: n, rule: r }),
          (e) => X(e, (e) => e[0]),
        )
      if (nl(u) && u[0][0] && !i) {
        let e = u[0],
...
function nl(e, t = !0) {
  ...
  for (let n of e) {
    ...
    for (let i of n) {
      ...
      let n = [i.tokenTypeIdx].concat(i.categoryMatches)
      for (let t of n)
        if (r.has(t)) {
          if (!e.has(t)) return !1
      ...
      ((a = fl(
        ...
        dl(
          (function (e) {
            ...
            for (let n = 0; n < r; n++)
              pl({ state: e.transitions[n].target, alt: n, stack: [] }, t)
            return t
          })(i.atnStartState),
        ),
      )),
      (i.start = a)),
    al.apply(this, [i, a, r, n])
  )
}
function al(e, t, r, n) {
  let i = t,
  ...
  for (;;) {
    let t = ul(i, o)
    if ((void 0 === t && (t = sl.apply(this, [e, i, o, a, r, n])), t === ks))
      return ll(s, i, o)
...
function sl(e, t, r, n, i, a) {
  let s = (function (e, t, r) {
    ...
    for (let s of e.elements) {
      if (!1 === r.is(s.alt)) continue
      if (7 === s.state.type) {
        a.push(s)
        continue
      }
      let e = s.state.transitions.length
      for (let r = 0; r < e; r++) {
        let e = cl(s.state.transitions[r], t)
        void 0 !== e && i.add({ state: e, alt: s.alt, stack: s.stack })
      }
    }
    if ((0 === a.length && 1 === i.size && (n = i), void 0 === n)) {
      n = new xs()
      for (let e of i.elements) pl(e, n)
    }
    if (
      a.length > 0 &&
      !(function (e) {
      ...
      for (let s of a) n.add(s)
    return n
  })(t.configs, r, i)
  if (0 === s.size) return (hl(e, t, r, ks), ks)
  let o = dl(s),
    l = (function (e, t) {
      let r
  ...
  if (void 0 !== l)
    ...
    ;((o.isAcceptState = !0),
      ...
      ol.apply(this, [e, n, s.alts, a]))
  }
  return ((o = hl(e, t, r, o)), o)
}
function ol(e, t, r, n) {
  let i = []
  for (let s = 1; s <= t; s++) i.push(this.LA(s).tokenType)
  let a = e.atnStartState
  n(
    (function (e) {
      let t = X(e.prefixPath, (e) => Ti(e)).join(', '),
        r = 0 === e.production.idx ? '' : e.production.idx,
        n = `Ambiguous Alternatives Detected: <${e.ambiguityIndices.join(', ')}> in <${(function (
          e,
        ) {
          if (e instanceof dn) return 'SUBRULE'
          if (e instanceof pn) return 'OPTION'
          ...
          e.production,
        )}${r}> inside <${e.topLevelRule.name}> Rule,\n<${t}> may appears as a prefix path in all these alternatives.\n`
      return (
        (n +=
          'See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES\nFor Further details.'),
        n
...
function ll(e, t, r) {
  return {
    actualToken: r,
    possibleTokenTypes: nn(
      Vr(t.configs.elements, (e) => e.state.transitions)
...
function cl(e, t) {
  if (e instanceof ls && bi(t, e.tokenType)) return e.target
}
function dl(e) {
  return { configs: e, edges: {}, isAcceptState: !1, prediction: -1 }
}
function hl(e, t, r, n) {
  return ((n = fl(e, n)), (t.edges[r.tokenTypeIdx] = n), n)
}
function fl(e, t) {
  if (t === ks) return t
  let r = t.configs.key,
    n = e.states[r]
  return void 0 === n ? (t.configs.finalize(), (e.states[r] = t), t) : n
}
function pl(e, t) {
  let r = e.state
  if (7 === r.type) {
    if (e.stack.length > 0) {
      let r = [...e.stack]
      pl({ state: r.pop(), alt: e.alt, stack: r }, t)
    } else t.add(e)
    return
  }
...
;(((Cs ||= {}).is = function (e) {
  ...
  (function (e) {
    ;((e.create = function (e, t) {
      return (
        e === Number.MAX_VALUE && (e = Ls.MAX_VALUE),
        t === Number.MAX_VALUE && (t = Ls.MAX_VALUE),
        { line: e, character: t }
      )
    }),
      (e.is = function (e) {
        let t = e
        return (
          gl.objectLiteral(t) && gl.uinteger(t.line) && gl.uinteger(t.character)
        )
      }))
  })((bs ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r, n) {
      if (gl.uinteger(e) && gl.uinteger(t) && gl.uinteger(r) && gl.uinteger(n))
        return { start: bs.create(e, t), end: bs.create(r, n) }
      if (bs.is(e) && bs.is(t)) return { start: e, end: t }
      throw Error(
      ...
      (e.is = function (e) {
        let t = e
        return gl.objectLiteral(t) && bs.is(t.start) && bs.is(t.end)
      }))
  })((Os ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.objectLiteral(t) &&
          Os.is(t.range) &&
          (gl.string(t.uri) || gl.undefined(t.uri))
        )
      }))
  })((_s ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r, n) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.objectLiteral(t) &&
          Os.is(t.targetRange) &&
          gl.string(t.targetUri) &&
          Os.is(t.targetSelectionRange) &&
          (Os.is(t.originSelectionRange) ||
            gl.undefined(t.originSelectionRange))
        )
      }))
  })((Ps ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r, n) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.objectLiteral(t) &&
          gl.numberRange(t.red, 0, 1) &&
          gl.numberRange(t.green, 0, 1) &&
          gl.numberRange(t.blue, 0, 1) &&
          gl.numberRange(t.alpha, 0, 1)
        )
      }))
  })((Ms ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        let t = e
        return gl.objectLiteral(t) && Os.is(t.range) && Ms.is(t.color)
      }))
  })((Ds ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.objectLiteral(t) &&
          gl.string(t.label) &&
          (gl.undefined(t.textEdit) || zs.is(t)) &&
          (gl.undefined(t.additionalTextEdits) ||
            gl.typedArray(t.additionalTextEdits, zs.is))
        )
      }))
  })((Us ||= {})),
  (function (e) {
  ...
  (function (e) {
    ;((e.create = function (e, t, r, n, i, a) {
      let s = { startLine: e, endLine: t }
      return (
        gl.defined(r) && (s.startCharacter = r),
        gl.defined(n) && (s.endCharacter = n),
        gl.defined(i) && (s.kind = i),
        gl.defined(a) && (s.collapsedText = a),
        s
      )
    }),
      (e.is = function (e) {
        ...
        return (
          gl.objectLiteral(t) &&
          gl.uinteger(t.startLine) &&
          gl.uinteger(t.startLine) &&
          (gl.undefined(t.startCharacter) || gl.uinteger(t.startCharacter)) &&
          (gl.undefined(t.endCharacter) || gl.uinteger(t.endCharacter)) &&
          (gl.undefined(t.kind) || gl.string(t.kind))
        )
      }))
  })((Gs ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        let t = e
        return gl.defined(t) && _s.is(t.location) && gl.string(t.message)
      }))
  })((Bs ||= {})),
  (function (e) {
  ...
  ((js ||= {}).is = function (e) {
    let t = e
    return gl.objectLiteral(t) && gl.string(t.href)
  }),
  (function (e) {
    ;((e.create = function (e, t, r, n, i, a) {
      let s = { range: e, message: t }
      return (
        gl.defined(r) && (s.severity = r),
        gl.defined(n) && (s.code = n),
        gl.defined(i) && (s.source = i),
        gl.defined(a) && (s.relatedInformation = a),
        s
      )
    }),
      (e.is = function (e) {
        ...
        return (
          ...
          Os.is(t.range) &&
          gl.string(t.message) &&
          (gl.number(t.severity) || gl.undefined(t.severity)) &&
          (gl.integer(t.code) || gl.string(t.code) || gl.undefined(t.code)) &&
          (gl.undefined(t.codeDescription) ||
            gl.string(t.codeDescription?.href)) &&
          (gl.string(t.source) || gl.undefined(t.source)) &&
          (gl.undefined(t.relatedInformation) ||
            gl.typedArray(t.relatedInformation, Bs.is))
        )
      }))
  })((Hs ||= {})),
  (function (e) {
    ;((e.create = function (e, t, ...r) {
      ...
      return (gl.defined(r) && r.length > 0 && (n.arguments = r), n)
    }),
      (e.is = function (e) {
        let t = e
        return gl.defined(t) && gl.string(t.title) && gl.string(t.command)
      }))
  })((Ws ||= {})),
  (function (e) {
    ;((e.replace = function (e, t) {
      ...
      (e.is = function (e) {
        let t = e
        return gl.objectLiteral(t) && gl.string(t.newText) && Os.is(t.range)
      }))
  })((zs ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r) {
      let n = { label: e }
      return (
        void 0 !== t && (n.needsConfirmation = t),
      ...
      (e.is = function (e) {
        ...
        return (
          gl.objectLiteral(t) &&
          gl.string(t.label) &&
          (gl.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) &&
          (gl.string(t.description) || void 0 === t.description)
        )
      }))
  })((Ys ||= {})),
  ((qs ||= {}).is = function (e) {
  ...
  (function (e) {
    ;((e.replace = function (e, t, r) {
      ...
      (e.is = function (e) {
        let t = e
        return zs.is(t) && (Ys.is(t.annotationId) || qs.is(t.annotationId))
      }))
  })((Xs ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        let t = e
        return gl.defined(t) && io.is(t.textDocument) && Array.isArray(t.edits)
      }))
  })((Qs ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r) {
        ...
        return (
          ...
          (void 0 === t.options ||
            ((void 0 === t.options.overwrite ||
              gl.boolean(t.options.overwrite)) &&
              (void 0 === t.options.ignoreIfExists ||
                gl.boolean(t.options.ignoreIfExists)))) &&
          (void 0 === t.annotationId || qs.is(t.annotationId))
        )
      }))
  })((Js ||= {})),
  (function (e) {
        ...
        return (
          ...
          (void 0 === t.options ||
            ((void 0 === t.options.recursive ||
              gl.boolean(t.options.recursive)) &&
              (void 0 === t.options.ignoreIfNotExists ||
                gl.boolean(t.options.ignoreIfNotExists)))) &&
          (void 0 === t.annotationId || qs.is(t.annotationId))
        )
      }))
  })((eo ||= {})),
    ...
    return (
      ...
      (void 0 === t.documentChanges ||
        t.documentChanges.every((e) =>
          gl.string(e.kind) ? Js.is(e) || Zs.is(e) || eo.is(e) : Qs.is(e),
        ))
    )
  }),
  (function (e) {
    ;((e.create = function (e) {
      ...
      (e.is = function (e) {
        let t = e
        return gl.defined(t) && gl.string(t.uri)
      }))
  })((ro ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        let t = e
        return gl.defined(t) && gl.string(t.uri) && gl.integer(t.version)
      }))
  })((no ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.defined(t) &&
          gl.string(t.uri) &&
          (null === t.version || gl.integer(t.version))
        )
      }))
  })((io ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r, n) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.defined(t) &&
          gl.string(t.uri) &&
          gl.string(t.languageId) &&
          gl.integer(t.version) &&
          gl.string(t.text)
        )
      }))
  })((ao ||= {})),
  ...
  ((oo ||= {}).is = function (e) {
    let t = e
    return gl.objectLiteral(e) && so.is(t.kind) && gl.string(t.value)
  }),
  (function (e) {
    ;((e.Text = 1),
      (e.Method = 2),
  ...
  (function (e) {
    ;((e.create = function (e, t, r) {
      ...
      (e.is = function (e) {
        let t = e
        return t && gl.string(t.newText) && Os.is(t.insert) && Os.is(t.replace)
      }))
  })((ho ||= {})),
  (function (e) {
  ...
  ((po ||= {}).is = function (e) {
    ...
    return (
      t &&
      (gl.string(t.detail) || void 0 === t.detail) &&
      (gl.string(t.description) || void 0 === t.description)
    )
  }),
  ...
  (function (e) {
    ;((e.fromPlainText = function (e) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.string(t) ||
          (gl.objectLiteral(t) && gl.string(t.language) && gl.string(t.value))
        )
      }))
  })((yo ||= {})),
  ((To ||= {}).is = function (e) {
    ...
    return (
      ...
      (oo.is(t.contents) ||
        yo.is(t.contents) ||
        gl.typedArray(t.contents, yo.is)) &&
      (void 0 === e.range || Os.is(e.range))
    )
  }),
  ((Ro ||= {}).create = function (e, t) {
    return t ? { label: e, documentation: t } : { label: e }
  }),
  ((vo ||= {}).create = function (e, t, ...r) {
    let n = { label: e }
    return (
      gl.defined(t) && (n.documentation = t),
      gl.defined(r) ? (n.parameters = r) : (n.parameters = []),
      n
    )
  }),
  (function (e) {
  ...
  ((ko ||= {}).Deprecated = 1),
  ((xo ||= {}).create = function (e, t, r, n, i) {
    let a = { name: e, kind: t, location: { uri: n, range: r } }
    return (i && (a.containerName = i), a)
  }),
  ((Io ||= {}).create = function (e, t, r, n) {
    return void 0 === n
      ? { name: e, kind: t, location: { uri: r } }
      : { name: e, kind: t, location: { uri: r, range: n } }
  }),
  (function (e) {
    ;((e.create = function (e, t, r, n, i, a) {
      ...
      (e.is = function (e) {
        ...
        return (
          ...
          gl.number(t.kind) &&
          Os.is(t.range) &&
          Os.is(t.selectionRange) &&
          (void 0 === t.detail || gl.string(t.detail)) &&
          (void 0 === t.deprecated || gl.boolean(t.deprecated)) &&
  ...
  (function (e) {
    ;((e.create = function (e, t, r) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.defined(t) &&
          gl.typedArray(t.diagnostics, Hs.is) &&
          (void 0 === t.only || gl.typedArray(t.only, gl.string)) &&
          (void 0 === t.triggerKind ||
            t.triggerKind === No.Invoked ||
            t.triggerKind === No.Automatic)
        )
      }))
  })((wo ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r) {
      ...
      (e.is = function (e) {
        ...
        return (
          t &&
          gl.string(t.title) &&
          (void 0 === t.diagnostics || gl.typedArray(t.diagnostics, Hs.is)) &&
          (void 0 === t.kind || gl.string(t.kind)) &&
          (void 0 !== t.edit || void 0 !== t.command) &&
          (void 0 === t.command || Ws.is(t.command)) &&
          (void 0 === t.isPreferred || gl.boolean(t.isPreferred)) &&
          (void 0 === t.edit || to.is(t.edit))
        )
      }))
  })((Lo ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      let r = { range: e }
      return (gl.defined(t) && (r.data = t), r)
    }),
      (e.is = function (e) {
        let t = e
        return (
          gl.defined(t) &&
          Os.is(t.range) &&
          (gl.undefined(t.command) || Ws.is(t.command))
        )
      }))
  })((bo ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        let t = e
        return (
          gl.defined(t) && gl.uinteger(t.tabSize) && gl.boolean(t.insertSpaces)
        )
      }))
  })((Oo ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.defined(t) &&
          Os.is(t.range) &&
          (gl.undefined(t.target) || gl.string(t.target))
        )
      }))
  })((_o ||= {})),
  (function (e) {
  ...
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        let t = e
        return null != t && Os.is(t.range) && gl.string(t.text)
      }))
  })((Fo ||= {})),
  (function (e) {
    ;((e.create = function (e, t, r) {
      ...
      (e.is = function (e) {
        ...
        return (
          null != t &&
          Os.is(t.range) &&
          gl.boolean(t.caseSensitiveLookup) &&
          (gl.string(t.variableName) || void 0 === t.variableName)
        )
      }))
  })((Go ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        ...
        return (
          null != t &&
          Os.is(t.range) &&
          (gl.string(t.expression) || void 0 === t.expression)
        )
      }))
  })((Bo ||= {})),
  (function (e) {
    ;((e.create = function (e, t) {
      ...
      (e.is = function (e) {
        let t = e
        return gl.defined(t) && Os.is(e.stoppedLocation)
      }))
  })((Ko ||= {})),
  (function (e) {
    ;((e.Type = 1),
  ...
  (function (e) {
    ;((e.create = function (e) {
      ...
      (e.is = function (e) {
        ...
        return (
          gl.objectLiteral(t) &&
          (void 0 === t.tooltip || gl.string(t.tooltip) || oo.is(t.tooltip)) &&
          (void 0 === t.location || _s.is(t.location)) &&
          (void 0 === t.command || Ws.is(t.command))
        )
      }))
  })((jo ||= {})),
    ...
    ;((e.create = function (e, t, r) {
      ...
      (e.is = function (e) {
        ...
        return (
          (gl.objectLiteral(t) &&
            bs.is(t.position) &&
            (gl.string(t.label) || gl.typedArray(t.label, jo.is)) &&
            (void 0 === t.kind || Vo.is(t.kind)) &&
            void 0 === t.textEdits) ||
          (gl.typedArray(t.textEdits, zs.is) &&
            (void 0 === t.tooltip ||
              gl.string(t.tooltip) ||
              oo.is(t.tooltip)) &&
            (void 0 === t.paddingLeft || gl.boolean(t.paddingLeft)) &&
            (void 0 === t.paddingRight || gl.boolean(t.paddingRight)))
        )
      }))
  })((Ho ||= {})),
  ((Wo ||= {}).createSnippet = function (e) {
    return { kind: 'snippet', value: e }
  }),
  ((zo ||= {}).create = function (e, t, r, n) {
  ...
  ((Jo ||= {}).is = function (e) {
    let t = e
    return gl.objectLiteral(t) && Ns.is(t.uri) && gl.string(t.name)
  }),
  (function (e) {
    function t(e, r) {
      ...
      let s = 0,
        o = 0,
        l = 0
      for (; s < i.length && o < a.length;)
        r(i[s], a[o]) <= 0 ? (e[l++] = i[s++]) : (e[l++] = a[o++])
      for (; s < i.length;) e[l++] = i[s++]
      for (; o < a.length;) e[l++] = a[o++]
      return e
    }
    ;((e.create = function (e, t, r, n) {
      return new yl(e, t, r, n)
    }),
      (e.is = function (e) {
        let t = e
        return !!(
          gl.defined(t) &&
          gl.string(t.uri) &&
          (gl.undefined(t.languageId) || gl.string(t.languageId)) &&
          gl.uinteger(t.lineCount) &&
          gl.func(t.getText) &&
          gl.func(t.positionAt) &&
          gl.func(t.offsetAt)
        )
      }),
      (e.applyEdits = function (e, r) {
        ...
        for (let t = i.length - 1; t >= 0; t--) {
          let r = i[t],
            s = e.offsetAt(r.range.start),
            o = e.offsetAt(r.range.end)
          if (!(o <= a)) throw Error('Overlapping edit')
          ;((n = n.substring(0, s) + r.newText + n.substring(o, n.length)),
            (a = s))
        }
        return n
      }))
...
var Tl = class {
    ...
    buildLeafNode(e, t) {
      let r = new vl(e.startOffset, e.image.length, Re(e), e.tokenType, !t)
      return (
        (r.grammarSource = t),
    ...
    addHiddenNodes(e) {
      let t = []
      for (let i of e) {
        let e = new vl(i.startOffset, i.image.length, Re(i), i.tokenType, !0)
        ;((e.root = this.rootNode), t.push(e))
      }
      let r = this.current,
        n = !1
      if (r.content.length > 0) r.content.push(...t)
      else {
        for (; r.container;) {
    ...
    construct(e) {
      let t = this.current
      ;('string' == typeof e.$type && (this.current.astNode = e),
        (e.$cstNode = t))
      let r = this.nodeStack.pop()
      0 === r?.content.length && this.removeNode(r)
    }
  },
  Rl = class {
    get parent() {
  ...
  El = class extends Rl {
    ...
    get range() {
      ...
      return { start: bs.create(0, 0), end: bs.create(0, 0) }
    }
...
var Il = (e) => (e.endsWith('​') ? e : e + '​'),
  ...
  Cl = class extends Sl {
    ...
    rule(e, t) {
      let r = this.computeRuleType(e),
        n = this.wrapper.DEFINE_RULE(
          Il(e.name),
          this.startImplementation(r, t).bind(this),
        )
      return (this.allRules.set(e.name, n), e.entry && (this.mainRule = n), n)
    }
    computeRuleType(e) {
      if (!e.fragment) return Er(e) ? kl : (Ar(e) ?? e.name)
    }
    parse(e, t = {}) {
    ...
    startImplementation(e, t) {
      return (r) => {
        let n,
          i = !this.isRecording() && void 0 !== e
        if (i) {
          let t = { $type: e }
          ;(this.stack.push(t), e === kl && (t.value = ''))
        }
        try {
          n = t(r)
        } catch {
        ...
        return (void 0 === n && i && (n = this.construct()), n)
      }
    }
    extractHiddenTokens(e) {
      ...
      let r = e.startOffset
      for (let n = 0; n < t.length; n++)
        if (t[n].startOffset > r) return t.splice(0, n)
    ...
    consume(e, t, r) {
      ...
      if (!this.isRecording() && this.isValidToken(n)) {
        ...
        let t = this.nodeBuilder.buildLeafNode(n, r),
          { assignment: i, isCrossRef: a } = this.getAssignment(r),
          s = this.current
        if (i) {
          let e = Et(r) ? n.image : this.converter.convert(n.image, t)
          this.assign(i.operator, i.feature, e, t, a)
        } else if (xl(s)) {
          let e = n.image
          ;(Et(r) || (e = this.converter.convert(e, t).toString()),
            (s.value += e))
        }
      }
    }
    ...
    subrule(e, t, r, n, i) {
      ...
      let s = this.wrapper.wrapSubrule(e, t, i)
      !this.isRecording() &&
        a &&
        a.length > 0 &&
        this.performSubruleAssignment(s, n, a)
    }
    performSubruleAssignment(e, t, r) {
      let { assignment: n, isCrossRef: i } = this.getAssignment(t)
      if (n) this.assign(n.operator, n.feature, e, r, i)
      else if (!n) {
        let t = this.current
        if (xl(t)) t.value += e.toString()
    ...
    action(e, t) {
      if (!this.isRecording()) {
        ...
        if (t.feature && t.operator) {
          ...
          let n = { $type: e }
          ;(this.stack.push(n),
            this.assign(t.operator, t.feature, r, r.$cstNode, !1))
        } else r.$type = e
      }
    }
    construct() {
            ...
            t.startsWith('$') ||
              (Array.isArray(r)
                ? r.forEach((r, n) => {
                    te(r) &&
                      ((r.$container = e),
                      (r.$containerProperty = t),
                      (r.$containerIndex = n))
                  })
                : te(r) && ((r.$container = e), (r.$containerProperty = t)))
        })(e),
    ...
    assignWithoutOverride(e, t) {
      for (let [n, i] of Object.entries(t)) {
        ...
        void 0 === t
          ? (e[n] = i)
          : Array.isArray(t) && Array.isArray(i) && (i.push(...t), (e[n] = i))
      }
      let r = e.$cstNode
  ...
  Nl = class {
    buildMismatchTokenMessage(e) {
      return Oi.buildMismatchTokenMessage(e)
    }
    buildNotAllInputParsedMessage(e) {
      return Oi.buildNotAllInputParsedMessage(e)
    }
    buildNoViableAltMessage(e) {
      return Oi.buildNoViableAltMessage(e)
    }
    buildEarlyExitMessage(e) {
      return Oi.buildEarlyExitMessage(e)
    }
  },
  wl = class extends Nl {
  ...
  Ll = class extends Sl {
    ...
    rule(e, t) {
      let r = this.wrapper.DEFINE_RULE(
        Il(e.name),
  ...
  Ol = class extends as {
    constructor(e, t) {
      ...
      super(
        e,
        Object.assign(
          Object.assign(Object.assign({}, bl), {
            lookaheadStrategy: r
              ? new Ma({ maxLookahead: t.maxLookahead })
              : new rl({ logging: t.skipValidations ? () => {} : void 0 }),
          }),
          t,
        ),
      )
  ...
  return (
    (function (e, t) {
      ...
      for (let i of n) {
        ...
        e.parser.rule(i, Pl(t, i.definition))
      }
...
function Pl(e, t, r = !1) {
  ...
  if (Et(t))
  ...
  else if (ft(t)) n = Pl(e, t.terminal)
  else if (gt(t)) n = Ul(e, t)
  else if (xt(t))
    n = (function (e, t) {
      let r = t.rule.ref
      if (Xe(r)) {
        let n = e.subrule++,
          ...
          a =
            t.arguments.length > 0
              ...
              : () => ({})
        return (s) => e.parser.subrule(n, Gl(e, r), i, t, a(s))
      }
      if (nt(r)) {
        let n = e.consume++,
          i = Bl(e, r.name)
      ...
      if (!r) throw new ke(t.$cstNode, `Undefined rule: ${t.rule.$refText}`)
      xe()
    })(e, t)
  else if (dt(t))
    n = (function (e, t) {
      if (1 === t.elements.length) return Pl(e, t.elements[0])
      {
        let r = []
        for (let i of t.elements) {
          let t = { ALT: Pl(e, i, !0) },
            n = Dl(i)
          ;(n && (t.GATE = Ml(n)), r.push(t))
        }
        let n = e.or++
        return (t) =>
    ...
    n = (function (e, t) {
      let r = t.elements.map((t) => Pl(e, t))
      return (e) => r.forEach((t) => t(e))
    })(e, t)
  else {
    if (
      !(function (e) {
        return Pt.isInstance(e, yt)
      })(t)
    )
      throw new ke(t.$cstNode, `Unexpected element type: ${t.$type}`)
    {
      let r = e.consume++
      n = () => e.parser.consume(r, wi, t)
    }
  }
  return Fl(e, r ? void 0 : Dl(t), n, t.cardinality)
}
function Ml(e) {
  if (
    (function (e) {
      return Pt.isInstance(e, De)
    })(e)
  ) {
    let t = Ml(e.left),
      r = Ml(e.right)
...
function Dl(e) {
  if (Rt(e)) return e.guardCondition
}
function Ul(e, t, r = t.terminal) {
  if (r) {
    if (xt(r) && Xe(r.rule.ref)) {
      let n = r.rule.ref,
        i = e.subrule++
      return (r) => e.parser.subrule(i, Gl(e, n), !1, t, r)
    }
    if (xt(r) && nt(r.rule.ref)) {
      let n = e.consume++,
        i = Bl(e, r.rule.ref.name)
      return () => e.parser.consume(n, i, t)
    }
    if (Et(r)) {
      let n = e.consume++,
  ...
  }
  {
    ...
    let r = Rr(t.type.ref)?.terminal
    if (!r)
      throw Error('Could not find name assignment for type: ' + kr(t.type.ref))
    return Ul(e, t, r)
  }
}
function Fl(e, t, r, n) {
  ...
  if ('*' === n) {
    let t = e.many++
    return (n) =>
      e.parser.many(t, { DEF: () => r(n), GATE: i ? () => i(n) : void 0 })
  }
  if ('+' === n) {
    let t = e.many++
    if (i) {
      ...
      return (a) =>
        e.parser.alternatives(n, [
          {
            ALT: () => e.parser.atLeastOne(t, { DEF: () => r(a) }),
            GATE: () => i(a),
          },
          { ALT: ns(), GATE: () => !i(a) },
        ])
    }
    return (n) => e.parser.atLeastOne(t, { DEF: () => r(n) })
  }
  if ('?' === n) {
    let t = e.optional++
    return (n) =>
      e.parser.optional(t, { DEF: () => r(n), GATE: i ? () => i(n) : void 0 })
  }
  xe()
}
function Gl(e, t) {
...
function Kl(e) {
  let t = (function (e) {
    let t = e.Grammar,
      r = e.parser.Lexer
    return _l(t, new Cl(e), r.definition)
  })(e)
  return (t.finalize(), t)
}
var Vl,
  jl = class {
    ...
    buildTokens(e, t) {
      ...
      return (
        n.forEach((e) => {
          let t = e.PATTERN
          'object' == typeof t && t && 'test' in t && cr(t)
            ? i.unshift(e)
            : i.push(e)
        }),
        i
    ...
    buildTerminalToken(e) {
      ...
      return (
        'function' == typeof r && (n.LINE_BREAKS = !0),
        e.hidden && (n.GROUP = cr(t) ? yi.SKIPPED : 'hidden'),
        n
      )
    }
    ...
    findLongerAlt(e, t) {
      return t.reduce((t, r) => {
        let n = r?.PATTERN
        return (n?.source && hr('^' + n.source + '$', e.value) && t.push(r), t)
      }, [])
    }
  },
  Hl = class {
    ...
    runConverter(e, t, r) {
      switch (e.name.toUpperCase()) {
        case 'INT':
          return Vl.convertInt(t)
        case 'STRING':
          return Vl.convertString(t)
        case 'ID':
          return Vl.convertID(t)
      }
      switch (
        (function (e) {
          return nt(e) ? (e.type?.name ?? 'string') : (Ar(e) ?? e.name)
        })(e)?.toLowerCase()
      ) {
        case 'number':
          return Vl.convertNumber(t)
        case 'boolean':
          return Vl.convertBoolean(t)
        case 'bigint':
          return Vl.convertBigint(t)
        case 'date':
          return Vl.convertDate(t)
        default:
          return t
      }
    }
...
var Wl = y((e) => {
    var t
    function r() {
      if (void 0 === t) throw Error('No runtime abstraction layer installed')
      return t
    }
  ...
  zl = y((e) => {
    ...
    ;(Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (e.array = r),
      (e.stringArray = function (e) {
        return r(e) && e.every((e) => t(e))
      }))
  }),
  Yl = y((e) => {
    ;(Object.defineProperty(e, '__esModule', { value: !0 }),
    ...
    var n = class {
      ...
      i = class e {
        ...
        dispose() {
          this._callbacks &&= void this._callbacks.dispose()
        }
      }
    ...
    var a = Object.freeze(function (e, t) {
      ...
      s = class {
        ...
        get onCancellationRequested() {
          return this._isCancelled
            ? a
            : ((this._emitter ||= new i.Emitter()), this._emitter.event)
        }
        dispose() {
          this._emitter &&= void this._emitter.dispose()
        }
      }
...
v(Xl, f(ql(), 1))
var Ql = 0
var Jl = Symbol('OperationCancelled')
function Zl(e) {
  return e === Jl
}
async function eu(e) {
  if (e === Xl.CancellationToken.None) return
...
var tu,
  ...
  iu = class e {
      ...
      for (let n of t)
        if (e.isIncremental(n)) {
          ...
          let i = Math.max(e.start.line, 0),
            ...
            o = su(n.text, !1, t)
          if (a - i === o.length)
            for (let n = 0, u = o.length; n < u; n++) s[n + i + 1] = o[n]
          else
            o.length < 1e4
              ? s.splice(i + 1, a - i, ...o)
              : (this._lineOffsets = s =
                  s.slice(0, i + 1).concat(o, s.slice(a + 1)))
          let l = n.text.length - (r - t)
          if (0 !== l)
            for (let n = i + 1 + o.length, u = s.length; n < u; n++)
              s[n] = s[n] + l
        } else {
          if (!e.isFull(n)) throw Error('Unknown change event received')
    ...
    getLineOffsets() {
      return (
        void 0 === this._lineOffsets &&
          (this._lineOffsets = su(this._content, !0)),
        this._lineOffsets
      )
    }
    positionAt(e) {
    ...
    ensureBeforeEOL(e, t) {
      for (; e > t && ou(this._content.charCodeAt(e - 1));) e--
      return e
    }
    get lineCount() {
      return this.getLineOffsets().length
...
function au(e, t) {
  ...
  for (; a < n.length && s < i.length;)
    t(n[a], i[s]) <= 0 ? (e[o++] = n[a++]) : (e[o++] = i[s++])
  for (; a < n.length;) e[o++] = n[a++]
...
;(!(function (e) {
  ;((e.create = function (e, t, r, n) {
    ...
    (e.update = function (e, t, r) {
      if (e instanceof iu) return (e.update(t, r), e)
      throw Error(
    ...
    (e.applyEdits = function (e, t) {
      ...
      for (let s of n) {
        ...
        if (t < i) throw Error('Overlapping edit')
        ;(t > i && a.push(r.substring(i, t)),
          s.newText.length && a.push(s.newText),
  ...
  (() => {
    var e = {
        470: (e) => {
          ...
          var n = {
            resolve: function () {
              for (
                var e, n = '', i = !1, a = arguments.length - 1;
                a >= -1 && !i;
                a--
              ) {
                var s
            ...
            relative: function (e, r) {
              ...
              for (
                var l = r.length - o, u = s < l ? s : l, c = -1, d = 0;
                d <= u;
                ++d
              ) {
                if (d === u) {
            ...
            parse: function (e) {
              ...
              a ? ((r.root = '/'), (n = 1)) : (n = 0)
              for (
                var s = -1, o = 0, l = -1, u = !0, c = e.length - 1, d = 0;
                c >= n;
                --c
              )
    ...
    ;((() => {
      ...
      class l {
        ...
        static file(t) {
          ...
          if (
            ...
            ;-1 === e
              ? ((r = t.substring(2)), (t = '/'))
              : ((r = t.substring(2, e)), (t = t.substring(e) || '/'))
          }
          return new c('file', r, t, '', '')
        }
        static from(e) {
          let t = new c(e.scheme, e.authority, e.path, e.query, e.fragment)
          return (s(t, !0), t)
        }
        toString(e = !1) {
          return m(this, e)
          ...
          if (e) {
            if (e instanceof l) return e
            {
              ...
              return (
                ...
                (t._fsPath = e._sep === u ? e.fsPath : null),
                t
              )
            }
          }
      ...
      class c extends l {
        ...
        _fsPath = null
        get fsPath() {
          return ((this._fsPath ||= p(this, !1)), this._fsPath)
        }
        toString(e = !1) {
          return e
            ? m(this, !0)
            : ((this._formatted ||= m(this, !1)), this._formatted)
        }
        toJSON() {
          let e = { $mid: 1 }
          return (
      ...
      function h(e, t, r) {
        ...
        for (let a = 0; a < e.length; a++) {
          ...
          if (
            ...
            (-1 !== i &&
              ((n += encodeURIComponent(e.substring(i, a))), (i = -1)),
              void 0 !== n && (n += e.charAt(a)))
          else {
        ...
        if (
          ...
          if (-1 !== e) {
            ...
            ;((a = a.substr(e + 1)),
              ...
              -1 === e
                ? (n += r(t, !1, !1))
                : ((n += r(t.substr(0, e), !1, !1)),
                  (n += ':'),
                  (n += r(t.substr(e + 1), !1, !0))),
              (n += '@'))
          }
          ;((a = a.toLowerCase()),
            (e = a.lastIndexOf(':')),
      ...
      function T(e) {
        return e.match(y) ? e.replace(y, (e) => g(e)) : e
      }
      var R = r(470)
      let v = R.posix || R
      var E
      !(function (e) {
        ;((e.joinPath = function (e, ...t) {
          return e.with({ path: v.join(e.path, ...t) })
        }),
          (e.resolvePath = function (e, ...t) {
            ...
            let i = v.resolve(r, ...t)
            return (
              n && '/' === i[0] && !e.authority && (i = i.substring(1)),
              e.with({ path: i })
            )
          }),
          (e.dirname = function (e) {
            if (0 === e.path.length || '/' === e.path) return e
            let t = v.dirname(e.path)
            return (
...
var cu,
  ...
  { URI: hu, Utils: fu } = ru
;(!(function (e) {
  ;((e.basename = fu.basename),
    (e.dirname = fu.dirname),
    (e.extname = fu.extname),
    (e.joinPath = fu.joinPath),
    (e.resolvePath = fu.resolvePath),
    ...
    (e.relative = function (e, t) {
      let r = 'string' == typeof e ? e : e.path,
        ...
        i = r.split('/').filter((e) => e.length > 0),
        a = n.split('/').filter((e) => e.length > 0),
        s = 0
      for (; s < i.length && i[s] === a[s]; s++);
      return '../'.repeat(i.length - s) + a.slice(s).join('/')
    }),
    (e.normalize = function (e) {
      return hu.parse(e.toString()).toString()
    }))
})((cu ||= {})),
  (function (e) {
...
var pu = class {
    ...
    async fromUri(e, t = Xl.CancellationToken.None) {
    ...
    fromTextDocument(e, t, r) {
      return (
        (t ??= hu.parse(e.uri)),
        Xl.CancellationToken.is(r)
          ? this.createAsync(t, e, r)
          : this.create(t, e, r)
      )
    }
    fromString(e, t, r) {
      return Xl.CancellationToken.is(r)
        ? this.createAsync(t, e, r)
        : this.create(t, e, r)
    }
    fromModel(e, t) {
    ...
    parse(e, t, r) {
      return this.serviceRegistry
        .getServices(e)
        .parser.LangiumParser.parse(t, r)
    }
    parseAsync(e, t, r) {
  ...
  mu = class {
    ...
    get all() {
      return fe(this.documentMap.values())
    }
    addDocument(e) {
    ...
    async getOrCreateDocument(e, t) {
      ...
      return (
        r ||
        ((r = await this.langiumDocumentFactory.fromUri(e, t)),
        this.addDocument(r),
        r)
      )
    }
    ...
    deleteDocument(e) {
      let t = e.toString(),
        r = this.documentMap.get(t)
      return (r && ((r.state = du.Changed), this.documentMap.delete(t)), r)
    }
  },
  gu = Symbol('ref_resolving'),
  yu = class {
    constructor(e) {
    ...
    async link(e, t = Xl.CancellationToken.None) {
      for (let r of Bt(e.parseResult.value))
        (await eu(t), Vt(r).forEach((t) => this.doLink(t, e)))
    }
    doLink(e, t) {
      let r = e.reference
      if (void 0 === r._ref) {
    ...
    buildReference(e, t, r, n) {
      let i = this,
        a = {
          ...
          $refText: n,
          get ref() {
            if (te(this._ref)) return this._ref
            if (
              (function (e) {
                return (
                  'object' == typeof e &&
              ...
              let r = i.loadAstNode(this._nodeDescription)
              this._ref =
                r ??
              ...
              this._ref = gu
              let r = Ut(e).$document,
                n = i.getLinkedNode({ reference: a, container: e, property: t })
              if (n.error && r && r.state < du.ComputedScopes)
                return void (this._ref = void 0)
              ;((this._ref = n.node ?? n.error),
                (this._nodeDescription = n.descr),
                r?.references.push(this))
            } else if (this._ref === gu)
              throw Error(
                `Cyclic reference resolution detected: ${i.astNodeLocator.getAstNodePath(e)}/${t} (symbol '${n}')`,
              )
            return te(this._ref) ? this._ref : void 0
          },
          get $nodeDescription() {
            return this._nodeDescription
          },
          get error() {
            return ne(this._ref) ? this._ref : void 0
          },
        }
      return a
    }
    ...
    createLinkingError(e, t) {
      let r = Ut(e.container).$document
      r && (r.state, du.ComputedScopes)
...
var Tu = class {
  ...
  Ru = class {
    ...
    findReferences(e, t) {
      ...
      let n = this.index.findAllReferences(
        e,
        this.nodeLocator.getAstNodePath(e),
      )
      return (
        t.documentUri &&
          (n = n.filter((e) => cu.equals(e.sourceUri, t.documentUri))),
        r.push(...n),
        fe(r)
      )
    }
    getReferenceToSelf(e) {
      ...
      if (t) {
        let r = Dt(e),
          n = this.nodeLocator.getAstNodePath(e)
        return {
          sourceUri: r.uri,
          sourcePath: n,
          targetUri: r.uri,
  ...
  vu = class {
    ...
    get size() {
      return pe.sum(fe(this.map.values()).map((e) => e.length))
    }
    clear() {
      this.map.clear()
    }
    delete(e, t) {
      if (void 0 === t) return this.map.delete(e)
      {
        ...
        if (r) {
          let n = r.indexOf(t)
          if (n >= 0)
            return (1 === r.length ? this.map.delete(e) : r.splice(n, 1), !0)
        }
        return !1
      }
    }
    ...
    entries() {
      return fe(this.map.entries()).flatMap(([e, t]) => t.map((t) => [e, t]))
    }
    keys() {
  ...
  $u = class {
    ...
    async computeExports(e, t = Xl.CancellationToken.None) {
      return this.computeExportsForNode(e.parseResult.value, e, void 0, t)
    }
    async computeExportsForNode(e, t, r = Ft, n = Xl.CancellationToken.None) {
      let i = []
      this.exportNode(e, i, t)
      for (let a of r(e)) (await eu(n), this.exportNode(a, i, t))
      return i
    }
    exportNode(e, t, r) {
    ...
    async computeLocalScopes(e, t = Xl.CancellationToken.None) {
      let r = e.parseResult.value,
        n = new vu()
      for (let i of Gt(r)) (await eu(t), this.processNode(i, e, n))
      return n
    }
    processNode(e, t, r) {
      let n = e.$container
  ...
  ku = class {
    constructor(e, t, r) {
      ;((this.elements = new Map()),
        (this.caseInsensitive = r?.caseInsensitive ?? !1))
      for (let n of e) {
        let e = this.caseInsensitive ? n.name.toLowerCase() : n.name
  ...
  Nu = class {
    constructor(e) {
      ;((this.reflection = e.shared.AstReflection),
        ...
        (this.globalScopeCache = new Cu(e.shared)))
    }
    getScope(e) {
      let t = [],
        r = this.reflection.getReferenceType(e),
        n = Dt(e.container).precomputedScopes
      if (n) {
        let i = e.container
        do {
          let e = n.get(i)
          ;(e.length > 0 &&
            t.push(fe(e).filter((e) => this.reflection.isSubtype(e.type, r))),
            (i = i.$container))
        } while (i)
      }
    ...
    getGlobalScope(e, t) {
      return this.globalScopeCache.get(
        e,
        () => new ku(this.indexManager.allElements(e)),
      )
    }
  }
function wu(e) {
  ...
  bu = class {
    ...
    serialize(e, t) {
      let r = t ?? {},
        ...
        a = n ? (e, t) => n(e, t, i) : i
      try {
        return ((this.currentDocument = Dt(e)), JSON.stringify(e, a, t?.space))
      } finally {
    ...
    replacer(
      ...
      if (!this.ignoreProperties.has(e)) {
        if (re(t)) {
          let e = t.ref,
            n = r ? t.$refText : void 0
          if (e) {
            let r = Dt(e),
              i = ''
            return (
              this.currentDocument &&
                this.currentDocument !== r &&
                (i = s ? s(r.uri, t) : r.uri.toString()),
              {
                $ref: `${i}#${this.astNodeLocator.getAstNodePath(e)}`,
                $refText: n,
              }
            )
          }
        ...
        if (te(t)) {
          ...
          if (
            (i &&
              ((r = this.addAstNodeRegionWithAssignmentsTo(
                Object.assign({}, t),
              )),
              (!e || t.$document) &&
                r?.$textRegion &&
                (r.$textRegion.documentURI =
                  this.currentDocument?.uri.toString())),
            n &&
              !e &&
              ((r ??= Object.assign({}, t)),
              (r.$sourceText = t.$cstNode?.text)),
            a)
          ) {
            r ??= Object.assign({}, t)
      ...
      for (let [o, l] of Object.entries(e))
        if (Array.isArray(l))
          for (let n = 0; n < l.length; n++) {
            let i = l[n]
            wu(i)
              ? (l[n] = this.reviveReference(e, o, t, i, r))
              : te(i) && this.linkNode(i, t, r, e, o, n)
          }
        else
          wu(l)
            ? (e[o] = this.reviveReference(e, o, t, l, r))
            : te(l) && this.linkNode(l, t, r, e, o)
      let s = e
      ;((s.$container = n), (s.$containerProperty = i), (s.$containerIndex = a))
    }
    reviveReference(e, t, r, n, i) {
      let a = n.$refText,
        s = n.$error
      if (n.$ref) {
        let e = this.getRefNode(r, n.$ref, i.uriConverter)
        if (te(e))
          return (
      ...
      if (s) {
        let r = { $refText: a ?? '' }
        return (
          (r.error = { container: e, property: t, message: s, reference: r }),
          r
        )
      }
    }
    getRefNode(e, t, r) {
      try {
        ...
        if (n < 0) {
          let e = r ? r(t) : hu.parse(t),
            n = this.langiumDocuments.getDocument(e)
          return n
            ? n.parseResult.value
            : 'Could not find document for URI: ' + t
        }
        let i = r ? r(t.substring(0, n)) : hu.parse(t.substring(0, n)),
  ...
  Ou = class {
    ...
    register(e) {
      ...
      for (let r of t.fileExtensions)
        (this.fileExtensionMap.has(r), this.fileExtensionMap.set(r, e))
      ;(this.languageIdMap.set(t.languageId, e),
        1 === this.languageIdMap.size
          ? (this.singleton = e)
    ...
    getServices(e) {
      ...
      let r = cu.extname(e),
        n = this.fileExtensionMap.get(r)
      if (!n)
        throw Error(
          t
            ? `The service registry contains no services for the extension '${r}' for language '${t}'.`
            : `The service registry contains no services for the extension '${r}'.`,
        )
      return n
    }
    hasServices(e) {
...
var Pu,
  Mu = class {
    ...
    async handleException(e, t, r, n) {
      try {
        ...
        ;(e instanceof Error && e.stack,
          r('error', `${t}: ${e instanceof Error ? e.message : String(e)}`, {
            node: n,
          }))
      }
    }
    ...
    getChecks(e, t) {
      let r = fe(this.entries.get(e)).concat(this.entries.get('AstNode'))
      return (
  ...
  Du = class {
    ...
    async validateDocument(e, t = {}, r = Xl.CancellationToken.None) {
      let n = e.parseResult,
        i = []
      if (
        (await eu(r),
        (!t.categories || t.categories.includes('built-in')) &&
          ...
          (t.stopAfterLexingErrors &&
            i.some((e) => e.data?.code === Pu.LexingError)) ||
            (this.processParsingErrors(n, i, t),
            t.stopAfterParsingErrors &&
              i.some((e) => e.data?.code === Pu.ParsingError)) ||
            (this.processLinkingErrors(e, i, t),
            t.stopAfterLinkingErrors &&
              i.some((e) => e.data?.code === Pu.LinkingError))))
      )
        return i
      try {
    ...
    async validateAst(e, t, r = Xl.CancellationToken.None) {
      let n = [],
        i = (e, t, r) => {
    ...
    async validateAstBefore(e, t, r, n = Xl.CancellationToken.None) {
      let i = this.validationRegistry.checksBefore
      for (let a of i) (await eu(n), await a(e, r, t.categories ?? [], n))
    }
    async validateAstNodes(e, t, r, n = Xl.CancellationToken.None) {
      await Promise.all(
        Bt(e).map(async (e) => {
          await eu(n)
          let i = this.validationRegistry.getChecks(e.$type, t.categories)
          for (let t of i) await t(e, r, n)
        }),
      )
    }
    async validateAstAfter(e, t, r, n = Xl.CancellationToken.None) {
...
function Uu(e) {
  ...
  return (
    'string' == typeof e.property
      ? (t = gr(e.node.$cstNode, e.property, e.index))
      : 'string' == typeof e.keyword &&
        (t = Tr(e.node.$cstNode, e.keyword, e.index)),
    (t ??= e.node.$cstNode),
    t
      ? t.range
...
function Gu(e) {
  switch (e) {
    case 'error':
      return _u(Pu.LexingError)
    case 'warning':
      return _u(Pu.LexingWarning)
    case 'info':
      return _u(Pu.LexingInfo)
    case 'hint':
      return _u(Pu.LexingHint)
    default:
      throw Error('Invalid diagnostic severity: ' + e)
  }
}
...
var Bu = class {
    ...
    createDescription(e, t, r) {
      ...
      let a,
        s = () => (a ??= ve(this.nameProvider.getNameNode(e) ?? e.$cstNode))
      return {
        node: e,
        name: t,
        get nameSegment() {
  ...
  Ku = class {
    ...
    async createDescriptions(e, t = Xl.CancellationToken.None) {
      let r = [],
        n = e.parseResult.value
      for (let i of Bt(n))
        (await eu(t),
          Vt(i)
            .filter((e) => !ne(e))
    ...
    createDescription(e) {
      ...
      return {
        ...
        targetPath: t.path,
        segment: ve(r),
        local: cu.equals(t.documentUri, n),
      }
    }
  },
  Vu = class {
    ...
    getPathSegment({ $containerProperty: e, $containerIndex: t }) {
      ...
      return void 0 === t ? e : e + this.indexSeparator + t
    }
    getAstNode(e, t) {
  ...
  Wu = class {
    constructor(e) {
      ;((this._ready = new nu()),
        ...
        (this.onConfigurationSectionUpdateEmitter = new ju.Emitter()),
        (this.serviceRegistry = e.ServiceRegistry))
    }
    get ready() {
...
var zu = class {
    constructor(e) {
      ;((this.updateBuildOptions = {
        ...
        (this.buildPhaseListeners = new vu()),
        (this.documentPhaseListeners = new vu()),
        (this.buildState = new Map()),
        (this.documentBuildWaiters = new Map()),
        (this.currentState = du.Changed),
    ...
    async build(e, t = {}, r = Xl.CancellationToken.None) {
      for (let n of e) {
        let e = n.uri.toString()
        if (n.state === du.Validated) {
          if ('boolean' == typeof t.validation && t.validation)
            ((n.state = du.IndexedReferences),
            ...
            if (i) {
              let a = (t.validation.categories ?? Lu.all).filter(
                (e) => !i.includes(e),
              )
              a.length > 0 &&
    ...
    async update(e, t, r = Xl.CancellationToken.None) {
      this.currentState = du.Changed
      for (let a of t)
      ...
      for (let a of e) {
        if (!this.langiumDocuments.invalidateDocument(a)) {
          let e = this.langiumDocumentFactory.fromModel({ $type: 'INVALID' }, a)
          ;((e.state = du.Changed), this.langiumDocuments.addDocument(e))
        }
        this.buildState.delete(a.toString())
      }
      let n = fe(e)
      ...
      ;(this.langiumDocuments.all
        .filter((e) => !n.has(e.uri.toString()) && this.shouldRelink(e, n))
        .forEach((e) => {
          ;(this.serviceRegistry.getServices(e.uri).references.Linker.unlink(e),
            (e.state = Math.min(e.state, du.ComputedScopes)),
      ...
      await this.buildDocuments(i, this.updateBuildOptions, r)
    }
    ...
    async buildDocuments(e, t, r) {
      ;(this.prepareBuild(e, t),
        await this.runCancelable(e, du.Parsed, r, (e) =>
          this.langiumDocumentFactory.update(e, r),
        ),
        await this.runCancelable(e, du.IndexedContent, r, (e) =>
          this.indexManager.updateContent(e, r),
        ),
        await this.runCancelable(e, du.ComputedScopes, r, async (e) => {
          e.precomputedScopes = await this.serviceRegistry
            .getServices(e.uri)
            .references.ScopeComputation.computeLocalScopes(e, r)
        }),
        await this.runCancelable(e, du.Linked, r, (e) =>
          this.serviceRegistry.getServices(e.uri).references.Linker.link(e, r),
        ),
        await this.runCancelable(e, du.IndexedReferences, r, (e) =>
          this.indexManager.updateReferences(e, r),
        ))
      let n = e.filter((e) => this.shouldValidate(e))
      await this.runCancelable(n, du.Validated, r, (e) => this.validate(e, r))
      for (let i of e) {
        let e = this.buildState.get(i.uri.toString())
        e && (e.completed = !0)
      }
    }
    prepareBuild(e, t) {
    ...
    async runCancelable(e, t, r, n) {
      ...
      for (let s of i)
        (await eu(r),
          await n(s),
          (s.state = t),
          await this.notifyDocumentPhase(s, t, r))
    ...
    waitUntil(e, t, r) {
      ...
      if (
        (t && 'path' in t ? (n = t) : (r = t),
        (r ??= Xl.CancellationToken.None),
        n)
      ) {
        let t = this.langiumDocuments.getDocument(n)
        if (t && t.state > e) return Promise.resolve(n)
      }
        ...
        : r.isCancellationRequested
          ...
          : new Promise((t, i) => {
              let a = this.onBuildPhase(e, () => {
                  ;(a.dispose(),
                    s.dispose(),
                    t(n ? this.langiumDocuments.getDocument(n)?.uri : void 0))
                }),
                s = r.onCancellationRequested(() => {
                  ;(a.dispose(), s.dispose(), i(Jl))
                })
            })
    }
    ...
    async notifyBuildPhase(e, t, r) {
      ...
      for (let i of n) (await eu(r), await i(e, r))
    }
    shouldValidate(e) {
      return !!this.getBuildOptions(e).validation
    }
    async validate(e, t) {
      let r = this.serviceRegistry.getServices(e.uri).validation
          .DocumentValidator,
        n = this.getBuildOptions(e).validation,
        i = 'object' == typeof n ? n : void 0,
        a = await r.validateDocument(e, i, t)
      e.diagnostics ? e.diagnostics.push(...a) : (e.diagnostics = a)
      let s = this.buildState.get(e.uri.toString())
      if (s) {
        s.result ??= {}
        let e = i?.categories ?? Lu.all
        s.result.validationChecks
          ? s.result.validationChecks.push(...e)
          : (s.result.validationChecks = [...e])
      }
    }
    getBuildOptions(e) {
  ...
  Yu = class {
    ...
    findAllReferences(e, t) {
      ...
      return (
        this.referenceIndex.forEach((e) => {
          e.forEach((e) => {
            cu.equals(e.targetUri, r) && e.targetPath === t && n.push(e)
          })
        }),
        fe(n)
      )
    ...
    allElements(e, t) {
      let r = fe(this.symbolIndex.keys())
      return (
        t && (r = r.filter((e) => !t || t.has(e))),
        r.map((t) => this.getFileDescriptions(t, e)).flat()
      )
    }
    ...
    async updateContent(e, t = Xl.CancellationToken.None) {
    ...
    async updateReferences(e, t = Xl.CancellationToken.None) {
      let r = await this.serviceRegistry
        .getServices(e.uri)
  ...
  qu = class {
    ...
    async initializeWorkspace(e, t = Xl.CancellationToken.None) {
      ...
      return (
        ...
        await Promise.all(
          e
            ...
            .map(async (e) => this.traverseFolder(...e, t, n)),
        ),
        this._ready.resolve(),
        r
      )
    ...
    getRootFolder(e) {
      return hu.parse(e.uri)
    }
    async traverseFolder(e, t, r, n) {
      let i = await this.fileSystemProvider.readDirectory(t)
      await Promise.all(
        i.map(async (t) => {
          this.includeEntry(e, t, r) &&
            (t.isDirectory
              ? await this.traverseFolder(e, t.uri, r, n)
              : t.isFile &&
                n(await this.langiumDocuments.getOrCreateDocument(t.uri)))
        }),
      )
    }
    includeEntry(e, t, r) {
      let n = cu.basename(t.uri)
      if (n.startsWith('.')) return !1
      if (t.isDirectory) return 'node_modules' !== n && 'out' !== n
      if (t.isFile) {
        let e = cu.extname(t.uri)
        return r.includes(e)
      }
      return !1
    }
  ...
  Xu = class {
    buildUnexpectedCharactersMessage(e, t, r, n, i) {
      return mi.buildUnexpectedCharactersMessage(e, t, r, n, i)
    }
    buildUnableToPopLexerModeMessage(e) {
      return mi.buildUnableToPopLexerModeMessage(e)
    }
  },
  Qu = { mode: 'full' },
  Ju = class {
    constructor(e) {
      ...
      let r = ec(t) ? Object.values(t) : t,
        n = 'production' === e.LanguageMetaData.mode
      this.chevrotainLexer = new yi(r, {
        positionTracking: 'full',
        skipValidations: n,
    ...
    tokenize(e, t = Qu) {
      ...
      return {
        ...
        report: (r = this.tokenBuilder).flushLexingReport?.call(r, e),
      }
    }
    toTokenTypeDictionary(e) {
      if (ec(e)) return e
      let t = Zu(e) ? Object.values(e.modes).flat() : e,
        r = {}
...
function tc(e, t, r) {
  let n, i
  return (
    'string' == typeof e ? ((i = t), (n = r)) : ((i = e.range.start), (n = t)),
    (i ||= bs.create(0, 0)),
    (function (e) {
      let t = bs.create(e.position.line, e.position.character)
      if (0 === e.tokens.length) return new Tc([], Os.create(t, t))
      let r = []
      for (; e.index < e.tokens.length;) {
        let t = dc(e, r[r.length - 1])
        t && r.push(t)
      }
      let n = r[0]?.range.start ?? t,
        i = r[r.length - 1]?.range.end ?? t
      return new Tc(r, Os.create(n, i))
    })({
      index: 0,
      tokens: ac({ lines: rc(e), position: i, options: gc(n) }),
      position: i,
    })
  )
}
function rc(e) {
  let t = ''
  return ((t = 'string' == typeof e ? e : e.text), t.split(ar))
}
var nc = /\s*(@([\p{L}][\p{L}\p{N}]*)?)/uy,
  ic = /\{(@[\p{L}][\p{L}\p{N}]*)(\s*)([^\r\n}]+)?\}/gu
function ac(e) {
  let t = [],
    r = e.position.line,
  ...
  for (let i = 0; i < e.lines.length; i++) {
    ...
    if (((o = o.substring(0, cc(o))), uc(o, l) >= o.length)) {
      if (t.length > 0) {
        let e = bs.create(r, n)
        t.push({ type: 'break', content: '', range: Os.create(e, e) })
      }
    } else {
      nc.lastIndex = l
      let e = nc.exec(o)
      if (e) {
        let i = e[0],
          a = e[1],
          s = bs.create(r, n + l),
          u = bs.create(r, n + l + i.length)
        ;(t.push({ type: 'tag', content: a, range: Os.create(s, u) }),
          (l += i.length),
          (l = uc(o, l)))
      }
      if (l < o.length) {
        let e = o.substring(l),
          i = Array.from(e.matchAll(ic))
        t.push(...sc(i, e, r, n + l))
      }
    }
    ;(r++, (n = 0))
...
function sc(e, t, r, n) {
  ...
  if (0 === e.length) {
    let e = bs.create(r, n),
      a = bs.create(r, n + t.length)
    i.push({ type: 'text', content: t, range: Os.create(e, a) })
  } else {
    let a = 0
    for (let o of e) {
      let e = o.index,
      ...
      s.length > 0 &&
        i.push({
          ...
          range: Os.create(bs.create(r, a + n), bs.create(r, e + n)),
        })
      let l = s.length + 1,
        u = o[1]
      if (
        ...
        i.push({
          type: 'text',
          content: '',
          range: Os.create(bs.create(r, a + l + n), bs.create(r, a + l + n)),
        })
      a = e + o[0].length
    }
    let s = t.substring(a)
    s.length > 0 &&
      i.push({
        type: 'text',
        content: s,
        range: Os.create(bs.create(r, a + n), bs.create(r, a + n + s.length)),
      })
  }
  return i
}
...
function hc(e) {
  ...
  for (; t && 'break' !== t.type && 'tag' !== t.type;)
    (i.push(fc(e)), (n = t), (t = e.tokens[e.index]))
  return new vc(i, Os.create(r.range.start, n.range.end))
}
function fc(e) {
  return 'inline-tag' === e.tokens[e.index].type ? pc(e, !0) : mc(e)
}
function pc(e, t) {
  let r = e.tokens[e.index++],
    n = r.content.substring(1)
  if ('text' === e.tokens[e.index]?.type) {
    if (t) {
      let i = mc(e)
      return new Rc(
        n,
        new vc([i], i.range),
        t,
        Os.create(r.range.start, i.range.end),
      )
    }
    {
      let i = hc(e)
      return new Rc(n, i, t, Os.create(r.range.start, i.range.end))
    }
  }
  {
    let e = r.range
    return new Rc(n, new vc([], e), t, e)
  }
}
function mc(e) {
  let t = e.tokens[e.index++]
  return new Ec(t.content, t.range)
}
function gc(e) {
  if (!e) return gc({ start: '/**', end: '*/', line: '*' })
  let { start: t, end: r, line: n } = e
  return { start: yc(t, !0), end: yc(r, !1), line: yc(n, !0) }
}
function yc(e, t) {
  if ('string' == typeof e || 'object' == typeof e) {
    let r = 'string' == typeof e ? dr(e) : e.source
    return RegExp(t ? `^\\s*${r}` : `\\s*${r}\\s*$`)
  }
  return e
}
var Tc = class {
      ...
      if (this.inline) {
        let r = (function (e, t, r) {
          if ('linkplain' === e || 'linkcode' === e || 'link' === e) {
            ...
            return (
              ('linkcode' === e || ('link' === e && 'code' === r.link)) &&
                (i = `\`${i}\``),
              r.renderLink?.call(r, t, i) ??
                (function (e, t) {
                  try {
                    return (hu.parse(e, !0), `[${t}](${e})`)
                  } catch {
                    return e
                  }
                })(t, i)
    ...
    toString() {
      ...
      for (let t = 0; t < this.inlines.length; t++) {
        let r = this.inlines[t],
          n = this.inlines[t + 1]
        ;((e += r.toString()),
          n && n.range.start.line > r.range.start.line && (e += '\n'))
      }
      return e
    }
    toMarkdown(e) {
      ...
      for (let r = 0; r < this.inlines.length; r++) {
        let n = this.inlines[r],
          i = this.inlines[r + 1]
        ;((t += n.toMarkdown(e)),
          i && i.range.start.line > n.range.start.line && (t += '\n'))
      }
      return t
    }
  },
...
var Ac,
  kc = class {
    ...
    findNameInPrecomputedScopes(e, t) {
      let r = Dt(e).precomputedScopes
      if (!r) return
      let n = e
      do {
        let e = r.get(n).find((e) => e.name === t)
        if (e) return e
        n = n.$container
      } while (n)
    }
  ...
  Sc = class {
    constructor() {
      ;((this.previousTokenSource = new Xl.CancellationTokenSource()),
        (this.writeQueue = []),
        (this.readQueue = []),
        (this.done = !0))
    }
    write(e) {
      this.cancelWrite()
      let t = ((Ql = performance.now()), new Xl.CancellationTokenSource())
      return (
    ...
    enqueue(e, t, r = Xl.CancellationToken.None) {
      let n = new nu(),
        i = { action: t, deferred: n, cancellationToken: r }
        ...
        await Promise.all(
          e.map(async ({ action: e, deferred: t, cancellationToken: r }) => {
            try {
              ...
              Zl(e) ? t.resolve(void 0) : t.reject(e)
            }
          }),
        ),
        (this.done = !0),
  ...
  Cc = class {
    constructor(e) {
      ;((this.grammarElementIdMap = new Eu()),
        (this.tokenTypeIdMap = new Eu()),
    ...
    createDehyrationContext(e) {
      let t = new Map(),
        r = new Map()
      for (let n of Bt(e)) t.set(n, {})
      if (e.$cstNode) for (let n of Te(e.$cstNode)) r.set(n, {})
      ...
      for (let [n, i] of Object.entries(e))
        if (!n.startsWith('$'))
          if (Array.isArray(i)) {
            ...
            for (let r of i)
              te(r)
                ? e.push(this.dehydrateAstNode(r, t))
                : re(r)
                  ? e.push(this.dehydrateReference(r, t))
                  : e.push(r)
          } else
            te(i)
              ? (r[n] = this.dehydrateAstNode(i, t))
              : re(i)
                ? (r[n] = this.dehydrateReference(i, t))
                : void 0 !== i && (r[n] = i)
      return r
    }
    dehydrateReference(e, t) {
      ...
      return (
        (r.$refText = e.$refText),
        e.$refNode && (r.$refNode = t.cstNodes.get(e.$refNode)),
        r
      )
    }
    ...
    createHydrationContext(e) {
      let t,
        r = new Map(),
        n = new Map()
      for (let i of Bt(e)) r.set(i, {})
      if (e.$cstNode)
        for (let i of Te(e.$cstNode)) {
          let e
          ;('fullText' in i
            ? ((e = new Al(i.fullText)), (t = e))
            : 'content' in i
              ? (e = new El())
              : 'tokenType' in i && (e = this.hydrateCstLeafNode(i)),
            e && (n.set(i, e), (e.root = t)))
        }
      ...
      for (let [n, i] of Object.entries(e))
        if (!n.startsWith('$'))
          if (Array.isArray(i)) {
            ...
            for (let a of i)
              te(a)
                ? e.push(this.setParent(this.hydrateAstNode(a, t), r))
                : re(a)
                  ? e.push(this.hydrateReference(a, r, n, t))
                  : e.push(a)
          } else
            te(i)
              ? (r[n] = this.setParent(this.hydrateAstNode(i, t), r))
              : re(i)
                ? (r[n] = this.hydrateReference(i, r, n, t))
                : void 0 !== i && (r[n] = i)
      return r
    }
    setParent(e, t) {
    ...
    hydrateCstNode(e, t, r = 0) {
      ...
      if (
        ('number' == typeof e.grammarSource &&
          (n.grammarSource = this.getGrammarElement(e.grammarSource)),
    ...
    hydrateCstLeafNode(e) {
      ...
      return new vl(
        r,
        n,
        { start: { line: i, character: a }, end: { line: s, character: o } },
        t,
        l,
      )
    }
    ...
    createGrammarElementIdMap() {
      let e = 0
      for (let t of Bt(this.grammar))
        be(t) && this.grammarElementIdMap.set(t, e++)
    }
  }
function Nc(e) {
  return {
    documentation: {
      CommentProvider: (e) => new xc(e),
      DocumentationProvider: (e) => new kc(e),
    },
    parser: {
      AsyncParser: (e) => new Ic(e),
      GrammarConfig: (e) =>
        (function (e) {
          let t = [],
            r = e.Grammar
          for (let n of r.rules) nt(n) && mr(n) && lr(xr(n)) && t.push(n.name)
          return { multilineCommentRules: t, nameRegexp: $e }
        })(e),
      LangiumParser: (e) => Kl(e),
      CompletionParser: (e) =>
        (function (e) {
          let t = e.Grammar,
            r = e.parser.Lexer,
            n = new Ll(e)
          return (_l(t, n, r.definition), n.finalize(), n)
        })(e),
      ValueConverter: () => new Hl(),
      TokenBuilder: () => new jl(),
      Lexer: (e) => new Ju(e),
      ParserErrorMessageProvider: () => new wl(),
      LexerErrorMessageProvider: () => new Xu(),
    },
    workspace: {
      AstNodeLocator: () => new Vu(),
      AstNodeDescriptionProvider: (e) => new Bu(e),
      ReferenceDescriptionProvider: (e) => new Ku(e),
    },
    references: {
      Linker: (e) => new yu(e),
      NameProvider: () => new Tu(),
      ScopeProvider: (e) => new Nu(e),
      ScopeComputation: (e) => new $u(e),
      References: (e) => new Ru(e),
    },
    serializer: {
      Hydrator: (e) => new Cc(e),
      JsonSerializer: (e) => new bu(e),
    },
    validation: {
      DocumentValidator: (e) => new Du(e),
      ValidationRegistry: (e) => new Mu(e),
    },
    shared: () => e.shared,
  }
}
function wc(e) {
  return {
    ServiceRegistry: (e) => new Ou(e),
    workspace: {
      LangiumDocuments: (e) => new mu(e),
      LangiumDocumentFactory: (e) => new pu(e),
      DocumentBuilder: (e) => new zu(e),
      IndexManager: (e) => new Yu(e),
      WorkspaceManager: (e) => new qu(e),
      FileSystemProvider: (t) => e.fileSystemProvider(t),
      WorkspaceLock: () => new Sc(),
      ConfigurationProvider: (e) => new Wu(e),
    },
  }
}
function Lc(e, t, r, n, i, a, s, o, l) {
  return Oc([e, t, r, n, i, a, s, o, l].reduce(Mc, {}))
}
;(Ac ||= {}).merge = (e, t) => Mc(Mc({}, e), t)
var bc = Symbol('isProxy')
function Oc(e, t) {
  let r = new Proxy(
    {},
    {
...
function Pc(e, t, r, n) {
  ...
  if (t in r) {
    ...
    e[t] = _c
    try {
      e[t] = 'function' == typeof i ? i(n) : Oc(i, n)
    } catch (r) {
...
function Bc(e) {
  let t = (function () {
    ...
    r = t.serializer.JsonSerializer.deserialize(e)
  return (
    t.shared.workspace.LangiumDocumentFactory.fromModel(
      r,
      hu.parse(`memory://${r.name ?? 'grammar'}.langium`),
    ),
    r
  )
}
var Kc = Object.defineProperty,
  Vc = (e, t) => Kc(e, 'name', { value: t, configurable: !0 }),
  jc = 'Statement',
  Hc = 'Architecture'
Vc(function (e) {
  return Id.isInstance(e, Hc)
}, 'isArchitecture')
var Wc = 'Axis',
  zc = 'Branch'
Vc(function (e) {
  return Id.isInstance(e, zc)
}, 'isBranch')
var Yc = 'Checkout',
  qc = 'CherryPicking',
  Xc = 'ClassDefStatement',
  Qc = 'Commit'
Vc(function (e) {
  return Id.isInstance(e, Qc)
}, 'isCommit')
var Jc = 'Curve',
  Zc = 'Edge',
  ed = 'Entry',
  td = 'GitGraph'
Vc(function (e) {
  return Id.isInstance(e, td)
}, 'isGitGraph')
var rd = 'Group',
  nd = 'Info'
Vc(function (e) {
  return Id.isInstance(e, nd)
}, 'isInfo')
var id = 'Item',
  ad = 'Junction',
  sd = 'Merge'
Vc(function (e) {
  return Id.isInstance(e, sd)
}, 'isMerge')
var od = 'Option',
  ld = 'Packet'
Vc(function (e) {
  return Id.isInstance(e, ld)
}, 'isPacket')
var ud = 'PacketBlock'
;(Vc(function (e) {
  return Id.isInstance(e, ud)
}, 'isPacketBlock'),
  Vc(function (e) {
    return Id.isInstance(e, 'Pie')
  }, 'isPie'))
var cd = 'PieSection'
Vc(function (e) {
  return Id.isInstance(e, cd)
}, 'isPieSection')
var dd = 'Radar',
  hd = 'Service',
  fd = 'Treemap'
Vc(function (e) {
  return Id.isInstance(e, fd)
}, 'isTreemap')
var pd,
  md,
  gd,
  ...
  xd = class extends ie {
    ...
    computeIsSubtype(e, t) {
      switch (e) {
        ...
        case Qc:
        case sd:
          return this.isSubtype(jc, t)
        case $d:
          return this.isSubtype(td, t)
        case Ad:
        case kd:
          return this.isSubtype(id, t)
        default:
          return !1
      }
    }
    ...
    getTypeMetaData(e) {
      switch (e) {
        ...
        case Wc:
          return { name: Wc, properties: [{ name: 'label' }, { name: 'name' }] }
        case zc:
          return { name: zc, properties: [{ name: 'name' }, { name: 'order' }] }
        case Yc:
          return { name: Yc, properties: [{ name: 'branch' }] }
        case qc:
          return {
            name: qc,
            properties: [
        ...
        case ed:
          return { name: ed, properties: [{ name: 'axis' }, { name: 'value' }] }
        case td:
          return {
            name: td,
            properties: [
        ...
        case ad:
          return { name: ad, properties: [{ name: 'id' }, { name: 'in' }] }
        case sd:
          return {
            name: sd,
            properties: [
  ...
  Bd = { AstReflection: Vc(() => new xd(), 'AstReflection') },
  Kd = {
    Grammar: Vc(() => Sd(), 'Grammar'),
    LanguageMetaData: Vc(() => _d, 'LanguageMetaData'),
    parser: {},
  },
  Vd = {
    Grammar: Vc(() => Cd(), 'Grammar'),
    LanguageMetaData: Vc(() => Pd, 'LanguageMetaData'),
    parser: {},
  },
  jd = {
    Grammar: Vc(() => Nd(), 'Grammar'),
    LanguageMetaData: Vc(() => Md, 'LanguageMetaData'),
    parser: {},
  },
  Hd = {
    Grammar: Vc(() => wd(), 'Grammar'),
    LanguageMetaData: Vc(() => Dd, 'LanguageMetaData'),
    parser: {},
  },
  Wd = {
    Grammar: Vc(() => Ld(), 'Grammar'),
    LanguageMetaData: Vc(() => Ud, 'LanguageMetaData'),
    parser: {},
  },
  zd = {
    Grammar: Vc(() => bd(), 'Grammar'),
    LanguageMetaData: Vc(() => Fd, 'LanguageMetaData'),
    parser: {},
  },
  Yd = {
    Grammar: Vc(() => Od(), 'Grammar'),
    LanguageMetaData: Vc(() => Gd, 'LanguageMetaData'),
    parser: {},
  },
  qd = {
    ACC_DESCR: /accDescr(?:[\t ]*:([^\n\r]*)|\s*{([^}]*)})/,
  ...
  Xd = class extends Hl {
    static {
      Vc(this, 'AbstractMermaidValueConverter')
    }
    runConverter(e, t, r) {
      let n = this.runCommonConverter(e, t, r)
      return (
        void 0 === n && (n = this.runCustomConverter(e, t, r)),
        void 0 === n ? super.runConverter(e, t, r) : n
      )
    }
  ...
  Qd = class extends Xd {
    static {
      Vc(this, 'CommonValueConverter')
    }
    runCustomConverter(e, t, r) {}
  },
  Jd = class extends jl {
    static {
      Vc(this, 'AbstractMermaidTokenBuilder')
    }
    constructor(e) {
...
;(class extends Jd {
  static {
    Vc(this, 'CommonTokenBuilder')
  }
})
var Zd = class extends Jd {
    static {
      Vc(this, 'ArchitectureTokenBuilder')
    }
    constructor() {
      super(['architecture'])
    }
  ...
  eh = class extends Xd {
    static {
      Vc(this, 'ArchitectureValueConverter')
    }
    runCustomConverter(e, t, r) {
  ...
  th = {
    parser: {
      TokenBuilder: Vc(() => new Zd(), 'TokenBuilder'),
      ValueConverter: Vc(() => new eh(), 'ValueConverter'),
    },
  }
function rh(e = Uc) {
  let t = Lc(wc(e), Bd),
    r = Lc(Nc({ shared: t }), Hd, th)
  return (t.ServiceRegistry.register(r), { shared: t, Architecture: r })
}
Vc(rh, 'createArchitectureServices')
var nh = class extends Jd {
    static {
      Vc(this, 'GitGraphTokenBuilder')
    }
    constructor() {
      super(['gitGraph'])
    }
  ...
  ih = {
    parser: {
      TokenBuilder: Vc(() => new nh(), 'TokenBuilder'),
      ValueConverter: Vc(() => new Qd(), 'ValueConverter'),
    },
  }
function ah(e = Uc) {
  let t = Lc(wc(e), Bd),
    r = Lc(Nc({ shared: t }), Wd, ih)
  return (t.ServiceRegistry.register(r), { shared: t, GitGraph: r })
}
Vc(ah, 'createGitGraphServices')
var sh = class extends Jd {
    static {
      Vc(this, 'InfoTokenBuilder')
    }
    constructor() {
      super(['info', 'showInfo'])
    }
  ...
  oh = {
    parser: {
      TokenBuilder: Vc(() => new sh(), 'TokenBuilder'),
      ValueConverter: Vc(() => new Qd(), 'ValueConverter'),
    },
  }
function lh(e = Uc) {
  let t = Lc(wc(e), Bd),
    r = Lc(Nc({ shared: t }), Kd, oh)
  return (t.ServiceRegistry.register(r), { shared: t, Info: r })
}
Vc(lh, 'createInfoServices')
var uh = class extends Jd {
    static {
      Vc(this, 'PacketTokenBuilder')
    }
    constructor() {
      super(['packet'])
    }
  ...
  ch = {
    parser: {
      TokenBuilder: Vc(() => new uh(), 'TokenBuilder'),
      ValueConverter: Vc(() => new Qd(), 'ValueConverter'),
    },
  }
function dh(e = Uc) {
  let t = Lc(wc(e), Bd),
    r = Lc(Nc({ shared: t }), Vd, ch)
  return (t.ServiceRegistry.register(r), { shared: t, Packet: r })
}
Vc(dh, 'createPacketServices')
var hh = class extends Jd {
    static {
      Vc(this, 'PieTokenBuilder')
    }
    constructor() {
      super(['pie', 'showData'])
    }
  ...
  ph = {
    parser: {
      TokenBuilder: Vc(() => new hh(), 'TokenBuilder'),
      ValueConverter: Vc(() => new fh(), 'ValueConverter'),
    },
  }
function mh(e = Uc) {
  let t = Lc(wc(e), Bd),
    r = Lc(Nc({ shared: t }), jd, ph)
  return (t.ServiceRegistry.register(r), { shared: t, Pie: r })
}
Vc(mh, 'createPieServices')
var gh = class extends Jd {
    static {
      Vc(this, 'RadarTokenBuilder')
    }
    constructor() {
      super(['radar-beta'])
    }
  ...
  yh = {
    parser: {
      TokenBuilder: Vc(() => new gh(), 'TokenBuilder'),
      ValueConverter: Vc(() => new Qd(), 'ValueConverter'),
    },
  }
function Th(e = Uc) {
  let t = Lc(wc(e), Bd),
    r = Lc(Nc({ shared: t }), zd, yh)
  return (t.ServiceRegistry.register(r), { shared: t, Radar: r })
}
Vc(Th, 'createRadarServices')
var Rh = class extends Jd {
    static {
      Vc(this, 'TreemapTokenBuilder')
    }
    constructor() {
      super(['treemap'])
    }
  },
  vh = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/,
  Eh = class extends Xd {
    static {
      Vc(this, 'TreemapValueConverter')
    }
    runCustomConverter(e, t, r) {
      if ('NUMBER2' === e.name) return parseFloat(t.replace(/,/g, ''))
      if ('SEPARATOR' === e.name || 'STRING2' === e.name)
...
Vc($h, 'registerValidationChecks')
var Ah = class {
    static {
      Vc(this, 'TreemapValidator')
    }
    checkSingleRoot(e, t) {
      let r
      for (let n of e.TreemapRows)
        n.item &&
          (void 0 === r && void 0 === n.indent
            ? (r = 0)
            : (void 0 === n.indent ||
                (void 0 !== r && r >= parseInt(n.indent, 10))) &&
  ...
  kh = {
    parser: {
      TokenBuilder: Vc(() => new Rh(), 'TokenBuilder'),
      ValueConverter: Vc(() => new Eh(), 'ValueConverter'),
    },
    validation: { TreemapValidator: Vc(() => new Ah(), 'TreemapValidator') },
  }
function xh(e = Uc) {
  let t = Lc(wc(e), Bd),
    r = Lc(Nc({ shared: t }), Yd, kh)
  return (t.ServiceRegistry.register(r), $h(r), { shared: t, Treemap: r })
}
Vc(xh, 'createTreemapServices')
var Ih = {},
  Sh = {
    info: Vc(async () => {
      let { createInfoServices: e } = await u(async () => {
        const { createInfoServices: e } =
          await import('./info-63CPKGFF-C5qLm77y-PZ2cNKr9.js')
        return { createInfoServices: e }
      }, [])
      Ih.info = e().Info.parser.LangiumParser
    }, 'info'),
    packet: Vc(async () => {
      let { createPacketServices: e } = await u(async () => {
        const { createPacketServices: e } =
          await import('./packet-HUATNLJX-DH3z2nUY-DqPVy-l5.js')
        return { createPacketServices: e }
      }, [])
      Ih.packet = e().Packet.parser.LangiumParser
    }, 'packet'),
    pie: Vc(async () => {
      let { createPieServices: e } = await u(async () => {
        const { createPieServices: e } =
          await import('./pie-WTHONI2E-D4D4sBKQ-B2yZ5Xn5.js')
        return { createPieServices: e }
      }, [])
      Ih.pie = e().Pie.parser.LangiumParser
    }, 'pie'),
    architecture: Vc(async () => {
      let { createArchitectureServices: e } = await u(async () => {
        const { createArchitectureServices: e } =
          await import('./architecture-O4VJ6CD3-CqLO852D-JccRMemD.js')
        return { createArchitectureServices: e }
      }, [])
      Ih.architecture = e().Architecture.parser.LangiumParser
    }, 'architecture'),
    gitGraph: Vc(async () => {
      let { createGitGraphServices: e } = await u(async () => {
        const { createGitGraphServices: e } =
          await import('./gitGraph-ZV4HHKMB-BITaNtjy-CFv70alW.js')
        return { createGitGraphServices: e }
      }, [])
      Ih.gitGraph = e().GitGraph.parser.LangiumParser
    }, 'gitGraph'),
    radar: Vc(async () => {
      let { createRadarServices: e } = await u(async () => {
        const { createRadarServices: e } =
          await import('./radar-NJJJXTRR-CPNIrjDo-C7nCc_VC.js')
        return { createRadarServices: e }
      }, [])
      Ih.radar = e().Radar.parser.LangiumParser
    }, 'radar'),
    treemap: Vc(async () => {
      let { createTreemapServices: e } = await u(async () => {
        const { createTreemapServices: e } =
          await import('./treemap-75Q7IDZK-DZ-9vjsy-BGgeR1A7.js')
        return { createTreemapServices: e }
      }, [])
      Ih.treemap = e().Treemap.parser.LangiumParser
    }, 'treemap'),
  }
async function Ch(e, t) {
  ...
  Ih[e] || (await r())
  let n = Ih[e].parse(t)
  if (n.lexerErrors.length > 0 || n.parserErrors.length > 0) throw new Nh(n)
  return n.value
}
Vc(Ch, 'parse')
...
//# sourceMappingURL=mermaid-parser.core-C45JiJ5u-CB90PcCy.js.map
