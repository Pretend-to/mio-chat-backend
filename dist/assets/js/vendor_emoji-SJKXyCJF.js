...
var B = 'undefined' != typeof wrappedJSObject
function O(e) {
  if (!e) return e
...
var N = ['annotation', 'emoji', 'group', 'order', 'version']
function D(e, t) {
...
async function W(e, t) {
  ...
  ;(await (async function (e, t, n) {
    ...
    return i === n && r === t
  })(e, t, i)) || (n || (n = (await F(t))[1]), await L(e, n, t, i))
}
var G = class {
    constructor({
      dataSource:
    ...
    async delete() {
      ...
      ;(await this._shutdown(),
        ...
        new Promise((t, n) => {
          ;(w(e), v(t, n, indexedDB.deleteDatabase(e)))
        })))
    }
  },
  V = [
        ...
        K(() =>
          e(
            (function () {
              ...
              try {
                for (const [t, n] of e) if (ee(t)) return n
              } catch (t) {}
              return e[0][1]
            })(),
          ),
...
var he = new WeakMap(),
  fe = new WeakMap(),
  pe = Symbol('un-keyed'),
  ge = 'replaceChildren' in Element.prototype
function be(e, t) {
  ...
  ;(o
    ...
    i &&
      (function (e, t) {
        ge ? e.replaceChildren(...t) : ((e.innerHTML = ''), e.append(...t))
      })(o, e))
}
function ve(e, t, n) {
...
function ke(e) {
  const { template: t, elementsToBindings: n } = ue(he, e, () =>
      (function (e) {
        let t = '',
          n = !1,
          o = !1,
        ...
        for (let c = 0, d = e.length; c < d; c++) {
          const u = e[c]
          if (((t += u.slice(s)), c === d - 1)) break
          for (let e = 0; e < u.length; e++)
            switch (u.charAt(e)) {
              case '<':
                '/' === u.charAt(e + 1) ? a.pop() : ((n = !0), a.push(++i))
                break
              case '>':
                ;((n = !1), (o = !1))
                break
        ...
        return { template: me(t), elementsToBindings: r }
      })(e),
    ),
    ...
    i = (function (e, t) {
      const n = []
      let o
      if (1 === t.size && (o = t.get(0))) ve(o, e, n)
      else {
  ...
  const c = (t) => {
    ...
    b = {
      onClickSkinToneButton: function (e) {
        ;((r.skinTonePickerExpanded = !r.skinTonePickerExpanded),
          ...
          r.skinTonePickerExpanded && (oe(e), se(() => c('skintone-list'))))
      },
      onEmojiClick: async function (e) {
        const { target: t } = e
        if (!t.classList.contains('emoji')) return
        ;(oe(e), T(t.id.substring(4)))
      },
    ...
    v = {
      calculateEmojiGridStyle: function (e) {
        !(function (e, t, n) {
          let o
          ;(ce ? ((o = new ResizeObserver(n)), o.observe(e)) : se(n),
      ...
      r.databaseLoaded &&
        (async function () {
          ...
          r.defaultFavoriteEmojis = (
            await Promise.all(J.map((t) => e.getEmojiByUnicodeOrName(t)))
          ).filter(Boolean)
        })()
    }),
    a(() => {
      r.databaseLoaded &&
        ...
        (async function () {
          ...
          r.currentFavorites = await S(
            re(
              [...(await e.getTopFavoriteEmoji(n)), ...t],
              (e) => e.unicode || e.name,
            ).slice(0, n),
          )
        })()
          ...
          se(() =>
            (function (e) {
              !(function (e, t, n) {
                ...
                ? (r.currentEmojis = [...r.currentEmojis])
                : w()
            })(o),
          ))
        : (h(t ? e : e.filter(j)), w())
...
//# sourceMappingURL=vendor_emoji-SJKXyCJF.js.map
