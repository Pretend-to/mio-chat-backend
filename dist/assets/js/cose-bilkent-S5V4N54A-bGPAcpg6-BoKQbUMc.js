...
import { t as o } from './cytoscape.esm-xf9dtmBj-D8iH9RMK.js'
var s = n((t, e) => {
    var i, r
    ;((i = t),
      (r = function () {
        return (function (t) {
          ...
          function (t, e, i) {
            var r = (function () {
              ...
              o = function (t, e, i, r) {
                return (
                  null === t ? (r.head = e) : (t.next = e),
                  null === i ? (r.tail = e) : (i.prev = e),
                  (e.prev = t),
                  (e.next = i),
                  r.length++,
                  e
              ...
              s = function (t, e) {
                var i = t.prev,
                  r = t.next
                return (
                  null === i ? (e.head = r) : (i.next = r),
                  null === r ? (e.tail = i) : (r.prev = i),
                  (t.prev = t.next = null),
                  e.length--,
                  t
                )
            ...
            ;((n.lastID = 0),
              (n.createID = function (t) {
                return n.isPrimitive(t)
                  ? t
                  : null == t.uniqueID
                    ? ((t.uniqueID = n.getString()), n.lastID++, t.uniqueID)
                    : t.uniqueID
              }),
              (n.getString = function (t) {
                return ((t ??= n.lastID), 'Object#' + t)
              }),
            ...
            ;((c.RANDOM_SEED = 1),
              ...
              (c.prototype.createBendpointsFromDummyNodes = function () {
                ...
                ;((t = t.concat(this.graphManager.getAllEdges())),
                  (t = [].concat(r(this.edgeToDummyNodes.keys()), t)))
          ...
          function (t, e, i) {
            ...
            ;((h.prototype.initParameters = function () {
              ...
              (h.prototype.calcGravitationalForce = function (t) {
                var e,
                  i = t.getOwner(),
                  r = (i.getRight() + i.getLeft()) / 2,
                  n = (i.getTop() + i.getBottom()) / 2,
                  o = t.getCenterX() - r,
                  s = t.getCenterY() - n,
                  a = Math.abs(o) + t.getWidth() / 2,
                  h = Math.abs(s) + t.getHeight() / 2
                t.getOwner() == this.graphManager.getRoot()
                  ? (a > (e = i.getEstimatedSize() * this.gravityRangeFactor) ||
                      h > e) &&
                    ((t.gravitationForceX = -this.gravityConstant * o),
                    (t.gravitationForceY = -this.gravityConstant * s))
                  : (a >
                      (e =
                        i.getEstimatedSize() *
                        this.compoundGravityRangeFactor) ||
                    ...
                    (t.gravitationForceY =
                      -this.gravityConstant * s * this.compoundGravityConstant))
              }),
              ...
              (h.prototype.calcGrid = function (t) {
                ...
                for (n = 0; n < e; n++) for (var o = 0; o < i; o++) r[n][o] = []
                return r
              }),
              ...
              (h.prototype.calculateRepulsionForceOfANode = function (
                ...
                if (
                  ...
                  t.surrounding = []
                  for (
                    var s, a = this.grid, h = t.startX - 1;
                    h < t.finishX + 2;
                    h++
                  )
          ...
          function (t, e, i) {
            ...
            ;((v.prototype.newGraphManager = function () {
              ...
              (v.prototype.canAddHorizontal = function (t, e, i) {
                ...
                t.rowHeight[r] < i &&
                  r > 0 &&
                  (o = i + t.verticalPadding - t.rowHeight[r])
                var s =
                  t.width - n >= e + t.horizontalPadding
                    ? (t.height + o) / (n + e + t.horizontalPadding)
                    : (t.height + o) / t.width
                o = i + t.verticalPadding
                var a =
                  t.width < e ? (t.height + o) / e : (t.height + o) / t.width
                return (a < 1 && (a = 1 / a), s < 1 && (s = 1 / s), s < a)
              }),
              ...
              (v.prototype.findPlaceforPrunedNode = function (t) {
                ...
                if (3 == u && 0 == d)
                  ...
                  e = 4 == u && 0 == d ? (y = Math.floor(4 * Math.random())) : c
                0 == e
                  ? r.setCenter(
                      i.getCenterX(),
                      i.getCenterY() -
        ...
        (r = function (t) {
          return (function (t) {
            ...
            function (t, e, i) {
                ...
                (u.prototype.processChildrenList = function (t, e, i) {
                  for (var r = e.length, n = 0; n < r; n++) {
                    var o,
                      s = e[n],
                      g = s.children(),
                      u = s.layoutDimensions({
                        nodeDimensionsIncludeLabels:
                          this.options.nodeDimensionsIncludeLabels,
                      })
                    if (
                      (((o =
                        null != s.outerWidth() && null != s.outerHeight()
                          ? t.add(
                              new a(
                                i.graphManager,
                                new h(
                          ...
                          : t.add(new a(this.graphManager))).id = s.data('id')),
                      (o.paddingLeft = parseInt(s.css('padding'))),
                      (o.paddingTop = parseInt(s.css('padding'))),
                      (o.paddingRight = parseInt(s.css('padding'))),
                      (o.paddingBottom = parseInt(s.css('padding'))),
              ...
              ;(typeof cytoscape < 'u' && d(cytoscape), (t.exports = d))
            },
          ])
        }),
        'object' == typeof t && 'object' == typeof e
          ...
          : 'function' == typeof define && define.amd
            ? define(['cose-base'], r)
            : 'object' == typeof t
              ? (t.cytoscapeCoseBilkent = r(a()))
              : (i.cytoscapeCoseBilkent = r(i.coseBase)))
    })(),
    1,
  )
function l(t, e) {
  t.forEach((t) => {
    ...
    ;(Object.keys(t).forEach((e) => {
      ;['id', 'label', 'height', 'width', 'padding', 'x', 'y'].includes(e) ||
        (i[e] = t[e])
    }),
      e.add({
        group: 'nodes',
...
async function p(t, e) {
  ...
  try {
    ...
    let e = await u(t),
      ...
      n = d(e)
    return (
      i.debug(`Layout completed: ${r.length} nodes, ${n.length} edges`),
      { nodes: r, edges: n }
    )
  } catch (t) {
    throw (i.error('Error in cose-bilkent layout algorithm:', t), t)
  }
}
function f(t) {
...
;(o.use(h.default),
  e(l, 'addNodes'),
  e(g, 'addEdges'),
  e(u, 'createCytoscapeInstance'),
  e(c, 'extractPositionedNodes'),
  e(d, 'extractPositionedEdges'),
  e(p, 'executeCoseBilkentLayout'),
  e(f, 'validateLayoutData'))
var y = e(
  async (
    t,
    e,
    ...
    let d = c.insert('g').attr('class', 'subgraphs'),
      f = c.insert('g').attr('class', 'edgePaths'),
      y = c.insert('g').attr('class', 'edgeLabels'),
      E = c.insert('g').attr('class', 'nodes')
      ...
      await Promise.all(
        t.edges.map(async (e) => {
          ...
          let i = g[e.start ?? ''],
            o = g[e.end ?? '']
          if (i && o) {
            let n = v.edges.find((t) => t.id === e.id)
            if (n) {
              a.debug('APA01 positionedEdge', n)
              let s = { ...e }
              h(s, r(f, s, u, t.type, i, o, t.diagramId))
            } else {
              let n = {
                ...e,
                points: [
              ...
              h(n, r(f, n, u, t.type, i, o, t.diagramId))
            }
          }
        }),
      ),
...
export { y as render }
//# sourceMappingURL=cose-bilkent-S5V4N54A-bGPAcpg6-BoKQbUMc.js.map
