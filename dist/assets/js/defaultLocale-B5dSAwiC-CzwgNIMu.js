function t(t, i) {
  if (
    (r = (t = i ? t.toExponential(i - 1) : t.toExponential()).indexOf('e')) < 0
  )
    return null
  var r,
    n = t.slice(0, r)
...
var r,
  n = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i
function e(t) {
  if (!(i = n.exec(t))) throw Error('invalid format: ' + t)
  var i
  return new o({
    fill: i[1],
    align: i[2],
...
var s = {
  ...
  s: function (i, n) {
    ...
    return s === c
      ? o
      : s > c
        ? o + Array(s - c + 1).join('0')
        : s > 0
          ? o.slice(0, s) + '.' + o.slice(s)
          : '0.' + Array(1 - s).join('0') + t(i, Math.max(0, n + s - 1))[0]
  },
...
function g(t) {
  var n =
      void 0 === t.grouping || void 0 === t.thousands
        ...
        : (function (t, i) {
            return function (r, n) {
              for (
                var e = r.length, o = [], a = 0, s = t[0], c = 0;
                e > 0 &&
                s > 0 &&
                (c + s + 1 > n && (s = Math.max(1, n - c)),
                o.push(r.substring((e -= s), e + s)),
                !((c += s + 1) > n));
              )
                s = t[(a = (a + 1) % t.length)]
              return o.reverse().join(i)
            }
          })(f.call(t.grouping, Number), t.thousands + ''),
  ...
  function p(t) {
    ...
    function N(t) {
      ...
      if ('c' === w) ((u = z(t) + u), (t = ''))
        ...
        var p = (t = +t) < 0 || 1 / t < 0
        if (
          ((t = isNaN(t) ? m : z(Math.abs(t), b)),
          x &&
            (t = (function (t) {
              t: for (var i, r = t.length, n = 1, e = -1; n < r; ++n)
                switch (t[n]) {
                  case '.':
                    e = i = n
                    break
          ...
          for (e = -1, o = t.length; ++e < o;)
            if (48 > (a = t.charCodeAt(e)) || a > 57) {
              ;((u = (46 === a ? l + t.slice(e + 1) : t.slice(e)) + u),
                (t = t.slice(0, e)))
              break
            }
      }
      M && !v && (t = n(t, Infinity))
      var N = s.length + t.length + u.length,
        j = N < y ? Array(y - N + 1).join(i) : ''
      switch (
        (M &&
          v &&
          ((t = n(j + t, j.length ? y - u.length : Infinity)), (j = '')),
        c)
      ) {
        case '<':
          t = s + t + u + j
        ...
        case '=':
          ...
          break
        case '^':
          t = j.slice(0, (N = j.length >> 1)) + s + t + u + j.slice(N)
          break
        default:
          t = j + s + t + u
      }
  ...
  return {
    ...
    formatPrefix: function (t, r) {
      var n = p((((t = e(t)).type = 'f'), t)),
        o = 3 * Math.max(-8, Math.min(8, Math.floor(i(r) / 3))),
        a = 10 ** -o,
        s = d[8 + o / 3]
      return function (t) {
        return n(a * t) + s
...
!(function (t) {
  ;((l = g(t)), (h = l.format), (u = l.formatPrefix))
})({ thousands: ',', grouping: [3], currency: ['$', ''] })
export { u as i, e as n, h as r, i as t }
//# sourceMappingURL=defaultLocale-B5dSAwiC-CzwgNIMu.js.map
