...
import { t as d } from './arc-vLgDTVZZ-DVeiGpC_.js'
var u = (function () {
  var t = i(function (t, e, n, i) {
    ...
    h = {
      ...
      performAction: i(function (t, e, n, i, r, a, s) {
        var l = a.length - 1
        switch (r) {
          case 1:
            return a[l - 1]
          ...
          case 5:
            ...
            break
          case 8:
            ;(i.getCommonDb().setDiagramTitle(a[l].substr(6)),
              (this.$ = a[l].substr(6)))
            break
          case 9:
      ...
      parse: i(function (t) {
        ...
        ;('function' == typeof y.yy.parseError
          ...
          i(function (t) {
            ;((n.length -= 2 * t), (a.length -= t), (s.length -= t))
          }, 'popStack'),
          i(x, 'lex'))
        for (var b, k, _, w, v, S, $, E, T, I = {}; ;) {
          if (
            ((_ = n[n.length - 1]),
...
var g = '',
  ...
  k = i(() => l, 'getCommonDb'),
  _ = i(function () {
    ;((m.length = 0), (x.length = 0), (g = ''), (b.length = 0), n())
  }, 'clear'),
  w = i(function (t) {
    ;((g = t), m.push(t))
  }, 'addSection'),
  ...
  T = i(function (t) {
    let e = { section: g, type: g, description: t, task: t, classes: [] }
    x.push(e)
  }, 'addTaskOrg'),
  I = i(function () {
    let t = i(function (t) {
      ...
      e = !0
    for (let [n, i] of b.entries()) (t(n), (e &&= i.processed))
    return e
  }, 'compileTasks'),
  M = {
    clear: _,
  ...
  N = i(function (t, e) {
    ...
    return (
      ...
      i(s, 'sad'),
      i(l, 'ambivalent'),
      e.score > 3 ? a(r) : e.score < 3 ? s(r) : l(r),
      n
    )
  }, 'drawFace'),
  C = i(function (t, e) {
  ...
  j = i(function (t, e, n) {
    ...
    ;(O++,
      r
        ...
        .attr('stroke', '#666'),
      N(r, { cx: i, cy: 300 + 30 * (5 - e.score), score: e.score }))
    let a = z()
    ;((a.x = e.x),
      (a.y = e.y),
      (a.fill = e.fill),
  ...
  B = (function () {
    ...
    function e(t, e, n, i, a, s, l, o, c) {
      let { taskFontSize: h, taskFontFamily: d } = o,
        u = t.split(/<br\s*\/?>/gi)
      for (let p = 0; p < u.length; p++) {
        let t = p * h - (h * (u.length - 1)) / 2,
          o = e
            .append('text')
            .attr('x', n + a / 2)
            .attr('y', i)
  ...
  t.each(function () {
    ...
    for (let e = 0; e < r.length; e++)
      ((t = r[r.length - 1 - e]),
        a.push(t),
        o.text(a.join(' ').trim()),
        (o.node().getComputedTextLength() > n || '<br>' === t) &&
          (a.pop(),
          o.text(a.join(' ').trim()),
          (a = '<br>' === t ? [''] : [t]),
          (o = i
...
var V = i(function (t, e, n, i) {
  ...
  Z = i(function (t, e, n) {
    ...
    return (i.remove(), r.height + 1.1 * a * 0.5 + e.padding)
  ...
  U = i(function (n, i, a, s) {
    let l = h(),
      o = l.timeline?.leftMargin ?? 50
    r.debug('timeline', s.db)
    let c,
      d = l.securityLevel
    'sandbox' === d && (c = e('#i' + i))
    let u = e(
      'sandbox' === d ? c.nodes()[0].contentDocument.body : 'body',
    ).select('#' + i)
    u.append('g')
    let p = s.db.getTasks(),
      y = s.db.getCommonDb().getDiagramTitle()
    ;(r.debug('task', p), q.initGraphics(u))
    ...
    g.forEach(function (t) {
      let e = {
        ...
        n = q.getVirtualNodeHeight(u, e, l)
      ;(r.debug('sectionHeight before draw', n), (f = Math.max(f, n + 20)))
    })
    let S = 0,
      $ = 0
    r.debug('tasks.length', p.length)
    for (let [t, e] of p.entries()) {
      let n = {
          number: t,
          descr: e,
          section: e.section,
        ...
        i = q.getVirtualNodeHeight(u, n, l)
      ;(r.debug('taskHeight before draw', i),
        (m = Math.max(m, i + 20)),
        (S = Math.max(S, e.events.length)))
      let a = 0
      for (let t of e.events) {
        ...
        a += q.getVirtualNodeHeight(u, n, l)
      }
      ;(e.events.length > 0 && (a += 10 * (e.events.length - 1)),
        ($ = Math.max($, a)))
    }
    ;(r.debug('maxSectionHeight before draw', f),
      r.debug('maxTaskHeight before draw', m),
      g && g.length > 0
        ? g.forEach((t) => {
            let e = p.filter((e) => e.section === t),
              n = {
                number: w,
                descr: t,
                section: w,
            ...
            r.debug('sectionNode', n)
            let i = u.append('g'),
              a = q.drawNode(i, n, w, l)
            ;(r.debug('sectionNode output', a),
              i.attr('transform', `translate(${k}, 50)`),
              (_ += f + 50),
              e.length > 0 && Y(u, e, w, k, _, m, l, S, $, f, !1),
              (k += 200 * Math.max(e.length, 1)),
              (_ = 50),
              w++)
          })
        : ((v = !1), Y(u, p, w, k, _, m, l, S, $, f, !0)))
    ...
    ;(r.debug('bounds', E),
      ...
      t(void 0, u, l.timeline?.padding ?? 50, l.timeline?.useMaxWidth ?? !1))
  }, 'draw'),
  Y = i(function (t, e, n, i, a, s, l, o, c, h, d) {
    for (let u of e) {
      let e = {
        descr: u.task,
        section: n,
      ...
      r.debug('taskNode', e)
      let o = t.append('g').attr('class', 'taskWrapper'),
        h = q.drawNode(o, e, n, l).height
      if (
        (r.debug('taskHeight after draw', h),
        o.attr('transform', `translate(${i}, ${a})`),
        (s = Math.max(s, h)),
        u.events)
      ) {
        ...
        ;((a += 100),
          ...
          e
            ...
            .attr('y1', a + s)
            .attr('x2', i + 95)
            .attr('y2', a + s + 100 + c + 100)
            .attr('stroke-width', 2)
            .attr('stroke', 'black')
            .attr('marker-end', 'url(#arrowhead)')
            .attr('stroke-dasharray', '5,5'))
      }
      ;((i += 200), d && !l.timeline?.disableMulticolor && n++)
    }
    a -= 10
  }, 'drawTasks'),
  K = i(function (t, e, n, i, a, s) {
    let l = 0,
      o = a
    a += 100
    for (let c of e) {
      ...
      r.debug('eventNode', e)
      let o = t.append('g').attr('class', 'eventWrapper'),
        h = q.drawNode(o, e, n, s).height
      ;((l += h),
        o.attr('transform', `translate(${i}, ${a})`),
        (a = a + 10 + h))
    }
...
export { Q as diagram }
//# sourceMappingURL=timeline-definition-IT6M3QCI-C9VMls3W-BRnCDvac.js.map
