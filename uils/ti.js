...
var gpt = function (_a, process) {
  var _b = _a.messages,
    ...
    model = _d === void 0 ? '' : _d,
    _e = _a.markdown,
    markdown = _e === void 0 ? false : _e
  try {
    axios_1
      .post(
        'https://ti.krumio.com/api/chat/gpt',
        {
          ...
          markdown:
            markdown != undefined && markdown != null ? markdown : false,
        },
        {
          headers: {
...
var bing = function (_a, process) {
  var _b = _a.messages,
    messages = _b === void 0 ? [] : _b,
    _c = _a.conversation_style,
    conversation_style = _c === void 0 ? 'Balanced' : _c,
    _d = _a.markdown,
    markdown = _d === void 0 ? false : _d,
    _e = _a.stream,
    stream = _e === void 0 ? false : _e
  var str = false
  try {
    if (
      stream != undefined &&
      stream != null &&
      (typeof stream).toString().toLowerCase() === 'Boolean'.toLowerCase()
    ) {
      if (stream === true) {
        str = true
      } else {
  ...
  try {
    axios_1
      .post(
        'https://ti.krumio.com/api/chat/complements',
        {
          messages: messages != undefined && messages != null ? messages : [],
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_d) {
        try {
          axios_1
            .post(
              'https://ti.krumio.com/api/image/complements',
              {
                prompt: prompt != undefined && prompt != null ? prompt : '',
                model: 'pixart-a',
                data: {
                  ...
                  dpm_guidance_scale:
                    data != undefined &&
                    data != null &&
                    data.dpm_guidance_scale != undefined &&
                    data.dpm_guidance_scale != null
                      ? data.dpm_guidance_scale
                      : 4.5,
                  dpm_inference_steps:
                    data != undefined &&
                    data != null &&
                    data.dpm_inference_steps != undefined &&
                    data.dpm_inference_steps != null
                      ? data.dpm_inference_steps
                      : 14,
                  sa_guidance_scale:
                    data != undefined &&
                    data != null &&
                    data.sa_guidance_scale != undefined &&
                    data.sa_guidance_scale != null
                      ? data.sa_guidance_scale
                      : 3,
                  sa_inference_steps:
                    data != undefined &&
                    data != null &&
                    data.sa_inference_steps != undefined &&
                    data.sa_inference_steps != null
                      ? data.sa_inference_steps
                      : 25,
                },
              },
              {
              ...
              'https://ti.krumio.com/api/image/complements',
              {
                ...
                data: {
                  ...
                  lcm_inference_steps:
                    data != undefined &&
                    data != null &&
                    data.lcm_inference_steps != undefined &&
                    data.lcm_inference_steps != null
                      ? data.lcm_inference_steps
                      : 9,
                },
              },
              {
...
const _pixart = pixart
export { _pixart as pixart }
              ...
              'https://ti.krumio.com/api/image/complements',
              {
                ...
                data: {
                  ...
                  sampling_method:
                    data != undefined &&
                    data != null &&
                    data.sampling_method != undefined &&
                  ...
                  sampling_steps:
                    data != undefined &&
                    data != null &&
                    data.sampling_steps != undefined &&
                    data.sampling_steps != null
                      ? data.sampling_steps
                      : 25,
                  width:
                    data != undefined &&
