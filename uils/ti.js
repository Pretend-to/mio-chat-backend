...
var gpt = function (_a, process) {
    ...
    try {
        axios_1.post("https://ti.krumio.com/api/chat/gpt", {
...
var bing = function (_a, process) {
    ...
    try {
        axios_1.post("https://ti.krumio.com/api/chat/complements", {
            messages: messages != undefined && messages != null ? messages : [],
    ...
    pixart.a = function (_a, process) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_d) {
                try {
                    axios_1.post("https://ti.krumio.com/api/image/complements", {
                        prompt: prompt != undefined && prompt != null ? prompt : "",
                        model: "pixart-a",
                        data: {
