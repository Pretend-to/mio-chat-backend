...
const BUILTIN_MODEL_RULES = [
  // DeepSeek 系列
  {
    pattern: /deepseek-(chat|v3|reasoner|r1)/i,
    maxInput: 131072,
    maxOutput: 65536,
    vision: false,
    fc: true,
  ...
  {
    pattern: /claude-3-5-(sonnet|haiku)/i,
    maxInput: 200000,
    maxOutput: 8192,
    vision: true,
    fc: true,
  ...
  {
    pattern: /claude-3-(opus|sonnet|haiku)/i,
    maxInput: 200000,
    maxOutput: 4096,
    vision: true,
    fc: true,
  ...
  // Google Gemini 系列
  {
    pattern: /gemini-2\.[05]-(flash|pro)/i,
    maxInput: 1048576,
    maxOutput: 65536,
    vision: true,
    fc: true,
  ...
  // 智谱 GLM 系列
  {
    pattern: /glm-[45](\.\d+)?(-turbo)?(-air)?(-flash)?$/i,
    maxInput: 131072,
    maxOutput: 4096,
    vision: false,
    fc: true,
