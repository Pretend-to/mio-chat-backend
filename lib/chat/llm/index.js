...
class LLMChatService {
  ...
  handleMessage(e) {
    try {
      ...
      if (!llm) {
        throw new Error(`No LLM instance found for provider: ${providerName}`)
      }
