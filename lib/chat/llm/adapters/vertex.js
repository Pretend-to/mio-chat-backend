...
export default class VertexAdapter extends GeminiAdapter {
  ...
  static getAdapterMetadata() {
    return {
      type: 'vertex',
      requiresSpecialAuth: true, // 需要 Service Account JSON 认证
      description: 'Google Vertex AI 适配器，支持基于 Service Account 的认证并可代理 Gemini/Anthropic 模型。',
      authSchema: {
        authConfig: {
          description: 'Service Account JSON 对象，用于获取 Google Cloud 访问令牌（整个 JSON 对象）',
          default: {},
          required: true,
          type: 'object',
        },
        region: {
          description: 'Vertex 服务区域，例如 us-central1 或 us-east5',
          default: 'us-central1',
          required: false,
          type: 'string',
        },
