...
export default class GeminiAdapter extends BaseLLMAdapter {
  ...
  static getAdapterMetadata() {
    return {
      ...
      description: 'Google Gemini / 类似 Gemini 的模型适配器，支持流式、工具调用与推理配置。',
      authSchema: {
        base_url: {
          description: 'Gemini API 的基础 URL，例如 https://generativelanguage.googleapis.com',
          default: 'https://generativelanguage.googleapis.com',
          required: true,
          type: 'string',
        },
        api_key: {
          description: '用于调用 Gemini 的 API Key，支持以逗号分隔的多个 key',
          default: '',
          required: true,
          type: 'string',
        },
