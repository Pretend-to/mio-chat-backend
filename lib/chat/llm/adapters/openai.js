...
export default class OpenAIBot extends BaseLLMAdapter {
  ...
  static getAdapterMetadata() {
    return {
      ...
      description: 'OpenAI 官方 API 适配器，支持流式输出、工具调用、推理设置与图片处理。',
      authSchema: {
        base_url: {
          description: 'OpenAI API 的基础 URL，例如 https://api.openai.com',
          default: 'https://api.openai.com/v1',
          required: true,
          type: 'string',
        },
        api_key: {
          description: '用于调用 OpenAI 的 API Key，支持以逗号分隔的多个 key',
          default: '',
          required: true,
          type: 'string',
        },
