...
export const declarativeProfiles = [
  ...
  {
    aliases: ['volc', '火山', '火山引擎'],
    avatarAliases: { volc: 'volcengine', 火山: 'volcengine', 火山引擎: 'volcengine' },
    avatarId: 'volcengine',
    description:
    ...
    initialConfigSchema: createConfigSchema({
      apiKeyDesc: '火山引擎 API 密钥',
      baseUrl: 'https://ark.cn-beijing.volces.com/api/v3',
      baseUrlDesc: '火山引擎 API 基础 URL',
      namePlaceholder: '例如：火山方舟-主要',
    }),
