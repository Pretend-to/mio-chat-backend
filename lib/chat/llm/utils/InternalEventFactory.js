 ...
 */
export const InternalEventFactory = {
  /**
   ...
   */
  createSimpleEvent({ model, messages, requestId, onContent, onComplete, chatParams, extraSettings, settings, stream = false }) {
