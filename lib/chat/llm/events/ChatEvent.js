...
export class ChatEvent {
   ...
   * @param {object|null} [params.principal]
   * @param {string|null} [params.subagentRunId]
   * @param {boolean} [params.isWake]
   * @param {string|null} [params.channelSource]
