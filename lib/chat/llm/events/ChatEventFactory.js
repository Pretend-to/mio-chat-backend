...
import { WakeChatEvent } from './subtypes/WakeChatEvent.js'
...
import { WakeNormalizer } from './normalizers/WakeNormalizer.js'
...
export const ChatEventFactory = {
  ...
  create(canonicalParams) {
    ...
    switch (source) {
      ...
      case EVENT_SOURCE.WAKE:
        return new WakeChatEvent(canonicalParams)
  ...
  /** Create a candidate event from one durable Agent Session work item. */
  createForWake(workItem) {
    return new WakeChatEvent(WakeNormalizer.normalize(workItem))
  },
