    ...
    switch (engine) {
      case 'prodia.v1':
        try {
          ...
          const imgUrl = await this.prodia.getImage(data,'sd','text2img')
          logger.info(
            '[' +
              id +
              '] 使用' +
      ...
      case 'prodia.xl':
        try {
          ...
          const imgUrl = await this.prodia.getImage(data,'xl','text2img')
      ...
      case 'prodia.upscale.img2img':
        try {
          ...
          const imgUrl = await this.prodia.getImage(data,'sd','upscale')
      ...
      case 'prodia.v1.img2img':
        try {
          ...
          const imgUrl = await this.prodia.getImage(data,'sd','img2img')
      ...
      case 'prodia.xl.img2img':
        try {
          ...
          const imgUrl = await this.prodia.getImage(data, 'xl', 'img2img')
