...
import { savePic, getPNGBase64 } from '../../utils/imgTools.js'
...
export function startServer() {
  ...
  // // 通配符路由，处理SPA的路由
  // app.get('*', (req,res) => {
  //   logger.info('请求的不是静态资源，返回index.html')
  //   // 如果请求的不是css、js、图片、字体等静态资源，则返回index.html
  //   if (!req.url.match(/\.(css|js|png|jpg|jpeg|gif|apk|ico|svg|ttf|woff|woff2|eot)$/)) 
