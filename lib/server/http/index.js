...
import * as subAgentController from './controllers/subAgentController.js'
...
export async function startServer() {
    ...
    expressStaticGzip(distDir, {
      ...
      setHeaders: (res, filePath) => {
        ...
        const isHashedAsset =
          ...
          /-[A-Za-z0-9_-]{8,}\.(?:js|css|woff2?|png|jpe?g|webp|avif|svg)(?:\.(?:br|gz))?$/.test(
            normalizedPath,
          )
        const isServiceWorker =
          /\/service-worker(?:\.[^/]+)?\.js(?:\.(?:br|gz))?$/.test(
            normalizedPath,
          )
  ...
  app.get(
    '/api/onebot/status',
    authConfigAPI,
    asyncHandler(baseController.getOnebotStatus),
  )
  // Onebot手动重连路由（需要管理员验证）
  app.post(
    '/api/onebot/reconnect',
    authConfigAPI,
    asyncHandler(baseController.reconnectOnebot),
  )
  // OpenAI预设和工具路由
  app.get(
    '/api/openai/:type',
  ...
  app.get(
    '/api/skills',
    asyncHandler(skillController.getSkills.bind(skillController)),
  )
  ...
  app.put(
    '/api/config/llm/:adapterType/:instanceId',
    authConfigAPI,
  ...
  app.post(
    '/api/config/llm/:adapterType/:instanceId/refresh-models',
    authConfigAPI,
    asyncHandler(configController.refreshModels),
  )
  app.post(
    '/api/config/llm/:adapterType/test-connection',
    authConfigAPI,
    asyncHandler(configController.testLLMConnection),
  )
  app.post(
    '/api/config/llm/:adapterType/fetch-models',
    authConfigAPI,
    asyncHandler(configController.fetchLLMModels),
  )
  app.post(
  ...
  app.get(
    '/api/push/vapid-key',
    authConfigAPI,
    asyncHandler(pushController.getVapidPublicKey),
  )
  app.get(
    '/api/push/subscriptions',
    authConfigAPI,
    asyncHandler(pushController.getSubscriptions),
  )
  app.post(
    '/api/push/subscribe',
    authConfigAPI,
  ...
  app.post(
    ...
    authConfigAPI,
    asyncHandler(pushController.unsubscribe),
  )
  app.post(
    '/api/push/clear-all',
    authConfigAPI,
    asyncHandler(pushController.clearSubscriptions),
  )
  app.post(
    '/api/push/test',
    authConfigAPI,
    asyncHandler(pushController.testPush),
  )
  ...
  app.get(
    '/api/images/adapters',
    authConfigAPI,
    asyncHandler(imageController.getImageAdapters),
  )
  app.post(
    '/api/images/adapters',
    authConfigAPI,
    asyncHandler(imageController.createImageAdapter),
  )
  app.put(
    '/api/images/adapters/:id',
    authConfigAPI,
    asyncHandler(imageController.updateImageAdapter),
  )
  app.delete(
    '/api/images/adapters/:id',
    authConfigAPI,
    asyncHandler(imageController.deleteImageAdapter),
  )
  app.post(
    '/api/images/test',
    authConfigAPI,
    asyncHandler(imageController.testImageGeneration),
  )
  app.post(
    '/api/images/models',
    authConfigAPI,
    asyncHandler(imageController.fetchImageModels),
  )
  app.get(
    '/api/images/tasks/:taskId',
    asyncHandler(imageController.getImageTask),
  )
  ...
  app.get(
    '/api/search/adapters',
    authConfigAPI,
    asyncHandler(searchController.getSearchAdapters),
  )
  app.post(
    '/api/search/adapters',
    authConfigAPI,
    asyncHandler(searchController.createSearchAdapter),
  )
  app.put(
    '/api/search/adapters/:id',
    authConfigAPI,
    asyncHandler(searchController.updateSearchAdapter),
  )
  app.delete(
    '/api/search/adapters/:id',
    authConfigAPI,
    asyncHandler(searchController.deleteSearchAdapter),
  )
  app.post(
    '/api/search/test',
    authConfigAPI,
    asyncHandler(searchController.testSearch),
  )
  // Shell 自动审批策略 API（后端权威名单管理）
  app.get(
    '/api/shell/policy',
    authConfigAPI,
    asyncHandler(shellPolicyController.listShellRules),
  )
  app.post(
    '/api/shell/policy',
    authConfigAPI,
    asyncHandler(shellPolicyController.addShellRule),
  )
  app.delete(
    '/api/shell/policy/:id',
    authConfigAPI,
    asyncHandler(shellPolicyController.removeShellRule),
  )
  ...
  app.get(
    '/api/agents/:agentId/delete-preview',
    authConfigAPI,
    asyncHandler(agentController.previewDeleteAgent),
  )
  app.delete(
    '/api/agents/:agentId',
    authConfigAPI,
  ...
  app.get(
    ...
    authConfigAPI,
    asyncHandler(agentController.listSessions),
  )
  app.post(
    '/api/agents/:agentId/sessions',
    authConfigAPI,
    asyncHandler(agentController.createSession),
  )
  app.delete(
    '/api/agents/:agentId/sessions/:sessionId',
    authConfigAPI,
    asyncHandler(agentController.deleteSession),
  )
  app.get(
    '/api/agents/:agentId/sessions/:sessionId/subagent-groups',
    authConfigAPI,
    asyncHandler(subAgentController.listSessionGroups),
  )
  app.get(
    '/api/subagent-groups/:groupId',
    authConfigAPI,
    asyncHandler(subAgentController.getGroup),
  )
  app.post(
    '/api/subagent-groups/:groupId/cancel',
    authConfigAPI,
    asyncHandler(subAgentController.cancelGroup),
  )
  app.get(
    '/api/subagent-runs/:runId',
    authConfigAPI,
    asyncHandler(subAgentController.getRun),
  )
  app.post(
    '/api/subagent-runs/:runId/continue',
    authConfigAPI,
    asyncHandler(subAgentController.continueRun),
  )
  app.post(
    '/api/subagent-runs/:runId/cancel',
    authConfigAPI,
    asyncHandler(subAgentController.cancelRun),
  )
  app.post(
    '/api/agents/:agentId/channels/:channelId',
    authConfigAPI,
    asyncHandler(agentController.bindChannel),
  )
  app.delete(
    '/api/agents/:agentId/channels/:channelId',
    authConfigAPI,
    asyncHandler(agentController.unbindChannel),
  )
  ...
  app.get(
    ...
    authConfigAPI,
    asyncHandler(channelController.getChannelPlatformCatalog),
  )
  app.get(
    '/api/channels/:channelId/agents',
    authConfigAPI,
    asyncHandler(agentController.listChannelAgents),
  )
  app.get(
    '/api/channels/:channelId/routes',
    authConfigAPI,
    asyncHandler(agentController.listChannelRoutes),
  )
  app.put(
    '/api/channels/:channelId/routes/:externalConversationId',
    authConfigAPI,
    asyncHandler(agentController.assignChannelRoute),
  )
  app.get(
    '/api/channels/:id',
    authConfigAPI,
  ...
  app.post(
    '/api/channels/:id/admin-claim',
    authConfigAPI,
    asyncHandler(channelController.createChannelAdminClaim),
  )
  app.post(
    '/api/channels/:id/qrcode',
    authConfigAPI,
    asyncHandler(channelController.getChannelQrcode),
  )
  app.post(
    '/api/channels/:id/poll',
    authConfigAPI,
    asyncHandler(channelController.pollChannelQr),
  )
  app.put(
    '/api/channels/:id',
    authConfigAPI,
  ...
  app.post(
    ...
    authConfigAPI,
    asyncHandler(channelController.startChannel),
  )
  app.post(
    '/api/channels/:id/stop',
    authConfigAPI,
    asyncHandler(channelController.stopChannel),
  )
  app.delete(
    '/api/channels/:id',
    authConfigAPI,
  ...
  app.get(
    '/api/vision/config',
    authConfigAPI,
    asyncHandler(visionController.getVisionConfig),
  )
  app.put(
    '/api/vision/config',
    authConfigAPI,
    asyncHandler(visionController.updateVisionConfig),
  )
  app.post(
    '/api/vision/test',
    authConfigAPI,
    asyncHandler(visionController.testVision),
  )
  ...
  app.post(
    '/api/webhook/demo',
    authConfigAPI,
    asyncHandler(webhookController.getDemo),
  )
  ...
  app.use((err, req, res, next) => {
    ...
    const status =
      err.status || err.statusCode || (isBodyParseError ? 400 : 500)
    ...
    if (isBodyParseError) {
      ...
      logger.error(
        `[HTTP] 路由处理异常 [${req.method} ${req.originalUrl || req.url}]:`,
        err,
      )
    }
