...
import * as oaiProxyController from './controllers/oaiProxyController.js'import * as webhookController from './controllers/webhookController.js'
...
export async function startServer() {
  ...
  app.get('/api/webhook/demo', asyncHandler(webhookController.getDemo))
