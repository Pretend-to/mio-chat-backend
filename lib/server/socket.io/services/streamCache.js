  ...
  _mergeChunk(item, chunk) {
    ...
    if (lastChunk && lastChunk.type === chunk.type && typeof chunk.content === 'string') {
      ...
      if (existingToolCall) {
        ...
        if (chunk.content.innerRender) existingToolCall.content.innerRender = chunk.content.innerRender
        if (chunk.content.outerRender) existingToolCall.content.outerRender = chunk.content.outerRender
