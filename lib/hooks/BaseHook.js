...
export default class BaseHook {
  constructor(options = {}) {
    ...
    const hasDynamicHookPoints = Object.values(HOOK_POINTS || {}).some(
      point => typeof this[point] === 'function'
    );

    if (!this.hookPoint && !hasDynamicHookPoints) {
