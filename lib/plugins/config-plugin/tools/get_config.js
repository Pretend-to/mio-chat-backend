...
import { getConfigSection, getFullConfig, maskSecret, sanitizeConfig } from '../../../server/http/services/configService.js'
  ...
  async execute(e) {
    ...
    try {
      if (section) {
        ...
        return { config: safeConfig, section, success: true }
      }
      ...
      return { config: toolSafeConfig, success: true }
    } catch (error) {
