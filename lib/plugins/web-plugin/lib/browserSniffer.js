...
export function findBrowserPath() {
    ...
    if (platform === 'darwin') {
        ...
        const localAppData = process.env.LOCALAPPDATA || path.join(process.env.USERPROFILE || String.raw`C:\Users\Default`, String.raw`AppData\Local`)

        const winPaths = [
            path.join(programFiles, String.raw`Google\Chrome\Application\chrome.exe`),
            path.join(programFilesX86, String.raw`Google\Chrome\Application\chrome.exe`),
            path.join(localAppData, String.raw`Google\Chrome\Application\chrome.exe`),
            path.join(programFiles, String.raw`Microsoft\Edge\Application\msedge.exe`),
            path.join(programFilesX86, String.raw`Microsoft\Edge\Application\msedge.exe`),
            path.join(programFiles, String.raw`Chromium\Application\chrome.exe`),
            path.join(programFilesX86, String.raw`Chromium\Application\chrome.exe`),
            path.join(localAppData, String.raw`Chromium\Application\chrome.exe`)
        ]
