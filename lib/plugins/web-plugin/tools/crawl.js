...
export default class WebScreenshot extends MioFunction {
  constructor() {
    super({
      name: 'crawl',
      description:
        'Takes a full-page screenshot of a specified URL. Returns a public image URL you can embed directly via markdown `![alt](url)` — no need to call any other upload/send tools.',
      parameters: {
        type: 'object',
        properties: {
          url: {
