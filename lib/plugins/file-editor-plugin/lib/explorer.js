 ...
 * 递归生成 ASCII 树状结构
 */
export function generateTree(dir, prefix = '', currentDepth = 0, maxDepth = 3, ignore = []) {
 ...
 */
export function generateList(dir, parentId = null, currentDepth = 0, maxDepth = 3, ignore = [], nodes = [], rootPath = process.cwd()) {
