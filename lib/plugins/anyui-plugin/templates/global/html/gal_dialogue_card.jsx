    ...
    <div class="comic">
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        /* 当已有图片时解除 16/9 强制比例，以图片自身的自然高度优雅展开 */
        .ldr-box.has-image {
          aspect-ratio: unset;
        }

        /* 柔和流体融色层 */
        .balanced-liquid-container {
          position: absolute;
          inset: -30px;
          filter: blur(48px);
          opacity: 0.82;
        ...
        .ldr-box.has-image .glass-spinner {
          opacity: 0;
          transform: scale(0.85);
          pointer-events: none;
        }

        /* 真实图片层：初始无图，回填后渐入，自动填满主框宽度 */
        .ldr-box img {
          position: relative;
          z-index: 3;
          width: 100%;
