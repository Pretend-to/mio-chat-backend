...
export default class ps extends MioFunction {
  constructor() {
    super({
      name: 'ps',
      description: 'Check the status and output of a background process started via this plugin. This only works for processes initiated through the "sh" tool of this plugin (identified by a "proc_..." ID), not for arbitrary system processes.',
      parameters: {
        type: 'object',
        properties: {
          processId: {
